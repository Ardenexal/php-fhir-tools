...
/**
 * Hand-written stand-in for the generated R5 `CodeSystem/$lookup` IN class.
 *
 ...
 * `hl7.fhir.r5.core@5.0.0` `OperationDefinition-CodeSystem-lookup.json` — see the committed copy at
 * `src/Component/Serialization/tests/Fixtures/OperationDefinitions/r5-CodeSystem-lookup.json`.
 *
 * Differences from {@see \Ardenexal\FHIRTools\Component\Serialization\Tests\Fixtures\Operations\R4\CodeSystemLookupInput}:
...
final class CodeSystemLookupInput
{
    public function __construct(
        ...
        /**
         * R5-only. The one IN parameter R4 does not have.
         *
         * @var list<string>
         */
        #[FhirOperationParameter(
            ...
            max: '*',
            type: 'canonical',
            documentation: 'The supplement must be used when performing a lookup operation.',
        )]
