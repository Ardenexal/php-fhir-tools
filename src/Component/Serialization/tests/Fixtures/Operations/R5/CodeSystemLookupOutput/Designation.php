...
/**
 * The `part[]` children of the R5 `$lookup` OUT `designation` group.
 *
...
final class Designation
{
    public function __construct(
        ...
        /**
         * R5-only, and `0..*` where its sibling `use` is `0..1` — a list of Coding, not one.
         *
         * @var list<Coding>
         */
        #[FhirOperationParameter(
            name: 'additionalUse',
            phpName: 'additionalUse',
            use: 'out',
            min: 0,
            max: '*',
            type: 'Coding',
            documentation: 'Additional codes that detail how this designation would be used.',
        )]
        public readonly array $additionalUse = [],
        #[FhirOperationParameter(
            name: 'value',
            phpName: 'value',
            use: 'out',
