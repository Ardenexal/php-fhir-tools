...
#[LogicalModel(
    url: 'http://ns.electronichealth.net.au/cda/StructureDefinition/au-IntendedRecipient',
...
class AuIntendedRecipient extends IntendedRecipient
{
    ...
    public function __construct(
        ...
        public ?CD $code = null,
        ?InformationRecipientRole $classCode = null,
        array $id = [],
        array $sdtcIdentifiedBy = [],
        array $addr = [],
        array $telecom = [],
        ?Person $informationRecipient = null,
