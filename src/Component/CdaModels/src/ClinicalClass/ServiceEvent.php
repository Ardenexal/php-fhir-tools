...
class ServiceEvent extends InfrastructureRoot
{
    /**
     * @param list<II>         $id
    ...
    public function __construct(
        ...
        #[FhirProperty(
            fhirType: 'http://hl7.org/cda/stds/core/StructureDefinition/Performer1',
            propertyKind: 'complex',
            isArray: true,
            isRequired: false,
            phpType: '\Ardenexal\FHIRTools\Component\CdaModels\ClinicalClass\Performer1',
        )]
