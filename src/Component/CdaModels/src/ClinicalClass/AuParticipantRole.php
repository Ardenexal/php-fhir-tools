...
#[LogicalModel(
    url: 'http://ns.electronichealth.net.au/cda/StructureDefinition/au-ParticipantRole',
...
class AuParticipantRole extends ParticipantRole
{
    ...
    public function __construct(
        ...
        array $addr = [],
        array $telecom = [],
        ?Device $playingDevice = null,
        ?PlayingEntity $playingEntity = null,
        ?Entity $scopingEntity = null,
        array $realmCode = [],
        ?II $typeId = null,
        array $templateId = [],
