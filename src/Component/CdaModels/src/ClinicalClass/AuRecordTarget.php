...
#[LogicalModel(
    ...
    refines: 'http://hl7.org/cda/stds/core/StructureDefinition/RecordTarget',
    propertyOrder: ['nullFlavor', 'realmCode', 'typeId', 'templateId', 'typeCode', 'contextControlCode', 'patientRole'],
)]
