...
#[LogicalModel(
    ...
    propertyOrder: ['nullFlavor', 'realmCode', 'typeId', 'templateId', 'classCode', 'moodCode', 'id', 'code', 'statusCode'],
)]
class Consent extends InfrastructureRoot
{
    /**
     * @param list<II> $id
