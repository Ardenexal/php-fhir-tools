 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/measurereport-populationDescription', fhirVersion: 'R5')]
...
#[FHIRExtensionContext(type: 'element', expression: 'MeasureReport.group.stratifier')]
