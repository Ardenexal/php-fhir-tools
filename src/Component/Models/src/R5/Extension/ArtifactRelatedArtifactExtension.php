 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/artifact-relatedArtifact', fhirVersion: 'R5')]
...
#[FHIRExtensionContext(type: 'element', expression: 'Device.conformsTo')]
