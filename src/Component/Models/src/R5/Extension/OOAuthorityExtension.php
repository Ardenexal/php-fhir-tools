 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/operationoutcome-authority', fhirVersion: 'R5')]
class OOAuthorityExtension extends Extension
{
