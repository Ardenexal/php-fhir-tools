 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/servicerequest-precondition', fhirVersion: 'R5')]
class SRPreconditionExtension extends Extension
{
