 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/patient-sexParameterForClinicalUse', fhirVersion: 'R5')]
...
class PatSexParameterForClinicalUseExtension extends Extension implements FHIRComplexExtensionInterface
{
    ...
    public static function fromSubExtensions(array $subExtensions, ?string $id = null): self
    {
        ...
        return new self($valueSlice, $period, $comment, $supportingInfo, $intendedClinicalUse, $id);
    }
}
