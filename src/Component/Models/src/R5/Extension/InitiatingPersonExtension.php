 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/cqf-initiatingPerson', fhirVersion: 'R5')]
class InitiatingPersonExtension extends Extension
{
