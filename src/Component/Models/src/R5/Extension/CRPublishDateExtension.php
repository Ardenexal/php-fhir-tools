 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/metadataresource-publish-date', fhirVersion: 'R5')]
#[FHIRExtensionContext(type: 'element', expression: 'MetadataResource')]
