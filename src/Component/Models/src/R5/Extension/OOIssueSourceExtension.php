 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/operationoutcome-issue-source', fhirVersion: 'R5')]
class OOIssueSourceExtension extends Extension
{
