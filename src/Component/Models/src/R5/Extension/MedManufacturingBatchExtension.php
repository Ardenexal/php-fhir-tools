 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/medication-manufacturingBatch', fhirVersion: 'R5')]
...
class MedManufacturingBatchExtension extends Extension implements FHIRComplexExtensionInterface
{
    ...
    public static function fromSubExtensions(array $subExtensions, ?string $id = null): self
    {
        ...
        return new self($manufacturingDate, $manufacturingDateClassification, $assignedManufacturer, $expirationDateClassification, $batchUtilization, $batchQuantity, $additionalInformation, $container, $id);
    }
}
