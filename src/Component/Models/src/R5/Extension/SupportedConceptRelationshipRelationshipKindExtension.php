 ...
 */
#[FHIRExtensionDefinition(url: 'http://terminology.hl7.org/StructureDefinition/ext-mif-relationship-relationshipKind', fhirVersion: 'R5')]
class SupportedConceptRelationshipRelationshipKindExtension extends Extension
{
    public function __construct(
        ...
        public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CodePrimitive $valueCode = null,
        ?string $id = null,
        array $extension = [],
    ) {
        parent::__construct(
