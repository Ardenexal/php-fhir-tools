 ...
 */
#[FHIRPrimitive(primitiveType: 'unsignedInt', fhirVersion: 'R5')]
class UnsignedIntPrimitive extends IntegerPrimitive implements \Stringable
{
    ...
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'http://hl7.org/fhirpath/System.String', propertyKind: 'scalar', xmlSerializedName: '@value'), Regex(pattern: '~\A(?:[0]|([1-9][0-9]*))\z~')]
