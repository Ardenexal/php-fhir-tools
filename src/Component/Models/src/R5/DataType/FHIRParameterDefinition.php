...
class FHIRParameterDefinition extends FHIRDataType
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRCode name Name used to access the parameter value */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRString|string max Maximum cardinality (a number of *) */
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRString|string|null $max = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRString|string documentation A brief description of the parameter */
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRString|string|null $documentation = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRFHIRTypesType type What type of value */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRFHIRTypesType $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRCanonical profile What profile the value is expected to be */
