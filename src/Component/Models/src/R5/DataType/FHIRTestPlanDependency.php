...
/**
 * @fhir-backbone-element TestPlan.dependency
 * @description The required criteria to execute the test plan - e.g. preconditions, previous tests...
 */
class FHIRTestPlanDependency extends \Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRBackboneElement
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRMarkdown description Description of the dependency criterium */
