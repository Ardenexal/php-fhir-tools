...
/**
 * @fhir-backbone-element ClaimResponse.addItem.bodySite
 * @description Physical location where the service is performed or applies.
 */
class FHIRClaimResponseAddItemBodySite extends \Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRBackboneElement
{
