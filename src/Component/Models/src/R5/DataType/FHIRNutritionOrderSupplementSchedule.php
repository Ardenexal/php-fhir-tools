...
/**
 * @fhir-backbone-element NutritionOrder.supplement.schedule
 * @description Schedule information for a supplement.
 */
class FHIRNutritionOrderSupplementSchedule extends \Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRBackboneElement
{
