...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIREventTimingType;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRUnitsOfTimeType;
...
class FHIRTimingRepeat extends FHIRElement
{
    public function __construct(
        ...
        /** @var FHIRPositiveInt|null frequency Indicates the number of repetitions that should occur within a period. I.e. Event occurs frequency times per period */
        ...
        /** @var FHIRDecimal|null period The duration to which the frequency applies. I.e. Event occurs frequency times per period */
