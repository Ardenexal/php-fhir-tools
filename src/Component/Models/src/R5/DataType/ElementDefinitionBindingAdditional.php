...
class ElementDefinitionBindingAdditional extends Element
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\AdditionalBindingPurposeVSType purpose maximum | minimum | required | extensible | candidate | current | preferred | ui | starter | component */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive valueSet The value set for the additional binding */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive documentation Documentation of the purpose of use of the binding */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string shortDoco Concise documentation - for summary tables */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $shortDoco = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\UsageContext> usage Qualifies the usage - jurisdiction, gender, workflow status etc. */
		...
		public array $usage = [],
		/** @var null|bool any Whether binding can applies to all repeats, or just one */
