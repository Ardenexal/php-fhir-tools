...
/**
 * @fhir-backbone-element ClaimResponse.item.reviewOutcome
 * @description The high-level results of the adjudication if adjudication has been performed.
 */
class FHIRClaimResponseItemReviewOutcome extends \Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRBackboneElement
{
