 ...
 */
#[FHIRComplexType(typeName: 'Timing.repeat', fhirVersion: 'R5')]
#[FHIRPathInvariant(
    key: 'tim-1',
    severity: 'error',
...
class TimingRepeat extends Element
{
    public function __construct(
        ...
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/units-of-time|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\UnitsOfTime',
        )]
        public ?UnitsOfTimeType $durationUnit = null,
        /** @var PositiveIntPrimitive|null frequency Indicates the number of repetitions that should occur within a period. I.e. Event occurs frequency times per period */
        #[FhirProperty(fhirType: 'positiveInt', propertyKind: 'primitive')]
        ...
        /** @var numeric-string|null period The duration to which the frequency applies. I.e. Event occurs frequency times per period */
        #[FhirProperty(fhirType: 'decimal', propertyKind: 'scalar')]
        ...
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/days-of-week|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\DaysOfWeek',
        )]
        ...
        #[FhirProperty(
            ...
            propertyKind: 'primitive',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\DataType\EventTimingType',
        )]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/event-timing|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\EventTiming',
        )]
        public array $when = [],
