...
class FHIRExpression extends FHIRDataType
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRString|string description Natural language description of the condition */
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRString|string|null $description = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRCode name Short name assigned to expression for reuse */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRString|string expression Expression in specified language */
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRString|string|null $expression = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRUri reference Where the expression is found */
