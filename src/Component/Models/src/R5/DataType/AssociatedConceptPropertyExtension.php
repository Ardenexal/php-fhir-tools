 ...
 */
#[FHIRExtensionDefinition(url: 'http://terminology.hl7.org/StructureDefinition/ext-mif-assocConceptProp', fhirVersion: 'R5')]
class AssociatedConceptPropertyExtension extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\Extension implements FHIRComplexExtensionInterface
{
    public function __construct(
        /** @var StringPrimitive name Property name */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive $name,
        /** @var StringPrimitive valueSlice Property value */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive $valueSlice,
        ?string $id = null,
    ) {
        $subExtensions   = [];
