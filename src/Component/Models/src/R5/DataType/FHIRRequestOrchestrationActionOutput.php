...
/**
 * @fhir-backbone-element RequestOrchestration.action.output
 * @description Defines the outputs of the action, if any.
 */
class FHIRRequestOrchestrationActionOutput extends \Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRBackboneElement
{
