...
/**
 * @fhir-backbone-element ValueSet.expansion.contains.property
 * @description A property value for this concept.
 */
class FHIRValueSetExpansionContainsProperty extends \Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRBackboneElement
{
