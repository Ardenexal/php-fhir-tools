...
/**
 * @fhir-backbone-element PlanDefinition.action.input
 * @description Defines input data requirements for the action.
 */
class FHIRPlanDefinitionActionInput extends \Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRBackboneElement
{
