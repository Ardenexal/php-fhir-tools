...
/**
 * @fhir-backbone-element PlanDefinition.actor.option
 * @description The characteristics of the candidates that could serve as the actor.
 */
class FHIRPlanDefinitionActorOption extends \Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRBackboneElement
{
