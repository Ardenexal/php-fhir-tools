...
/**
 * @fhir-backbone-element ExplanationOfBenefit.item.bodySite
 * @description Physical location where the service is performed or applies.
 */
class FHIRExplanationOfBenefitItemBodySite extends \Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRBackboneElement
{
