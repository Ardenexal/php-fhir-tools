...
class FHIRDosage extends FHIRBackboneType
{
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRDosageDoseAndRate> doseAndRate Amount of medication administered, to be administered or typical amount to be administered */
