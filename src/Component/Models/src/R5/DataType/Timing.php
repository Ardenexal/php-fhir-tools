...
class Timing extends BackboneType
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive> event When the event occurs */
		...
		public array $event = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\TimingRepeat repeat When the event is to occur */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept code C | BID | TID | QID | AM | PM | QD | QOD | + */
