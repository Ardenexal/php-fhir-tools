...
/**
 * @fhir-backbone-element TestReport.setup.action.assert.requirement
 * @description Links or references providing traceability to the testing requirements for this assert.
 */
class FHIRTestReportSetupActionAssertRequirement extends \Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRBackboneElement
{
