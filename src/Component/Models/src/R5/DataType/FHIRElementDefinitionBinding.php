 ...
 */
#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FHIRComplexType(typeName: 'ElementDefinition.binding', fhirVersion: 'R5')]
class FHIRElementDefinitionBinding extends FHIRElement
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRMarkdown description Intended use of codes in the bound value set */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRElementDefinitionBindingAdditional> additional Additional Bindings - more rules about the binding */
