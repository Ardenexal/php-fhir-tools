...
class TestScriptResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive url Canonical identifier for this test script, represented as a URI (globally unique) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'uri', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive $url = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Additional identifier for the test script */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string version Business version of the test script */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name Name for this test script (computer friendly) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string title Name for this test script (human friendly) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Natural language description of the test script */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> jurisdiction Intended jurisdiction for test script (if applicable) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive purpose Why this test script is defined */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestScript\TestScriptOrigin> origin An abstract server representing a client or sender in a message exchange */
		...
		public array $origin = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestScript\TestScriptDestination> destination An abstract server representing a destination or receiver in a message exchange */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $destination = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestScript\TestScriptMetadata metadata Required capability that is assumed to function correctly on the FHIR server being tested */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestScript\TestScriptScope> scope Indication of the artifact(s) that are tested by this test case */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $scope = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestScript\TestScriptFixture> fixture Fixture in the test script - by reference (uri) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $fixture = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive> profile Reference of the validation profile */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestScript\TestScriptVariable> variable Placeholder for evaluated elements */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $variable = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestScript\TestScriptSetup setup A series of required setup operations before tests are executed */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?TestScript\TestScriptSetup $setup = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestScript\TestScriptTest> test A test in this script */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $test = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestScript\TestScriptTeardown teardown A series of required clean up steps */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
