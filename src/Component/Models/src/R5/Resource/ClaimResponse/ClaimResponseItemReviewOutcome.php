 ...
 */
#[FHIRBackboneElement(parentResource: 'ClaimResponse', elementPath: 'ClaimResponse.item.reviewOutcome', fhirVersion: 'R5')]
class ClaimResponseItemReviewOutcome extends BackboneElement
{
