...
class FHIRClaimResponseAddItemDetailSubDetail extends FHIRBackboneElement
{
    public function __construct(
        ...
        /** @var FHIRClaimResponseItemReviewOutcome|null reviewOutcome Added items subdetail level adjudication results */
        public ?FHIRClaimResponseItemReviewOutcome $reviewOutcome = null,
        /** @var array<FHIRClaimResponseItemAdjudication> adjudication Added items subdetail adjudication */
