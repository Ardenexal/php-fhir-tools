...
class DeviceMetricResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept type Identity of metric, for example Heart Rate or PEEP Setting */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept unit Unit of Measure for the Metric */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $unit = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference device Describes the link to the Device */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\DeviceMetricOperationalStatusType operationalStatus on | off | standby | entered-in-error */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\DeviceMetricOperationalStatusType $operationalStatus = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\ColorCodesOrRGBType color Color name (from CSS4) or #RRGGBB code */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\ColorCodesOrRGBType $color = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\DeviceMetricCategoryType category measurement | setting | calculation | unspecified */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\DeviceMetricCategoryType $category = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Quantity measurementFrequency Indicates how often the metric is taken or recorded */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Quantity', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Quantity $measurementFrequency = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\DeviceMetric\DeviceMetricCalibration> calibration Describes the calibrations that have been performed or that are required to be performed */
