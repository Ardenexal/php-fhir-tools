...
class ProvenanceResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> target Target Reference(s) (usually version specific) */
		...
		public array $target = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive occurred When the activity occurred */
		...
		public \Ardenexal\FHIRTools\Component\Models\R5\DataType\Period|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive|null $occurred = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive recorded When the activity was recorded / updated */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'instant', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive $recorded = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive> policy Policy or plan the activity was defined by */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'uri', propertyKind: 'primitive', isArray: true)]
		public array $policy = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference location Where the activity occurred, if relevant */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> authorization Authorization (purposeOfUse) related to the event */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept activity Activity that occurred */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $activity = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> basedOn Workflow authorization within which this event occurred */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference patient The patient is the subject of the data created/updated (.target) by the activity */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $patient = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference encounter Encounter within which this event occurred or which the event is tightly associated */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $encounter = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Provenance\ProvenanceAgent> agent Actor involved */
		...
		public array $agent = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Provenance\ProvenanceEntity> entity An entity used in this activity */
		...
		public array $entity = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Signature> signature Signature on target */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Signature', propertyKind: 'complex', isArray: true)]
