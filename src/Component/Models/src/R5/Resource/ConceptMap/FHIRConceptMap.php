 ...
 */
#[FhirResource(type: 'ConceptMap', version: '5.0.0', url: 'http://hl7.org/fhir/StructureDefinition/ConceptMap', fhirVersion: 'R5')]
class FHIRConceptMap extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var array<FHIRIdentifier> identifier Additional identifier for the concept map */
        ...
        /** @var FHIRDate|null approvalDate When the ConceptMap was approved by publisher */
        public ?FHIRDate $approvalDate = null,
        /** @var FHIRDate|null lastReviewDate When the ConceptMap was last reviewed by the publisher */
        public ?FHIRDate $lastReviewDate = null,
        /** @var FHIRPeriod|null effectivePeriod When the ConceptMap is expected to be used */
        public ?FHIRPeriod $effectivePeriod = null,
        /** @var array<FHIRCodeableConcept> topic E.g. Education, Treatment, Assessment, etc */
        public array $topic = [],
        /** @var array<FHIRContactDetail> author Who authored the ConceptMap */
        public array $author = [],
        /** @var array<FHIRContactDetail> editor Who edited the ConceptMap */
        public array $editor = [],
        /** @var array<FHIRContactDetail> reviewer Who reviewed the ConceptMap */
        public array $reviewer = [],
        /** @var array<FHIRContactDetail> endorser Who endorsed the ConceptMap */
        public array $endorser = [],
        /** @var array<FHIRRelatedArtifact> relatedArtifact Additional documentation, citations, etc */
        public array $relatedArtifact = [],
        /** @var array<FHIRConceptMapProperty> property Additional properties of the mapping */
        public array $property = [],
        /** @var array<FHIRConceptMapAdditionalAttribute> additionalAttribute Definition of an additional attribute to act as a data source or target */
        public array $additionalAttribute = [],
        /** @var FHIRUri|FHIRCanonical|null sourceScopeX The source value set that contains the concepts that are being mapped */
        public FHIRUri|FHIRCanonical|null $sourceScopeX = null,
        /** @var FHIRUri|FHIRCanonical|null targetScopeX The target value set which provides context for the mappings */
