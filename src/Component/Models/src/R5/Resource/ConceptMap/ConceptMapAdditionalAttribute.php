...
class ConceptMapAdditionalAttribute extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CodePrimitive code Identifies this additional attribute through this resource */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive uri Formal identifier for the data element referred to in this attribte */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string description Why the additional attribute is defined, and/or what the data element it refers to is */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\ConceptMapAttributeTypeType type code | Coding | string | boolean | Quantity */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\ConceptMapAttributeTypeType $type = null,
	) {
