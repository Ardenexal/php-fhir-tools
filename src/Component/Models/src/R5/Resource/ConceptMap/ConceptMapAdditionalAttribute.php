...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\ConceptMapAttributeTypeType;
...
class ConceptMapAdditionalAttribute extends BackboneElement
{
    public function __construct(
        ...
        /** @var CodePrimitive|null code Identifies this additional attribute through this resource */
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank]
        public ?CodePrimitive $code = null,
        /** @var UriPrimitive|null uri Formal identifier for the data element referred to in this attribte */
        #[FhirProperty(fhirType: 'uri', propertyKind: 'primitive')]
        public ?UriPrimitive $uri = null,
        /** @var StringPrimitive|string|null description Why the additional attribute is defined, and/or what the data element it refers to is */
