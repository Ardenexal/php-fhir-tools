...
class IngredientResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier identifier An identifier or code by which the ingredient can be referenced */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> for The product which this ingredient is a constituent part of */
		...
		public array $for = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept role Purpose of the ingredient within the product, e.g. active, inactive */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> function Precise action within the drug product, e.g. antioxidant, alkalizing agent */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept group A classification of the ingredient according to where in the physical item it tends to be used, such the outer shell of a tablet, inner body or ink */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $group = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive comment A place for providing any notes that are relevant to the component, e.g. removed during process, adjusted for loss on drying */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Ingredient\IngredientManufacturer> manufacturer An organization that manufactures this ingredient */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\Ingredient\IngredientSubstance substance The substance that comprises this ingredient */
