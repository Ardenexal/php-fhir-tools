...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\MessageHeader\MessageHeaderDestination;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\MessageHeader\MessageHeaderResponse;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\MessageHeader\MessageHeaderSource;
...
class MessageHeaderResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var Coding|CanonicalPrimitive|null event Event code or link to EventDefinition */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isRequired: true,
            ...
            variants: [
                ...
                [
                    ...
                    'jsonKey'      => 'eventCanonical',
                ],
            ],
        )]
        #[NotBlank]
        #[FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/EventDefinition'])]
        public Coding|CanonicalPrimitive|null $event = null,
        /** @var array<MessageHeaderDestination> destination Message destination application(s) */
        #[FhirProperty(
            fhirType: 'BackboneElement',
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\MessageHeader\MessageHeaderDestination',
        )]
