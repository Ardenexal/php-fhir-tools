...
class FamilyMemberHistoryProcedure extends BackboneElement
{
    public function __construct(
        ...
        /** @var CodeableConcept|null code Procedures performed on the related person */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isRequired: true), NotBlank]
        public ?CodeableConcept $code = null,
        /** @var CodeableConcept|null outcome What happened following the procedure */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
        public ?CodeableConcept $outcome = null,
        /** @var bool|null contributedToDeath Whether the procedure contributed to the cause of death */
        #[FhirProperty(fhirType: 'boolean', propertyKind: 'scalar')]
        public ?bool $contributedToDeath = null,
        /** @var Age|Range|Period|StringPrimitive|string|DateTimePrimitive|null performed When the procedure was performed */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isChoice: true,
        ...
        public Age|Range|Period|StringPrimitive|string|DateTimePrimitive|null $performed = null,
        /** @var array<Annotation> note Extra information about the procedure */
        #[FhirProperty(
            fhirType: 'Annotation',
            propertyKind: 'complex',
            isArray: true,
