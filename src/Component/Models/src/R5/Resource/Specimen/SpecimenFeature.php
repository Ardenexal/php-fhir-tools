 ...
 */
#[FHIRBackboneElement(parentResource: 'Specimen', elementPath: 'Specimen.feature', fhirVersion: 'R5')]
class SpecimenFeature extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var CodeableConcept|null type Highlighted feature */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isRequired: true), NotBlank]
        public ?CodeableConcept $type = null,
        /** @var StringPrimitive|string|null description Information about the feature */
