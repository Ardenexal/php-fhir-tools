...
class FHIRHealthcareService extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var array<FHIRReference> offeredIn The service within which this service is offered */
        ...
        /** @var FHIRMarkdown|null comment Additional description and/or any specific issues not covered elsewhere */
        ...
        /** @var array<FHIRExtendedContactDetail> contact Official contact details for the HealthcareService */
        ...
        /** @var array<FHIRAvailability> availability Times the healthcare service is available (including exceptions) */
