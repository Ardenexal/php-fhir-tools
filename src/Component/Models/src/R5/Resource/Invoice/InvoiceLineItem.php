...
class InvoiceLineItem extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var DatePrimitive|Period|null serviced Service data or period */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isChoice: true,
        ...
        /** @var array<MonetaryComponent> priceComponent Components of total line item price */
        #[FhirProperty(fhirType: 'MonetaryComponent', propertyKind: 'complex', isArray: true)]
