...
class GuidanceResponseResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier requestIdentifier The identifier of the request associated with this response, if any */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Identifier', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier $requestIdentifier = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept module What guidance was requested */
		...
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept|null $module = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\GuidanceResponseStatusType status success | data-requested | data-required | in-progress | failure | entered-in-error */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\GuidanceResponseStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject Patient the request was performed for */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference encounter Encounter during which the response was returned */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $encounter = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive occurrenceDateTime When the guidance response was processed */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive $occurrenceDateTime = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference performer Device returning the guidance */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $performer = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> reason Why guidance is needed */
		...
		public array $reason = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note Additional notes about the response */
		...
		public array $note = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference evaluationMessage Messages resulting from the evaluation of the artifact or artifacts */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $evaluationMessage = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference outputParameters The output parameters of the evaluation, if any */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $outputParameters = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> result Proposed actions, if any */
		...
		public array $result = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\DataRequirement> dataRequirement Additional required data */
