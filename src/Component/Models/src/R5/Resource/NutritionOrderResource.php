...
class NutritionOrderResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive> instantiates Instantiates protocol or definition */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'uri', propertyKind: 'primitive', isArray: true)]
		public array $instantiates = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> basedOn What this order fulfills */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier groupIdentifier Composite Request ID */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject Who requires the diet, formula or nutritional supplement */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference encounter The encounter associated with this nutrition order */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> supportingInformation Information to support fulfilling of the nutrition order */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $supportingInformation = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive dateTime Date and time the nutrition order was requested */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive $dateTime = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference orderer Who ordered the diet, formula or nutritional supplement */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $orderer = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> performer Who is desired to perform the administration of what is being ordered */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> allergyIntolerance List of the patient's food and nutrition-related allergies and intolerances */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $allergyIntolerance = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> foodPreferenceModifier Order-specific modifier about the type of food that should be given */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> excludeFoodModifier Order-specific modifier about the type of food that should not be given */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $excludeFoodModifier = [],
		/** @var null|bool outsideFoodAllowed Capture when a food item is brought in by the patient and/or family */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\NutritionOrder\NutritionOrderOralDiet oralDiet Oral diet components */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\NutritionOrder\NutritionOrderSupplement> supplement Supplement components */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\NutritionOrder\NutritionOrderEnteralFormula enteralFormula Enteral formula components */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
