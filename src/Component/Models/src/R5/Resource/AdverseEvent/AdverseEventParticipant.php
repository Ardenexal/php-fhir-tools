 ...
 */
#[FHIRBackboneElement(parentResource: 'AdverseEvent', elementPath: 'AdverseEvent.participant', fhirVersion: 'R5')]
class AdverseEventParticipant extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var Reference|null actor Who was involved in the adverse event or the potential adverse event */
