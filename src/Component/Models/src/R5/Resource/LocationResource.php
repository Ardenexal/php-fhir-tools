...
class LocationResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Unique code or number identifying the location to its users */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\LocationStatusType status active | suspended | inactive */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\LocationStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Coding operationalStatus The operational status of the location (typically only for a bed/room) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Coding', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Coding $operationalStatus = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name Name of the location as used by humans */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $name = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string> alias A list of alternate names that the location is known as, or was known as, in the past */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive', isArray: true)]
		public array $alias = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Additional details about the location that could be displayed as further information to identify the location beyond its name */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\LocationModeType mode instance | kind */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\LocationModeType $mode = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> type Type of function performed */
		...
		public array $type = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\ExtendedContactDetail> contact Official contact details for the location */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Address address Physical location */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Address', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Address $address = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept form Physical form of the location */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $form = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\Location\LocationPosition position The absolute geographic location */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference managingOrganization Organization responsible for provisioning and upkeep */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference partOf Another Location this one is physically a part of */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $partOf = null,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Availability> hoursOfOperation What days/times during a week is this location usually open (including exceptions) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> endpoint Technical endpoints providing access to services operated for the location */
