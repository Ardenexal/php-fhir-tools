 ...
 */
#[FHIRBackboneElement(parentResource: 'TerminologyCapabilities', elementPath: 'TerminologyCapabilities.expansion', fhirVersion: 'R5')]
class TerminologyCapabilitiesExpansion extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\TerminologyCapabilities\TerminologyCapabilitiesExpansionParameter',
        )]
