...
class FHIRResearchSubject extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var array<FHIRResearchSubjectProgress> progress Subject status */
        ...
        /** @var FHIRReference|null subject Who or what is part of study */
        #[NotBlank]
        public ?FHIRReference $subject = null,
        /** @var FHIRId|null assignedComparisonGroup What path should be followed */
        public ?FHIRId $assignedComparisonGroup = null,
        /** @var FHIRId|null actualComparisonGroup What path was followed */
        public ?FHIRId $actualComparisonGroup = null,
        /** @var array<FHIRReference> consent Agreement to participate in study */
