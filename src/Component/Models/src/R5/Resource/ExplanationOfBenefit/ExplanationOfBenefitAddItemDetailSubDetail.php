 ...
 */
#[FHIRBackboneElement(parentResource: 'ExplanationOfBenefit', elementPath: 'ExplanationOfBenefit.addItem.detail.subDetail', fhirVersion: 'R5')]
class ExplanationOfBenefitAddItemDetailSubDetail extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var ExplanationOfBenefitItemReviewOutcome|null reviewOutcome Additem subdetail level adjudication results */
