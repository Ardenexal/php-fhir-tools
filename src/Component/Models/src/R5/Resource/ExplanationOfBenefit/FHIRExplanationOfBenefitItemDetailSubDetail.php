...
class FHIRExplanationOfBenefitItemDetailSubDetail extends FHIRBackboneElement
{
    public function __construct(
        ...
        /** @var FHIRExplanationOfBenefitItemReviewOutcome|null reviewOutcome Subdetail level adjudication results */
