...
class OrganizationResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Identifies this organization  across multiple systems */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> type Kind of organization */
		...
		public array $type = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name Name used for the organization */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $name = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string> alias A list of alternate names that the organization is known as, or was known as in the past */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive', isArray: true)]
		public array $alias = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Additional details about the Organization that could be displayed as further information to identify the Organization beyond its name */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\ExtendedContactDetail> contact Official contact details for the Organization */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference partOf The organization of which this organization forms a part */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> endpoint Technical endpoints providing access to services operated for the organization */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Organization\OrganizationQualification> qualification Qualifications, certifications, accreditations, licenses, training, etc. pertaining to the provision of care */
