...
class ImplementationGuideResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive url Canonical identifier for this implementation guide, represented as a URI (globally unique) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Additional identifier for the implementation guide (business identifier) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string version Business version of the implementation guide */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name Name for this implementation guide (computer friendly) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string title Name for this implementation guide (human friendly) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Natural language description of the implementation guide */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> jurisdiction Intended jurisdiction for implementation guide (if applicable) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive purpose Why this implementation guide is defined */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\IdPrimitive packageId NPM Package name for IG */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\IdPrimitive $packageId = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\SPDXLicenseType license SPDX license code for this IG (or not-open-source) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\SPDXLicenseType $license = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRVersionType> fhirVersion FHIR Version(s) this Implementation Guide targets */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ImplementationGuide\ImplementationGuideDependsOn> dependsOn Another Implementation guide this depends on */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ImplementationGuide\ImplementationGuideGlobal> global Profiles that apply globally */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $global = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\ImplementationGuide\ImplementationGuideDefinition definition Information needed to build the IG */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\ImplementationGuide\ImplementationGuideManifest manifest Information about an assembled IG */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
