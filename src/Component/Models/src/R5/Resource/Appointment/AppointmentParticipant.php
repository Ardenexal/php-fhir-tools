...
class AppointmentParticipant extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> type Role of participant in the appointment */
		...
		public array $type = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period period Participation period of the actor */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference actor The individual, device, location, or service participating in the appointment */
		...
		/** @var null|bool required The participant is required to attend (optional when false) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'boolean', propertyKind: 'scalar')]
		public ?bool $required = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\ParticipationStatusType status accepted | declined | tentative | needs-action */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\ParticipationStatusType $status = null,
	) {
