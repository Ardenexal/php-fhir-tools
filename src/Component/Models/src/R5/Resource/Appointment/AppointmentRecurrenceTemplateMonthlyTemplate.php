...
class AppointmentRecurrenceTemplateMonthlyTemplate extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'Coding', propertyKind: 'complex'), Valid, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/week-of-month|5.0.0', strength: 'required')]
        public ?Coding $nthWeekOfMonth = null,
        /** @var Coding|null dayOfWeek Indicates which day of the week the appointment should occur */
        #[FhirProperty(fhirType: 'Coding', propertyKind: 'complex'), Valid, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/days-of-week|5.0.0', strength: 'required')]
