...
class SupplyRequestResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business Identifier for SupplyRequest */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\SupplyRequestStatusType status draft | active | suspended + */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\SupplyRequestStatusType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> basedOn What other request is fulfilled by this supply request */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept category The kind of supply (central, non-stock, etc.) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference deliverFor The patient for who the supply request is for */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $deliverFor = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference item Medication, Substance, or Device requested to be supplied */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Quantity quantity The requested amount of the item indicated */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\SupplyRequest\SupplyRequestParameter> parameter Ordered item details */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Timing occurrence When the request should be fulfilled */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive authoredOn When the request was made */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference requester Individual making the request */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $requester = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> supplier Who is intended to fulfill the request */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $supplier = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> reason The reason why the supply item was requested */
		...
		public array $reason = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference deliverFrom The origin of the supply */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $deliverFrom = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference deliverTo The destination of the supply */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $deliverTo = null,
	) {
