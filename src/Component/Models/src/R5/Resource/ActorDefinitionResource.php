...
class ActorDefinitionResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FHIRIsModifier(reason: 'This is labeled as "Is Modifier" because designs and applications should not use a retired ActorDefinition without due consideration')]
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/examplescenario-actor-type|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\ExampleScenarioActorType',
        )]
