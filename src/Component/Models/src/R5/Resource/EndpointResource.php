...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\EndpointStatusType;
...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\Endpoint\EndpointPayload;
 ...
 */
#[FhirResource(type: 'Endpoint', version: '5.0.0', url: 'http://hl7.org/fhir/StructureDefinition/Endpoint', fhirVersion: 'R5')]
class EndpointResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/endpoint-status|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\EndpointStatus',
        )]
        ...
        /** @var array<CodeableConcept> connectionType Protocol/Profile/Standard to be used with this endpoint connection */
        #[FhirProperty(
        ...
        /** @var StringPrimitive|string|null description Additional details about the endpoint that could be displayed as further information to identify the description beyond its name */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        public StringPrimitive|string|null $description = null,
        /** @var array<CodeableConcept> environmentType The type of environment(s) exposed at this endpoint */
        #[FhirProperty(
            fhirType: 'CodeableConcept',
            propertyKind: 'complex',
            isArray: true,
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/endpoint-environment',
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\EndpointEnvironment',
        )]
        ...
        /** @var array<EndpointPayload> payload Set of payloads that are provided by this endpoint */
        #[FhirProperty(
            fhirType: 'BackboneElement',
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\Endpoint\EndpointPayload',
        )]
        #[Valid]
