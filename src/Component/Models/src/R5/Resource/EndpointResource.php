...
class EndpointResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Identifies this endpoint across multiple systems */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\EndpointStatusType status active | suspended | error | off | entered-in-error | test */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\EndpointStatusType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> connectionType Protocol/Profile/Standard to be used with this endpoint connection */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name A name that this endpoint can be identified by */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $name = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string description Additional details about the endpoint that could be displayed as further information to identify the description beyond its name */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $description = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> environmentType The type of environment(s) exposed at this endpoint */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference managingOrganization Organization that manages this endpoint (might not be the organization that exposes the endpoint) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period period Interval the endpoint is expected to be operational */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Endpoint\EndpointPayload> payload Set of payloads that are provided by this endpoint */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UrlPrimitive address The technical base address for connecting to this endpoint */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UrlPrimitive $address = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string> header Usage depends on the channel type */
