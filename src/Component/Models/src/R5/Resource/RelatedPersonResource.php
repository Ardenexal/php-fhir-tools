...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\RelatedPerson\RelatedPersonCommunication;
 ...
 */
#[FhirResource(type: 'RelatedPerson', version: '5.0.0', url: 'http://hl7.org/fhir/StructureDefinition/RelatedPerson', fhirVersion: 'R5')]
class RelatedPersonResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var array<CodeableConcept> relationship The relationship of the related person to the patient */
        #[FhirProperty(
        ...
        #[FHIRValueSetBinding(
            ...
            strength: 'preferred',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\PatientRelationshipType',
        )]
        ...
        /** @var array<RelatedPersonCommunication> communication A language which may be used to communicate with the related person about the patient's health */
        #[FhirProperty(
            fhirType: 'BackboneElement',
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\RelatedPerson\RelatedPersonCommunication',
        )]
        #[Valid]
