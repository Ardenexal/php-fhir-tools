...
class RelatedPersonResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference patient The patient this person is related to */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> relationship The relationship of the related person to the patient */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive birthDate The date on which the related person was born */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Address> address Address where the related person can be contacted or visited */
		...
		public array $photo = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period period Period of time that this relationship is considered valid */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\RelatedPerson\RelatedPersonCommunication> communication A language which may be used to communicate with the related person about the patient's health */
