...
class PractitionerResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier An identifier for the person as this agent */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\HumanName> name The name(s) associated with the practitioner */
		...
		public array $name = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\ContactPoint> telecom A contact detail for the practitioner (that apply to all roles) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive birthDate The date  on which the practitioner was born */
		...
		/** @var null|bool|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive deceased Indicates if the practitioner is deceased or not */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Address> address Address(es) of the practitioner that are not role specific (typically home address) */
		...
		public array $photo = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Practitioner\PractitionerQualification> qualification Qualifications, certifications, accreditations, licenses, training, etc. pertaining to the provision of care */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Practitioner\PractitionerCommunication> communication A language which may be used to communicate with the practitioner */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
