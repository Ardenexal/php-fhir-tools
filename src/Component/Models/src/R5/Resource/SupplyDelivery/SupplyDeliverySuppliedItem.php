...
class SupplyDeliverySuppliedItem extends BackboneElement
{
    public function __construct(
        ...
        /** @var Quantity|null quantity Amount supplied */
        #[FhirProperty(fhirType: 'Quantity', propertyKind: 'complex')]
        public ?Quantity $quantity = null,
        /** @var CodeableConcept|Reference|null item Medication, Substance, Device or Biologically Derived Product supplied */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isChoice: true,
