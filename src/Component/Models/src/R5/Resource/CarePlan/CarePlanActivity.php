...
namespace Ardenexal\FHIRTools\Component\Models\R5\Resource\CarePlan;
...
class CarePlanActivity extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> performedActivity Results of the activity (concept, or Appointment, Encounter, Procedure, etc.) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> progress Comments about the activity status/progress */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference plannedActivityReference Activity that is intended to be part of the care plan */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $plannedActivityReference = null,
	) {
