...
class AuditEventResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> category Type/identifier of event */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept code Specific type of event */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\AuditEventActionType action Type of action performed during the event */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\AuditEventActionType $action = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\AuditEventSeverityType severity emergency | alert | critical | error | warning | notice | informational | debug */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\AuditEventSeverityType $severity = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive recorded Time when the event was recorded */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\AuditEvent\AuditEventOutcome outcome Whether the event succeeded or failed */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?AuditEvent\AuditEventOutcome $outcome = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> authorization Authorization related to the event */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference patient The patient is the subject of the data used/created/updated/deleted during the activity */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\AuditEvent\AuditEventAgent> agent Actor involved in the event */
		...
		public array $agent = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\AuditEvent\AuditEventSource source Audit Event Reporter */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\AuditEvent\AuditEventEntity> entity Data or objects used */
