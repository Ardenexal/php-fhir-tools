 ...
 */
#[FHIRBackboneElement(parentResource: 'CoverageEligibilityResponse', elementPath: 'CoverageEligibilityResponse.insurance', fhirVersion: 'R5')]
class CoverageEligibilityResponseInsurance extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\CoverageEligibilityResponse\CoverageEligibilityResponseInsuranceItem',
        )]
        public array $item = [],
    ) {
