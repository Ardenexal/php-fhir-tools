 ...
 */
#[FHIRBackboneElement(parentResource: 'CoverageEligibilityResponse', elementPath: 'CoverageEligibilityResponse.event', fhirVersion: 'R5')]
class CoverageEligibilityResponseEvent extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var CodeableConcept|null type Specific event */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isRequired: true), NotBlank]
        public ?CodeableConcept $type = null,
        /** @var DateTimePrimitive|Period|null when Occurance date or period */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isRequired: true,
        ...
        #[NotBlank]
        public DateTimePrimitive|Period|null $when = null,
    ) {
