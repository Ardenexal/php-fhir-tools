 ...
 */
#[FHIRBackboneElement(parentResource: 'ValueSet', elementPath: 'ValueSet.compose', fhirVersion: 'R5')]
class FHIRValueSetCompose extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRBackboneElement
{
    public function __construct(
        ...
        /** @var array<FHIRString|string> property Property to return if client doesn't override */
