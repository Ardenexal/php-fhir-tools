 ...
 */
#[FHIRBackboneElement(parentResource: 'ValueSet', elementPath: 'ValueSet.expansion.contains.property', fhirVersion: 'R5')]
class ValueSetExpansionContainsProperty extends BackboneElement
{
