 ...
 */
#[FHIRBackboneElement(parentResource: 'ValueSet', elementPath: 'ValueSet.compose.include.concept', fhirVersion: 'R5')]
class ValueSetComposeIncludeConcept extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\ValueSet\ValueSetComposeIncludeConceptDesignation',
        )]
