...
class ValueSetExpansionContainsPropertySubProperty extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var CodePrimitive|null code Reference to ValueSet.expansion.property.code */
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank]
        public ?CodePrimitive $code = null,
        /** @var CodePrimitive|Coding|StringPrimitive|string|int|bool|DateTimePrimitive|float|null value Value of the subproperty for this concept */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isRequired: true,
