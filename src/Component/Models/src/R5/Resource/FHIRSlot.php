...
class FHIRSlot extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRCodeableConcept> appointmentType The style of appointment or patient that may be booked in the slot (not service type) */
		public array $appointmentType = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRReference schedule The schedule resource that this slot defines an interval of status information */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRReference $schedule = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRSlotStatusType status busy | free | busy-unavailable | busy-tentative | entered-in-error */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRSlotStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRInstant start Date/Time that the slot is to begin */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRInstant $start = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRInstant end Date/Time that the slot is to conclude */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRInstant $end = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRBoolean overbooked This slot has already been overbooked, appointments are unlikely to be accepted for this time */
		public ?FHIRBoolean $overbooked = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRString|string comment Comments on the slot to describe any extended information. Such as custom constraints on the slot */
