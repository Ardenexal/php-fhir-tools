...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRSlotStatusType;
...
class FHIRSlot extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var array<FHIRCodeableReference> serviceType The type of appointments that can be booked into this slot (ideally this would be an identifiable service - which is at a location, rather than the location itself). If provided then this overrides the value provided on the Schedule resource */
        ...
        /** @var array<FHIRCodeableConcept> appointmentType The style of appointment or patient that may be booked in the slot (not service type) */
