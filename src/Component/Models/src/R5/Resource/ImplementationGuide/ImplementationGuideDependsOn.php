 ...
 */
#[FHIRBackboneElement(parentResource: 'ImplementationGuide', elementPath: 'ImplementationGuide.dependsOn', fhirVersion: 'R5')]
class ImplementationGuideDependsOn extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'canonical', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/ImplementationGuide'])]
        ...
        /** @var MarkdownPrimitive|null reason Why dependency exists */
        #[FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
        public ?MarkdownPrimitive $reason = null,
    ) {
