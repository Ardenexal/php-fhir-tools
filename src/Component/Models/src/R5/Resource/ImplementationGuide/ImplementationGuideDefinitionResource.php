...
class ImplementationGuideDefinitionResource extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference reference Location of the resource */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRVersionType> fhirVersion Versions this applies to (if different to IG) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name Human readable name for the resource */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $name = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Reason why included in guide */
		...
		/** @var null|bool isExample Is this an example */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive> profile Profile(s) this is an example of */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\IdPrimitive groupingId Grouping this is part of */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'id', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\IdPrimitive $groupingId = null,
	) {
