...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\ConceptMap\ConceptMapAdditionalAttribute;
...
class ConceptMapResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var array<Identifier> identifier Additional identifier for the concept map */
        #[FhirProperty(
            fhirType: 'Identifier',
        ...
        /** @var DatePrimitive|null approvalDate When the ConceptMap was approved by publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
        public ?DatePrimitive $approvalDate = null,
        /** @var DatePrimitive|null lastReviewDate When the ConceptMap was last reviewed by the publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
        ...
        #[FhirProperty(
            ...
            variants: [
                [
                    ...
                    'jsonKey'      => 'sourceScopeUri',
                ],
                [
                    'fhirType'     => 'canonical',
                    'propertyKind' => 'primitive',
                    'phpType'      => 'Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive',
                    'jsonKey'      => 'sourceScopeCanonical',
                ],
            ],
        )]
        #[FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/ValueSet'])]
        public UriPrimitive|CanonicalPrimitive|null $sourceScope = null,
        /** @var UriPrimitive|CanonicalPrimitive|null targetScope The target value set which provides context for the mappings */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isChoice: true,
            variants: [
                [
                    ...
                    'propertyKind' => 'primitive',
                    'phpType'      => 'Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive',
                    'jsonKey'      => 'targetScopeUri',
                ],
                [
                    'fhirType'     => 'canonical',
                    'propertyKind' => 'primitive',
                    'phpType'      => 'Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive',
                    'jsonKey'      => 'targetScopeCanonical',
                ],
            ],
        )]
        #[FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/ValueSet'])]
        public UriPrimitive|CanonicalPrimitive|null $targetScope = null,
