...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\Condition\ConditionParticipant;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\Condition\ConditionStage;
...
class ConditionResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/condition-clinical|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\ConditionClinicalStatusCodes',
        )]
        #[FHIRIsModifier(reason: 'This element is labeled as a modifier because the status contains codes that mark the condition as no longer active.')]
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/condition-ver-status|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\ConditionVerificationStatus',
        )]
        #[FHIRIsModifier(reason: 'This element is labeled as a modifier because the status contains the code refuted and entered-in-error that mark the Condition as not currently valid.')]
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/condition-category',
            strength: 'preferred',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\ConditionCategoryCodes',
        )]
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/condition-severity',
            strength: 'preferred',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\ConditionDiagnosisSeverity',
        )]
        ...
        /** @var DateTimePrimitive|null recordedDate Date condition was first recorded */
        #[FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
        public ?DateTimePrimitive $recordedDate = null,
        /** @var array<ConditionParticipant> participant Who or what participated in the activities related to the condition and how they were involved */
        #[FhirProperty(
            fhirType: 'BackboneElement',
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\Condition\ConditionParticipant',
        )]
        #[Valid]
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\Condition\ConditionStage',
        )]
        #[Valid]
        public array $stage = [],
        /** @var array<CodeableReference> evidence Supporting evidence for the verification status */
        #[FhirProperty(
