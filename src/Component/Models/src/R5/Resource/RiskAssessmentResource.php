...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\RiskAssessment\RiskAssessmentPrediction;
...
class RiskAssessmentResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'Reference', propertyKind: 'complex'), Valid, FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/Condition'])]
        ...
        /** @var array<CodeableReference> reason Why the assessment was necessary? */
        #[FhirProperty(
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\RiskAssessment\RiskAssessmentPrediction',
        )]
        #[Valid]
