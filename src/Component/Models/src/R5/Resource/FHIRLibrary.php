...
class FHIRLibrary extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var FHIRMarkdown|null usage Describes the clinical usage of the library */
        ...
        /** @var FHIRDate|null lastReviewDate When the library was last reviewed by the publisher */
