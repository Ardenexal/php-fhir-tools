 ...
 */
#[FHIRBackboneElement(parentResource: 'RequestOrchestration', elementPath: 'RequestOrchestration.action.dynamicValue', fhirVersion: 'R5')]
class RequestOrchestrationActionDynamicValue extends BackboneElement
{
