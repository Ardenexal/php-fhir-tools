...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\ActionConditionKindType;
 ...
 */
#[FHIRBackboneElement(parentResource: 'RequestOrchestration', elementPath: 'RequestOrchestration.action.condition', fhirVersion: 'R5')]
class RequestOrchestrationActionCondition extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/action-condition-kind|5.0.0', strength: 'required')]
