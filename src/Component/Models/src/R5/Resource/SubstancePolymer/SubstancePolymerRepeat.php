 ...
 */
#[FHIRBackboneElement(parentResource: 'SubstancePolymer', elementPath: 'SubstancePolymer.repeat', fhirVersion: 'R5')]
class SubstancePolymerRepeat extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var StringPrimitive|string|null averageMolecularFormula A representation of an (average) molecular formula from a polymer */
