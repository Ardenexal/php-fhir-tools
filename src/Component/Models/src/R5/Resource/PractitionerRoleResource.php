...
class PractitionerRoleResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Identifiers for a role/location */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period period The period during which the practitioner is authorized to perform in these role(s) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference practitioner Practitioner that provides services for the organization */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $practitioner = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference organization Organization where the roles are available */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $organization = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> code Roles which this practitioner may perform */
		...
		public array $code = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> specialty Specific specialty of the practitioner */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $specialty = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> location Location(s) where the practitioner provides care */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> healthcareService Healthcare services provided for this role's Organization/Location(s) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $healthcareService = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\ExtendedContactDetail> contact Official contact details relating to this PractitionerRole */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> communication A language the practitioner (in this role) can use in patient communication */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $communication = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Availability> availability Times the Practitioner is available at this location and/or healthcare service (including exceptions) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> endpoint Endpoints for interacting with the practitioner in this role */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
