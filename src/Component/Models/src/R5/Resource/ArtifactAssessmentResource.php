...
class ArtifactAssessmentResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Additional identifier for the artifact assessment */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string title A short title for the assessment for use in displaying and selecting */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $title = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive citeAs How to cite the comment or rating */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive approvalDate When the artifact assessment was approved by publisher */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive lastReviewDate When the artifact assessment was last reviewed by the publisher */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive $lastReviewDate = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive artifact The artifact assessed, commented upon or rated */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(
			fhirType: 'choice',
			propertyKind: 'choice',
			isRequired: true,
		...
		public \Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive|null $artifact = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ArtifactAssessment\ArtifactAssessmentContent> content Comment, classifier, or rating content */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\ArtifactAssessmentWorkflowStatusType workflowStatus submitted | triaged | waiting-for-input | resolved-no-change | resolved-change-required | deferred | duplicate | applied | published | entered-in-error */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\ArtifactAssessmentWorkflowStatusType $workflowStatus = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\ArtifactAssessmentDispositionType disposition unresolved | not-persuasive | persuasive | persuasive-with-modification | not-persuasive-with-modification */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\ArtifactAssessmentDispositionType $disposition = null,
	) {
