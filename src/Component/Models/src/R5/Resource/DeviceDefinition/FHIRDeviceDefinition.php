...
class FHIRDeviceDefinition extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRMarkdown description Additional information to describe the device */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRReference manufacturer Name of device manufacturer */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRString|string modelNumber The catalog or model number for the device for example as defined by the manufacturer */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRCodeableConcept> safety Safety characteristics of the device */
		public array $safety = [],
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRCodeableConcept> languageCode Language code for the human-readable text strings produced by the device (all supported) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRDeviceProductionIdentifierInUDIType> productionIdentifierInUDI lot-number | manufactured-date | serial-number | expiration-date | biological-source | software-version */
