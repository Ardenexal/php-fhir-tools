 ...
 */
#[FHIRBackboneElement(parentResource: 'DeviceDefinition', elementPath: 'DeviceDefinition.udiDeviceIdentifier', fhirVersion: 'R5')]
class DeviceDefinitionUdiDeviceIdentifier extends BackboneElement
{
    public function __construct(
        ...
        /** @var StringPrimitive|string|null deviceIdentifier The identifier that is to be associated with every Device that references this DeviceDefintiion for the issuer and jurisdiction provided in the DeviceDefinition.udiDeviceIdentifier */
        ...
        /** @var array<DeviceDefinitionUdiDeviceIdentifierMarketDistribution> marketDistribution Indicates whether and when the device is available on the market */
        #[FhirProperty(
            fhirType: 'BackboneElement',
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\DeviceDefinition\DeviceDefinitionUdiDeviceIdentifierMarketDistribution',
        )]
