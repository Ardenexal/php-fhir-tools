...
class DeviceDefinitionPackaging extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier identifier Business identifier of the packaged medication */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept type A code that defines the specific type of packaging */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $type = null,
		/** @var null|int count The number of items contained in the package (devices or sub-packages) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'integer', propertyKind: 'scalar')]
		public ?int $count = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\DeviceDefinition\DeviceDefinitionPackagingDistributor> distributor An organization that distributes the packaged device */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\DeviceDefinition\DeviceDefinitionUdiDeviceIdentifier> udiDeviceIdentifier Unique Device Identifier (UDI) Barcode string on the packaging */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\DeviceDefinition\DeviceDefinitionPackaging> packaging Allows packages within packages */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'unknown', propertyKind: 'complex', isArray: true)]
