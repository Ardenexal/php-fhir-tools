...
class MedicationKnowledgeIndicationGuidelineDosingGuidelineDosage extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var CodeableConcept|null type Category of dosage for a medication */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isRequired: true), NotBlank]
        public ?CodeableConcept $type = null,
        /** @var array<Dosage> dosage Dosage for the medication for the specific guidelines */
        #[FhirProperty(fhirType: 'Dosage', propertyKind: 'complex', isArray: true, isRequired: true)]
        public array $dosage = [],
    ) {
