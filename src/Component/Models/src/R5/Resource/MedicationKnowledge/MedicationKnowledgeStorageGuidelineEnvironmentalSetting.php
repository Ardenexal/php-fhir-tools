...
class MedicationKnowledgeStorageGuidelineEnvironmentalSetting extends BackboneElement
{
    public function __construct(
        ...
        /** @var CodeableConcept|null type Categorization of the setting */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isRequired: true), NotBlank]
        public ?CodeableConcept $type = null,
        /** @var Quantity|Range|CodeableConcept|null value Value of the setting */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isRequired: true,
        ...
        #[NotBlank]
        public Quantity|Range|CodeableConcept|null $value = null,
    ) {
