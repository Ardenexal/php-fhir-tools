...
class FHIRMedicationKnowledge extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRCodeableConcept code Code that identifies this medication */
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRCodeableConcept $code = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRMedicationKnowledgeStatusCodesType status active | entered-in-error | inactive */
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRMedicationKnowledgeStatusCodesType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRReference author Creator or owner of the knowledge or information about the medication */
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRReference $author = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRCodeableConcept> intendedJurisdiction Codes that identify the different jurisdictions for which the information of this resource was created */
		public array $intendedJurisdiction = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRString|string> name A name associated with the medication being described */
		public array $name = [],
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRReference> associatedMedication The set of medication resources that are associated with this medication */
		public array $associatedMedication = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRCodeableConcept> productType Category of the medication or product */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRMarkdown preparationInstruction The instructions for preparing the medication */
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\FHIRMarkdown $preparationInstruction = null,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRReference> clinicalUseIssue Potential clinical issue with or between medication(s) */
