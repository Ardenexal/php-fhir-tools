...
class MedicationKnowledgeRegulatoryMaxDispense extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Quantity quantity The maximum number of units of the medication that can be dispensed */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Duration period The period that applies to the maximum number of units */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Duration', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Duration $period = null,
	) {
