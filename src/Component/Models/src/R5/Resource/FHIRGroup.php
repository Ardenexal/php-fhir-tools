...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRGroupMembershipBasisType;
use Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRGroupTypeType;
...
class FHIRGroup extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var array<FHIRIdentifier> identifier Business Identifier for this Group */
        public array $identifier = [],
        /** @var FHIRBoolean|null active Whether this group's record is in active use */
        public ?FHIRBoolean $active = null,
        /** @var FHIRGroupTypeType|null type person | animal | practitioner | device | careteam | healthcareservice | location | organization | relatedperson | specimen */
        #[NotBlank]
        public ?FHIRGroupTypeType $type = null,
        /** @var FHIRGroupMembershipBasisType|null membership definitional | enumerated */
        #[NotBlank]
        ...
        /** @var FHIRMarkdown|null description Natural language description of the group */
