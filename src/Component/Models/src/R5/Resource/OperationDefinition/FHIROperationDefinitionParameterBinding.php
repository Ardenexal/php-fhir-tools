...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRBindingStrengthType;
 ...
 */
#[FHIRBackboneElement(parentResource: 'OperationDefinition', elementPath: 'OperationDefinition.parameter.binding', fhirVersion: 'R5')]
