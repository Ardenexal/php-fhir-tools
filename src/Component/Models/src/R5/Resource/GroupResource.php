...
class GroupResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business Identifier for this Group */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\GroupTypeType type person | animal | practitioner | device | careteam | healthcareservice | location | organization | relatedperson | specimen */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\GroupTypeType $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\GroupMembershipBasisType membership definitional | enumerated */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\GroupMembershipBasisType $membership = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept code Kind of Group members */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $code = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name Label for Group */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $name = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Natural language description of the group */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UnsignedIntPrimitive quantity Number of members */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'unsignedInt', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UnsignedIntPrimitive $quantity = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference managingEntity Entity that is the custodian of the Group's definition */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Group\GroupCharacteristic> characteristic Include / Exclude group members by Trait */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Group\GroupMember> member Who or what is in group */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $member = [],
	) {
