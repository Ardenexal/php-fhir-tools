...
class DeviceAssociationResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference device Reference to the devices associated with the patient or group */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> category Describes the relationship between the device and subject */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept status implanted | explanted | attached | entered-in-error | unknown */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> statusReason The reasons given for the current association status */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $statusReason = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject The individual, group of individuals or device that the device is on or associated with */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference bodyStructure Current anatomical location of the device in/on subject */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $bodyStructure = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period period Begin and end dates and times for the device association */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\DeviceAssociation\DeviceAssociationOperation> operation The details about the device when it is in use to describe its operation */
