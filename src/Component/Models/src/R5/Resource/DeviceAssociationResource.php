...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\DeviceAssociation\DeviceAssociationOperation;
...
class DeviceAssociationResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/deviceassociation-status|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\DeviceAssociationCodes',
        )]
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/deviceassociation-status-reason|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\DeviceAssociationCodes',
        )]
        ...
        /** @var array<DeviceAssociationOperation> operation The details about the device when it is in use to describe its operation */
        #[FhirProperty(
            fhirType: 'BackboneElement',
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\DeviceAssociation\DeviceAssociationOperation',
        )]
        #[Valid]
