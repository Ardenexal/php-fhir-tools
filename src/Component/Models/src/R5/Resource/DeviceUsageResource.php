...
class DeviceUsageResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier External identifier for this record */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\DeviceUsageStatusType status active | completed | not-done | entered-in-error + */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\DeviceUsageStatusType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> category The category of the statement - classifying how the statement is made */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference patient Patient using device */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> derivedFrom Supporting information */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $derivedFrom = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference context The encounter or episode of care that establishes the context for this device use statement */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $context = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Timing|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive timing How often  the device was used */
		...
		public \Ardenexal\FHIRTools\Component\Models\R5\DataType\Timing|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive|null $timing = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive dateAsserted When the statement was made (and recorded) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept usageStatus The status of the device usage, for example always, sometimes, never. This is not the same as the status of the statement */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $usageStatus = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> usageReason The reason for asserting the usage status - for example forgot, lost, stolen, broken */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $usageReason = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\DeviceUsage\DeviceUsageAdherence adherence How device is being used */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?DeviceUsage\DeviceUsageAdherence $adherence = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference informationSource Who made the statement */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $informationSource = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference device Code or Reference to device used */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> reason Why device was used */
		...
		public array $reason = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference bodySite Target body site */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableReference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference $bodySite = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note Addition details (comments, instructions) */
