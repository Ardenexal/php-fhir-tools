...
class SubscriptionTopicResourceTrigger extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Text representation of the resource trigger */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive resource Data Type or Resource (reference to definition) for this trigger definition */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\InteractionTriggerType> supportedInteraction create | update | delete */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\SubscriptionTopic\SubscriptionTopicResourceTriggerQueryCriteria queryCriteria Query based trigger rule */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string fhirPathCriteria FHIRPath based trigger rule */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $fhirPathCriteria = null,
	) {
