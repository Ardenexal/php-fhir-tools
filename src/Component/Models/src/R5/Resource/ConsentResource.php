...
class ConsentResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Identifier for this record (external references) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\ConsentStateType status draft | active | inactive | not-done | entered-in-error | unknown */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\ConsentStateType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> category Classification of the consent statement - for indexing/retrieval */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject Who the consent applies to */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive date Fully executed date of the consent */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period period Effective period for this Consent */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> grantor Who is granting rights according to the policy and rules */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> grantee Who is agreeing to the policy and rules */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $grantee = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> manager Consent workflow management */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $manager = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> controller Consent Enforcer */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $controller = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Attachment> sourceAttachment Source from which this consent is taken */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> sourceReference Source from which this consent is taken */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $sourceReference = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> regulatoryBasis Regulations establishing base Consent */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $regulatoryBasis = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\Consent\ConsentPolicyBasis policyBasis Computable version of the backing policy */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?Consent\ConsentPolicyBasis $policyBasis = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> policyText Human Readable Policy */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $policyText = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Consent\ConsentVerification> verification Consent Verified by patient or family */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\ConsentProvisionTypeType decision deny | permit */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\ConsentProvisionTypeType $decision = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Consent\ConsentProvision> provision Constraints to the base Consent.policyRule/Consent.policy */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
