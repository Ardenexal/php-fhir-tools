...
class SlotResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> serviceType The type of appointments that can be booked into this slot (ideally this would be an identifiable service - which is at a location, rather than the location itself). If provided then this overrides the value provided on the Schedule resource */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> appointmentType The style of appointment or patient that may be booked in the slot (not service type) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $appointmentType = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference schedule The schedule resource that this slot defines an interval of status information */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $schedule = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\SlotStatusType status busy | free | busy-unavailable | busy-tentative | entered-in-error */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\SlotStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive start Date/Time that the slot is to begin */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive end Date/Time that the slot is to conclude */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'instant', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string comment Comments on the slot to describe any extended information. Such as custom constraints on the slot */
