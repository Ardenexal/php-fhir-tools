...
class CapabilityStatementResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive url Canonical identifier for this capability statement, represented as a URI (globally unique) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'uri', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive $url = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Additional identifier for the CapabilityStatement (business identifier) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string version Business version of the capability statement */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name Name for this capability statement (computer friendly) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $name = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string title Name for this capability statement (human friendly) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Natural language description of the capability statement */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> jurisdiction Intended jurisdiction for capability statement (if applicable) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive purpose Why this capability statement is defined */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CapabilityStatementKindType kind instance | capability | requirements */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CapabilityStatementKindType $kind = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive> instantiates Canonical URL of another capability statement this implements */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive> imports Canonical URL of another capability statement this adds to */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'canonical', propertyKind: 'primitive', isArray: true)]
		public array $imports = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\CapabilityStatement\CapabilityStatementSoftware software Software that is covered by this capability statement */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\CapabilityStatement\CapabilityStatementImplementation implementation If this describes a specific instance */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?CapabilityStatement\CapabilityStatementImplementation $implementation = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRVersionType fhirVersion FHIR Version the system supports */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRVersionType $fhirVersion = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\MimeTypesType> format formats supported (xml | json | ttl | mime type) */
		...
		public array $format = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\MimeTypesType> patchFormat Patch formats supported */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\AllLanguagesType> acceptLanguage Languages supported */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive', isArray: true)]
		public array $acceptLanguage = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive> implementationGuide Implementation guides supported */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'canonical', propertyKind: 'primitive', isArray: true)]
		public array $implementationGuide = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\CapabilityStatement\CapabilityStatementRest> rest If the endpoint is a RESTful one */
		...
		public array $rest = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\CapabilityStatement\CapabilityStatementMessaging> messaging If messaging is supported */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $messaging = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\CapabilityStatement\CapabilityStatementDocument> document Document definition */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
