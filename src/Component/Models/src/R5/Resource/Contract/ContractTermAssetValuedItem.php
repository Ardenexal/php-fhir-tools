 ...
 */
#[FHIRBackboneElement(parentResource: 'Contract', elementPath: 'Contract.term.asset.valuedItem', fhirVersion: 'R5')]
class ContractTermAssetValuedItem extends BackboneElement
{
    public function __construct(
        ...
        /** @var numeric-string|null points Contract Valued Item Difficulty Scaling Factor */
        #[FhirProperty(fhirType: 'decimal', propertyKind: 'scalar')]
