...
class ContractTermOffer extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\Contract\ContractTermOfferParty',
        )]
        #[Valid]
        public array $party = [],
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://terminology.hl7.org/ValueSet/v3-ActConsentDirective',
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\ActConsentDirective',
        )]
