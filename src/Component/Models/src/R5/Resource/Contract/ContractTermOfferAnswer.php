 ...
 */
#[FHIRBackboneElement(parentResource: 'Contract', elementPath: 'Contract.term.offer.answer', fhirVersion: 'R5')]
class ContractTermOfferAnswer extends BackboneElement
{
    public function __construct(
        ...
        /** @var bool|string|int|DatePrimitive|DateTimePrimitive|TimePrimitive|StringPrimitive|UriPrimitive|Attachment|Coding|Quantity|Reference|null value The actual answer response */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isRequired: true,
