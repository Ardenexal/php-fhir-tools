...
class AppointmentResponseResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference appointment Appointment this response relates to */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $appointment = null,
		/** @var null|bool proposedNewTime Indicator for a counter proposal */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive start Time from appointment, or requested new start time */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive end Time from appointment, or requested new end time */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'instant', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive $end = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> participantType Role of participant in the appointment */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference actor Person(s), Location, HealthcareService, or Device */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\AppointmentResponseStatusType participantStatus accepted | declined | tentative | needs-action | entered-in-error */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\AppointmentResponseStatusType $participantStatus = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive comment Additional comments */
		...
		/** @var null|bool recurring This response is for all occurrences in a recurring request */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'boolean', propertyKind: 'scalar')]
		public ?bool $recurring = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive occurrenceDate Original date within a recurring request */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive $occurrenceDate = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\PositiveIntPrimitive recurrenceId The recurrence ID of the specific recurring request */
