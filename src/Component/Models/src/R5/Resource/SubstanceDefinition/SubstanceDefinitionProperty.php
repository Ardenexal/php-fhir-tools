 ...
 */
#[FHIRBackboneElement(parentResource: 'SubstanceDefinition', elementPath: 'SubstanceDefinition.property', fhirVersion: 'R5')]
class SubstanceDefinitionProperty extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var CodeableConcept|null type A code expressing the type of property */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isRequired: true), NotBlank]
        public ?CodeableConcept $type = null,
        /** @var CodeableConcept|Quantity|DatePrimitive|bool|Attachment|null value A value for the property */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isChoice: true,
