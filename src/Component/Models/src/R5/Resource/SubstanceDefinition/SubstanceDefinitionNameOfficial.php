 ...
 */
#[FHIRBackboneElement(parentResource: 'SubstanceDefinition', elementPath: 'SubstanceDefinition.name.official', fhirVersion: 'R5')]
class SubstanceDefinitionNameOfficial extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex'), Valid, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/substance-name-authority', strength: 'preferred')]
        public ?CodeableConcept $authority = null,
        /** @var CodeableConcept|null status The status of the official name, for example 'draft', 'active' */
