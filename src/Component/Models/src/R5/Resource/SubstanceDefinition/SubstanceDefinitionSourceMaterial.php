 ...
 */
#[FHIRBackboneElement(parentResource: 'SubstanceDefinition', elementPath: 'SubstanceDefinition.sourceMaterial', fhirVersion: 'R5')]
class SubstanceDefinitionSourceMaterial extends BackboneElement
{
    public function __construct(
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/country|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\CountryValueSet',
        )]
