...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\EligibilityOutcomeType;
use Ardenexal\FHIRTools\Component\Models\R5\DataType\EligibilityResponsePurposeType;
...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\CoverageEligibilityResponse\CoverageEligibilityResponseError;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\CoverageEligibilityResponse\CoverageEligibilityResponseEvent;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\CoverageEligibilityResponse\CoverageEligibilityResponseInsurance;
...
class CoverageEligibilityResponseResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FhirProperty(
            ...
            isArray: true,
            isRequired: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\DataType\EligibilityResponsePurposeType',
        )]
        #[Count(min: 1)]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/eligibilityresponse-purpose|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\EligibilityResponsePurpose',
        )]
        ...
        /** @var array<CoverageEligibilityResponseEvent> event Event information */
        #[FhirProperty(
            fhirType: 'BackboneElement',
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\CoverageEligibilityResponse\CoverageEligibilityResponseEvent',
        )]
        #[Valid]
        public array $event = [],
        ...
        #[FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isRequired: true), Valid, NotBlank, FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/CoverageEligibilityRequest'])]
        public ?Reference $request = null,
        /** @var EligibilityOutcomeType|null outcome queued | complete | error | partial */
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true)]
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/eligibility-outcome|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\EligibilityOutcome',
        )]
        public ?EligibilityOutcomeType $outcome = null,
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\CoverageEligibilityResponse\CoverageEligibilityResponseInsurance',
        )]
        #[Valid]
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\CoverageEligibilityResponse\CoverageEligibilityResponseError',
        )]
        #[Valid]
        public array $error = [],
    ) {
