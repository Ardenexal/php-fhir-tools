...
class CoverageEligibilityResponseResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business Identifier for coverage eligiblity request */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\EligibilityResponsePurposeType> purpose auth-requirements | benefits | discovery | validation */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference patient Intended recipient of products and services */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\CoverageEligibilityResponse\CoverageEligibilityResponseEvent> event Event information */
		...
		public array $event = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period serviced Estimated date or dates of service */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference requestor Party responsible for the request */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference request Eligibility request reference */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $request = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\EligibilityOutcomeType outcome queued | complete | error | partial */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\EligibilityOutcomeType $outcome = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference insurer Coverage issuer */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $insurer = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\CoverageEligibilityResponse\CoverageEligibilityResponseInsurance> insurance Patient insurance information */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept form Printed form identifier */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $form = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\CoverageEligibilityResponse\CoverageEligibilityResponseError> error Processing errors */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $error = [],
	) {
