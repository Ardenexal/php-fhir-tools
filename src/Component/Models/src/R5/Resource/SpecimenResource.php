...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\SpecimenCombinedType;
use Ardenexal\FHIRTools\Component\Models\R5\DataType\SpecimenStatusType;
use Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive;
use Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\Specimen\SpecimenCollection;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\Specimen\SpecimenContainer;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\Specimen\SpecimenFeature;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\Specimen\SpecimenProcessing;
 ...
 */
#[FhirResource(type: 'Specimen', version: '5.0.0', url: 'http://hl7.org/fhir/StructureDefinition/Specimen', fhirVersion: 'R5')]
class SpecimenResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/specimen-status|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\SpecimenStatus',
        )]
        ...
        /** @var Reference|null subject Where the specimen came from. This may be from patient(s), from a location (e.g., the source of an environmental sample), or a sampling of a substance, a biologically-derived product, or a device */
        ...
        /** @var DateTimePrimitive|null receivedTime The time when specimen is received by the testing laboratory */
        ...
        /** @var SpecimenCombinedType|null combined grouped | pooled */
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/specimen-combined|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\SpecimenCombined',
        )]
        public ?SpecimenCombinedType $combined = null,
        /** @var array<CodeableConcept> role The role the specimen serves */
        #[FhirProperty(
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/specimen-role',
            strength: 'preferred',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\SpecimenRole',
        )]
        public array $role = [],
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\Specimen\SpecimenFeature',
        )]
        #[Valid]
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\Specimen\SpecimenProcessing',
        )]
        #[Valid]
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\Specimen\SpecimenContainer',
        )]
        #[Valid]
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://terminology.hl7.org/ValueSet/v2-0493',
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\Hl7VSSpecimenCondition',
        )]
