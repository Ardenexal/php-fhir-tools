...
class SpecimenResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier accessionIdentifier Identifier assigned by the lab */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Identifier', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier $accessionIdentifier = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\SpecimenStatusType status available | unavailable | unsatisfactory | entered-in-error */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\SpecimenStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept type Kind of material that forms the specimen */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject Where the specimen came from. This may be from patient(s), from a location (e.g., the source of an environmental sample), or a sampling of a substance, a biologically-derived product, or a device */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive receivedTime The time when specimen is received by the testing laboratory */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive $receivedTime = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> parent Specimen from which this specimen originated */
		...
		public array $parent = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> request Why the specimen was collected */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $request = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\SpecimenCombinedType combined grouped | pooled */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\SpecimenCombinedType $combined = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> role The role the specimen serves */
		...
		public array $role = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Specimen\SpecimenFeature> feature The physical feature of a specimen */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\Specimen\SpecimenCollection collection Collection details */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Specimen\SpecimenProcessing> processing Processing and processing step details */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $processing = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Specimen\SpecimenContainer> container Direct container of specimen (tube/slide, etc.) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $container = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> condition State of the specimen */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
