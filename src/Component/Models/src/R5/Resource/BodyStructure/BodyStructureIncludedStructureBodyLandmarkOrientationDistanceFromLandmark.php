...
class BodyStructureIncludedStructureBodyLandmarkOrientationDistanceFromLandmark extends BackboneElement
{
    public function __construct(
        ...
        /** @var array<CodeableReference> device Measurement device */
        #[FhirProperty(
