...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRRequestResourceTypesType;
...
class FHIRActivityDefinition extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var FHIRMarkdown|null usage Describes the clinical usage of the activity definition */
        ...
        /** @var FHIRDate|null lastReviewDate When the activity definition was last reviewed by the publisher */
        ...
        /** @var FHIRRequestResourceTypesType|null kind Kind of resource */
        ...
        /** @var FHIRTiming|FHIRAge|FHIRRange|FHIRDuration|null timingX When activity is to occur */
        ...
        /** @var array<FHIRCanonical> specimenRequirement What specimens are required to perform this action */
        public array $specimenRequirement = [],
        /** @var array<FHIRCanonical> observationRequirement What observations are required to perform this action */
        public array $observationRequirement = [],
        /** @var array<FHIRCanonical> observationResultRequirement What observations must be produced by this action */
