...
class FHIRClinicalUseDefinition extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRIdentifier> identifier Business identifier for this issue */
		public array $identifier = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRClinicalUseDefinitionTypeType type indication | contraindication | interaction | undesirable-effect | warning */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRClinicalUseDefinitionTypeType $type = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRCodeableConcept> category A categorisation of the issue, primarily for dividing warnings into subject heading areas such as "Pregnancy", "Overdose" */
		public array $category = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRReference> subject The medication, product, substance, device, procedure etc. for which this is an indication */
		public array $subject = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRCodeableConcept status Whether this is a current issue or one that has been retired etc */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRReference> population The population group to which this applies */
		public array $population = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRCanonical> library Logic used by the clinical use definition */
