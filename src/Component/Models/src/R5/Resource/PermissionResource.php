...
class PermissionResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\PermissionStatusType status active | entered-in-error | draft | rejected */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\PermissionStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference asserter The person or entity that asserts the permission */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $asserter = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive> date The date that permission was asserted */
		...
		public array $date = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period validity The period in which the permission is active */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Period', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period $validity = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\Permission\PermissionJustification justification The asserted justification for using the data */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?Permission\PermissionJustification $justification = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\PermissionRuleCombiningType combining deny-overrides | permit-overrides | ordered-deny-overrides | ordered-permit-overrides | deny-unless-permit | permit-unless-deny */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\PermissionRuleCombiningType $combining = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Permission\PermissionRule> rule Constraints to the Permission */
