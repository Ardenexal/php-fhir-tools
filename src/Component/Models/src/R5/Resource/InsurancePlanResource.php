...
class InsurancePlanResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business Identifier for Product */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> type Kind of product */
		...
		public array $type = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name Official name */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $name = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string> alias Alternate names */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive', isArray: true)]
		public array $alias = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period period When the product is available */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference ownedBy Product issuer */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $ownedBy = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference administeredBy Product administrator */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $administeredBy = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> coverageArea Where product applies */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\ExtendedContactDetail> contact Official contact details relevant to the health insurance plan/product */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> endpoint Technical endpoint */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $endpoint = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> network What networks are Included */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $network = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\InsurancePlan\InsurancePlanCoverage> coverage Coverage details */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\InsurancePlan\InsurancePlanPlan> plan Plan details */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $plan = [],
	) {
