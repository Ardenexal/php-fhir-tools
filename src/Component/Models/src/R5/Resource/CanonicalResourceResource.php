...
abstract class CanonicalResourceResource extends DomainResourceResource
{
    ...
    public function __construct(
        ...
        /** @var UriPrimitive|null url Canonical identifier for this {{title}}, represented as an absolute URI (globally unique) */
        #[FhirProperty(fhirType: 'uri', propertyKind: 'primitive')]
        public ?UriPrimitive $url = null,
        /** @var array<Identifier> identifier Additional identifier for the {{title}} */
        #[FhirProperty(fhirType: 'Identifier', propertyKind: 'complex', isArray: true)]
        public array $identifier = [],
        /** @var StringPrimitive|string|null version Business version of the {{title}} */
        ...
        /** @var StringPrimitive|string|null title Name for this {{title}} (human friendly) */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        ...
        /** @var MarkdownPrimitive|null description Natural language description of the {{title}} */
        ...
        /** @var array<CodeableConcept> jurisdiction Intended jurisdiction for {{title}} (if applicable) */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
        public array $jurisdiction = [],
        /** @var MarkdownPrimitive|null purpose Why this {{title}} is defined */
        #[FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
