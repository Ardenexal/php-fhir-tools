...
class FHIRRelatedPerson extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var array<FHIRCodeableConcept> relationship The relationship of the related person to the patient */
        ...
        /** @var array<FHIRRelatedPersonCommunication> communication A language which may be used to communicate with the related person about the patient's health */
