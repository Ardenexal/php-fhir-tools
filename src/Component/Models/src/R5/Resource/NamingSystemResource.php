...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\NamingSystemTypeType;
...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\NamingSystem\NamingSystemUniqueId;
...
class NamingSystemResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var UriPrimitive|null url Canonical identifier for this naming system, represented as a URI (globally unique) */
        #[FhirProperty(fhirType: 'uri', propertyKind: 'primitive')]
        public ?UriPrimitive $url = null,
        /** @var array<Identifier> identifier Additional identifier for the naming system (business identifier) */
        #[FhirProperty(
            fhirType: 'Identifier',
        ...
        /** @var StringPrimitive|string|null version Business version of the naming system */
        ...
        /** @var StringPrimitive|string|null title Title for this naming system (human friendly) */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/namingsystem-type|5.0.0', strength: 'required')]
        ...
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex'), Valid, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/namingsystem-identifier-system-type', strength: 'preferred')]
        ...
        /** @var DatePrimitive|null approvalDate When the NamingSystem was approved by publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
        public ?DatePrimitive $approvalDate = null,
        /** @var DatePrimitive|null lastReviewDate When the NamingSystem was last reviewed by the publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
        public ?DatePrimitive $lastReviewDate = null,
        /** @var Period|null effectivePeriod When the NamingSystem is expected to be used */
        ...
        #[Valid]
        public array $author = [],
        /** @var array<ContactDetail> editor Who edited the NamingSystem */
        #[FhirProperty(
            fhirType: 'ContactDetail',
            propertyKind: 'complex',
            isArray: true,
        ...
        #[Valid]
        public array $editor = [],
        /** @var array<ContactDetail> reviewer Who reviewed the NamingSystem */
        #[FhirProperty(
            fhirType: 'ContactDetail',
            propertyKind: 'complex',
            isArray: true,
        ...
        /** @var array<ContactDetail> endorser Who endorsed the NamingSystem */
        #[FhirProperty(
            fhirType: 'ContactDetail',
            propertyKind: 'complex',
            isArray: true,
        ...
        #[FhirProperty(
            ...
            isArray: true,
            isRequired: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\NamingSystem\NamingSystemUniqueId',
        )]
        #[Valid]
        #[Count(min: 1)]
