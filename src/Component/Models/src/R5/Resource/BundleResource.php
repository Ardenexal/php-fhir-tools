...
class BundleResource extends ResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier identifier Persistent identifier for the bundle */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\BundleTypeType type document | message | transaction | transaction-response | batch | batch-response | history | searchset | collection | subscription-notification */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\BundleTypeType $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive timestamp When the bundle was assembled */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'instant', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive $timestamp = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UnsignedIntPrimitive total If search, the total number of matches */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'unsignedInt', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UnsignedIntPrimitive $total = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Bundle\BundleLink> link Links related to this Bundle */
		...
		public array $link = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Bundle\BundleEntry> entry Entry in the bundle - will have a resource or information */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $entry = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Signature signature Digital Signature */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Signature', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Signature $signature = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\ResourceResource issues Issues with the Bundle */
