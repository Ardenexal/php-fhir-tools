...
class ClinicalUseDefinitionResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business identifier for this issue */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\ClinicalUseDefinitionTypeType type indication | contraindication | interaction | undesirable-effect | warning */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\ClinicalUseDefinitionTypeType $type = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> category A categorisation of the issue, primarily for dividing warnings into subject heading areas such as "Pregnancy", "Overdose" */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> subject The medication, product, substance, device, procedure etc. for which this is an indication */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept status Whether this is a current issue or one that has been retired etc */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\ClinicalUseDefinition\ClinicalUseDefinitionContraindication contraindication Specifics for when this is a contraindication */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?ClinicalUseDefinition\ClinicalUseDefinitionContraindication $contraindication = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\ClinicalUseDefinition\ClinicalUseDefinitionIndication indication Specifics for when this is an indication */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?ClinicalUseDefinition\ClinicalUseDefinitionIndication $indication = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\ClinicalUseDefinition\ClinicalUseDefinitionInteraction interaction Specifics for when this is an interaction */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?ClinicalUseDefinition\ClinicalUseDefinitionInteraction $interaction = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> population The population group to which this applies */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $population = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive> library Logic used by the clinical use definition */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\ClinicalUseDefinition\ClinicalUseDefinitionUndesirableEffect undesirableEffect A possible negative outcome from the use of this treatment */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?ClinicalUseDefinition\ClinicalUseDefinitionUndesirableEffect $undesirableEffect = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\ClinicalUseDefinition\ClinicalUseDefinitionWarning warning Critical environmental, health or physical risks or hazards. For example 'Do not operate heavy machinery', 'May cause drowsiness' */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?ClinicalUseDefinition\ClinicalUseDefinitionWarning $warning = null,
	) {
