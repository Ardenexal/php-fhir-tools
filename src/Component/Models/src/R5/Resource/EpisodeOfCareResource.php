...
class EpisodeOfCareResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business Identifier(s) relevant for this EpisodeOfCare */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\EpisodeOfCare\EpisodeOfCareStatusHistory> statusHistory Past list of status codes (the current status may be included to cover the start date of the status) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> type Type/class  - e.g. specialist referral, disease management */
		...
		public array $type = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\EpisodeOfCare\EpisodeOfCareReason> reason The list of medical reasons that are expected to be addressed during the episode of care */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $reason = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\EpisodeOfCare\EpisodeOfCareDiagnosis> diagnosis The list of medical conditions that were addressed during the episode of care */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $diagnosis = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference patient The patient who is the focus of this episode of care */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference managingOrganization Organization that assumes responsibility for care coordination */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period period Interval during responsibility is assumed */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> referralRequest Originating Referral Request(s) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference careManager Care manager/care coordinator for the patient */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $careManager = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> careTeam Other practitioners facilitating this episode of care */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $careTeam = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> account The set of accounts that may be used for billing for this EpisodeOfCare */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
