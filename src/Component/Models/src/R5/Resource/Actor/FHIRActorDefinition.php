...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRExampleScenarioActorTypeType;
...
class FHIRActorDefinition extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var FHIRUri|null url Canonical identifier for this actor definition, represented as a URI (globally unique) */
        public ?FHIRUri $url = null,
        /** @var array<FHIRIdentifier> identifier Additional identifier for the actor definition (business identifier) */
        public array $identifier = [],
        /** @var FHIRString|string|null version Business version of the actor definition */
        ...
        /** @var FHIRString|string|null name Name for this actor definition (computer friendly) */
        public FHIRString|string|null $name = null,
        /** @var FHIRString|string|null title Name for this actor definition (human friendly) */
        ...
        /** @var FHIRMarkdown|null description Natural language description of the actor */
        public ?FHIRMarkdown $description = null,
        /** @var array<FHIRUsageContext> useContext The context that the content is intended to support */
        public array $useContext = [],
        /** @var array<FHIRCodeableConcept> jurisdiction Intended jurisdiction for actor definition (if applicable) */
        public array $jurisdiction = [],
        /** @var FHIRMarkdown|null purpose Why this actor definition is defined */
        ...
        /** @var FHIRMarkdown|null documentation Functionality associated with the actor */
        public ?FHIRMarkdown $documentation = null,
        /** @var array<FHIRUrl> reference Reference to more information about the actor */
        public array $reference = [],
        /** @var FHIRCanonical|null capabilities CapabilityStatement for the actor (if applicable) */
        public ?FHIRCanonical $capabilities = null,
        /** @var array<FHIRCanonical> derivedFrom Definition of this actor in another context / IG */
