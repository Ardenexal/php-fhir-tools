...
namespace Ardenexal\FHIRTools\Component\Models\R5\Resource\Linkage;
...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\LinkageTypeType;
...
class LinkageItem extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/linkage-type|5.0.0', strength: 'required')]
