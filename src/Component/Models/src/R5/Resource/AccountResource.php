...
class AccountResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Account number */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\AccountStatusType status active | inactive | entered-in-error | on-hold | unknown */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\AccountStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept billingStatus Tracks the lifecycle of the account through the billing process */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $billingStatus = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept type E.g. patient, expense, depreciation */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name Human-readable label */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $name = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> subject The entity that caused the expenses */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period servicePeriod Transaction window */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Period', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period $servicePeriod = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Account\AccountCoverage> coverage The party(s) that are responsible for covering the payment of this account, and what order should they be applied to the account */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference owner Entity managing the Account */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Explanation of purpose/use */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Account\AccountGuarantor> guarantor The parties ultimately responsible for balancing the Account */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $guarantor = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Account\AccountDiagnosis> diagnosis The list of diagnoses relevant to this account */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $diagnosis = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Account\AccountProcedure> procedure The list of procedures relevant to this account */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $procedure = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Account\AccountRelatedAccount> relatedAccount Other associated accounts related to this account */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $relatedAccount = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept currency The base or default currency */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $currency = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Account\AccountBalance> balance Calculated account balance(s) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $balance = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive calculatedAt Time the balance amount was calculated */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'instant', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive $calculatedAt = null,
	) {
