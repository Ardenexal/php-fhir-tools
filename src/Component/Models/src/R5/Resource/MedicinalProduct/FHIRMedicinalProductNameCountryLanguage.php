 ...
 */
#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FHIRBackboneElement(parentResource: 'MedicinalProduct', elementPath: 'MedicinalProduct.name.countryLanguage', fhirVersion: 'R5')]
class FHIRMedicinalProductNameCountryLanguage extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRBackboneElement
{
