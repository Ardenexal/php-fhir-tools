...
class FHIRCapabilityStatement extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var array<FHIRIdentifier> identifier Additional identifier for the CapabilityStatement (business identifier) */
        ...
        /** @var array<FHIRAllLanguagesType> acceptLanguage Languages supported */
