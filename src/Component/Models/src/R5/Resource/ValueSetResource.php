...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\ValueSet\ValueSetCompose;
 ...
 */
#[FhirResource(type: 'ValueSet', version: '5.0.0', url: 'http://hl7.org/fhir/StructureDefinition/ValueSet', fhirVersion: 'R5')]
#[FHIRPathInvariant(
    key: 'cnl-0',
    severity: 'warning',
...
class ValueSetResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var DatePrimitive|null approvalDate When the ValueSet was approved by publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
        public ?DatePrimitive $approvalDate = null,
        /** @var DatePrimitive|null lastReviewDate When the ValueSet was last reviewed by the publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
