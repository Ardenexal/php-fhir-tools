...
class FHIRPackagedProductDefinition extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRIdentifier> identifier A unique identifier for this package as whole - not for the content of the package */
		public array $identifier = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRString|string name A name for this package. Typically as listed in a drug formulary, catalogue, inventory etc */
		public FHIRString|string|null $name = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRCodeableConcept type A high level category e.g. medicinal product, raw material, shipping container etc */
		public ?FHIRCodeableConcept $type = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRReference> packageFor The product that this is a pack for */
		public array $packageFor = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRCodeableConcept status The status within the lifecycle of this item. High level - not intended to duplicate details elsewhere e.g. legal status, or authorization/marketing status */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRQuantity> containedItemQuantity A total of the complete count of contained items of a particular type/form, independent of sub-packaging or organization. This can be considered as the pack size. See also packaging.containedItem.amount (especially the long definition) */
		public array $containedItemQuantity = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRMarkdown description Textual description. Note that this is not the name of the package or product */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRBoolean copackagedIndicator Identifies if the drug product is supplied with another item such as a diluent or adjuvant */
		public ?FHIRBoolean $copackagedIndicator = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRReference> manufacturer Manufacturer of this package type (multiple means these are all possible manufacturers) */
		public array $manufacturer = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\FHIRReference> attachedDocument Additional information or supporting documentation about the packaged product */
