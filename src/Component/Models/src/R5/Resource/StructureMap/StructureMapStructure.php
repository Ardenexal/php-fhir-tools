...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\StructureMapModelModeType;
 ...
 */
#[FHIRBackboneElement(parentResource: 'StructureMap', elementPath: 'StructureMap.structure', fhirVersion: 'R5')]
class StructureMapStructure extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/map-model-mode|5.0.0', strength: 'required')]
