 ...
 */
#[FHIRBackboneElement(parentResource: 'StructureMap', elementPath: 'StructureMap.const', fhirVersion: 'R5')]
class StructureMapConst extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var IdPrimitive|null name Constant name */
        #[FhirProperty(fhirType: 'id', propertyKind: 'primitive')]
        public ?IdPrimitive $name = null,
        /** @var StringPrimitive|string|null value FHIRPath exression - value of the constant */
