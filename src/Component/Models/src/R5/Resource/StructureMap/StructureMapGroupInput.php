...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\StructureMapInputModeType;
 ...
 */
#[FHIRBackboneElement(parentResource: 'StructureMap', elementPath: 'StructureMap.group.input', fhirVersion: 'R5')]
class StructureMapGroupInput extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/map-input-mode|5.0.0', strength: 'required')]
