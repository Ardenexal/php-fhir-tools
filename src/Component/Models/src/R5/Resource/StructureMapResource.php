...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\StructureMap\StructureMapConst;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\StructureMap\StructureMapGroup;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\StructureMap\StructureMapStructure;
 ...
 */
#[FhirResource(type: 'StructureMap', version: '5.0.0', url: 'http://hl7.org/fhir/StructureDefinition/StructureMap', fhirVersion: 'R5')]
#[FHIRPathInvariant(
    key: 'cnl-0',
    severity: 'warning',
...
class StructureMapResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var UriPrimitive|null url Canonical identifier for this structure map, represented as a URI (globally unique) */
        #[FhirProperty(fhirType: 'uri', propertyKind: 'primitive', isRequired: true), NotBlank]
        public ?UriPrimitive $url = null,
        /** @var array<Identifier> identifier Additional identifier for the structure map */
        #[FhirProperty(
            fhirType: 'Identifier',
        ...
        /** @var StringPrimitive|string|null version Business version of the structure map */
        ...
        /** @var StringPrimitive|string|null name Name for this structure map (computer friendly) */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive', isRequired: true), NotBlank]
        public StringPrimitive|string|null $name = null,
        /** @var StringPrimitive|string|null title Name for this structure map (human friendly) */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        ...
        /** @var MarkdownPrimitive|null description Natural language description of the structure map */
        ...
        /** @var array<CodeableConcept> jurisdiction Intended jurisdiction for structure map (if applicable) */
        #[FhirProperty(
        ...
        /** @var MarkdownPrimitive|null purpose Why this structure map is defined */
        #[FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
        ...
        /** @var array<StructureMapStructure> structure Structure Definition used by this map */
        #[FhirProperty(
            fhirType: 'BackboneElement',
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\StructureMap\StructureMapStructure',
        )]
        ...
        public array $import = [],
        /** @var array<StructureMapConst> const Definition of the constant value used in the map rules */
        #[FhirProperty(
            fhirType: 'BackboneElement',
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\StructureMap\StructureMapConst',
        )]
        public array $const = [],
        ...
        #[FhirProperty(
            ...
            isArray: true,
            isRequired: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\StructureMap\StructureMapGroup',
        )]
        #[Count(min: 1)]
        public array $group = [],
    ) {
