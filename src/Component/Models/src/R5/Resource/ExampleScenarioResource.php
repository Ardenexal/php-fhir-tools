...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\ExampleScenario\ExampleScenarioActor;
...
class ExampleScenarioResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var StringPrimitive|string|null title Name for this example scenario (human friendly) */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        ...
        /** @var array<ExampleScenarioActor> actor Individual involved in exchange */
        #[FhirProperty(
