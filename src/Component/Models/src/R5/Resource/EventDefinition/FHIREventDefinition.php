...
class FHIREventDefinition extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var FHIRMarkdown|null usage Describes the clinical usage of the event definition */
        ...
        /** @var FHIRDate|null lastReviewDate When the event definition was last reviewed by the publisher */
