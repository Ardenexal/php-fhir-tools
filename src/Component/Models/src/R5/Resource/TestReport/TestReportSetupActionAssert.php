...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\TestReportActionResultType;
 ...
 */
#[FHIRBackboneElement(parentResource: 'TestReport', elementPath: 'TestReport.setup.action.assert', fhirVersion: 'R5')]
class TestReportSetupActionAssert extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var array<TestReportSetupActionAssertRequirement> requirement Links or references to the testing requirements */
