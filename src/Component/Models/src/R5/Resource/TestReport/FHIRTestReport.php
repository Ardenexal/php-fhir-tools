...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRTestReportResultType;
use Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRTestReportStatusType;
...
class FHIRTestReport extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var FHIRString|string|null name Informal name of the executed TestReport */
        ...
        /** @var FHIRCanonical|null testScript Canonical URL to the  version-specific TestScript that was executed to produce this TestReport */
        #[NotBlank]
