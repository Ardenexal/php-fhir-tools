...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\CodeSystem\CodeSystemConcept;
...
class CodeSystemResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var DatePrimitive|null approvalDate When the CodeSystem was approved by publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
        public ?DatePrimitive $approvalDate = null,
        /** @var DatePrimitive|null lastReviewDate When the CodeSystem was last reviewed by the publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
