...
class NutritionProductResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept code A code that can identify the detailed nutrients and ingredients in a specific food product */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $code = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\NutritionProductStatusType status active | inactive | entered-in-error */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\NutritionProductStatusType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> category Broad product groups or categories used to classify the product, such as Legume and Legume Products, Beverages, or Beef Products */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> manufacturer Manufacturer, representative or officially responsible for the product */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\NutritionProduct\NutritionProductNutrient> nutrient The product's nutritional information expressed by the nutrients */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\NutritionProduct\NutritionProductIngredient> ingredient Ingredients contained in this product */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $ingredient = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> knownAllergen Known or suspected allergens that are a part of this product */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\NutritionProduct\NutritionProductCharacteristic> characteristic Specifies descriptive properties of the nutrition product */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $characteristic = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\NutritionProduct\NutritionProductInstance> instance One or several physical instances or occurrences of the nutrition product */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $instance = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note Comments made about the product */
