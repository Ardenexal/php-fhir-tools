...
class ImagingStudyResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Identifiers for the whole study */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\ImagingStudyStatusType status registered | available | cancelled | entered-in-error | unknown */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\ImagingStudyStatusType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> modality All of the distinct values for series' modalities */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject Who or what is the subject of the study */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference encounter Encounter with which this imaging study is associated */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive started When the study was started */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive $started = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> basedOn Request fulfilled */
		...
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $partOf = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference referrer Referring physician */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $referrer = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> endpoint Study access endpoint */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $endpoint = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UnsignedIntPrimitive numberOfSeries Number of Study Related Series */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'unsignedInt', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UnsignedIntPrimitive $numberOfSeries = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UnsignedIntPrimitive numberOfInstances Number of Study Related Instances */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'unsignedInt', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UnsignedIntPrimitive $numberOfInstances = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> procedure The performed procedure or code */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference location Where ImagingStudy occurred */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $location = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> reason Why the study was requested / performed */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableReference', propertyKind: 'complex', isArray: true)]
		public array $reason = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note User-defined comments */
		...
		public array $note = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string description Institution-generated description */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ImagingStudy\ImagingStudySeries> series Each study has one or more series of instances */
