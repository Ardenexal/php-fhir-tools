...
class AdverseEventResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business identifier for the event */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\AdverseEventStatusType status in-progress | completed | entered-in-error | unknown */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\AdverseEventStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\AdverseEventActualityType actuality actual | potential */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\AdverseEventActualityType $actuality = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> category wrong-patient | procedure-mishap | medication-mishap | device | unsafe-physical-environment | hospital-aquired-infection | wrong-body-site */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept code Event or incident that occurred or was averted */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $code = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject Subject impacted by event */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference encounter The Encounter associated with the start of the AdverseEvent */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Timing occurrence When the event occurred */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive detected When the event was detected */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive $detected = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive recordedDate When the event was recorded */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive $recordedDate = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> resultingEffect Effect on the subject due to this event */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference location Location where adverse event occurred */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $location = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept seriousness Seriousness or gravity of the event */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $seriousness = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> outcome Type of outcome from the adverse event */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $outcome = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference recorder Who recorded the adverse event */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $recorder = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\AdverseEvent\AdverseEventParticipant> participant Who was involved in the adverse event or the potential adverse event and what they did */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> study Research study that the subject is enrolled in */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $study = [],
		/** @var null|bool expectedInResearchStudy Considered likely or probable or anticipated in the research study */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\AdverseEvent\AdverseEventSuspectEntity> suspectEntity The suspected agent causing the adverse event */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $suspectEntity = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\AdverseEvent\AdverseEventContributingFactor> contributingFactor Contributing factors suspected to have increased the probability or severity of the adverse event */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $contributingFactor = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\AdverseEvent\AdverseEventPreventiveAction> preventiveAction Preventive actions that contributed to avoiding the adverse event */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $preventiveAction = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\AdverseEvent\AdverseEventMitigatingAction> mitigatingAction Ameliorating actions taken after the adverse event occured in order to reduce the extent of harm */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $mitigatingAction = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\AdverseEvent\AdverseEventSupportingInfo> supportingInfo Supporting information relevant to the event */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $supportingInfo = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note Comment on adverse event */
