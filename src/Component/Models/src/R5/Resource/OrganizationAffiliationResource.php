...
class OrganizationAffiliationResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business identifiers that are specific to this role */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period period The period during which the participatingOrganization is affiliated with the primary organization */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference organization Organization where the role is available */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference participatingOrganization Organization that provides/performs the role (e.g. providing services or is a member of) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $participatingOrganization = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> network The network in which the participatingOrganization provides the role's services (if defined) at the indicated locations (if defined) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> code Definition of the role the participatingOrganization plays */
		...
		public array $code = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> specialty Specific specialty of the participatingOrganization in the context of the role */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $specialty = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> location The location(s) at which the role occurs */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $location = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> healthcareService Healthcare services provided through the role */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $healthcareService = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\ExtendedContactDetail> contact Official contact details at the participatingOrganization relevant to this Affiliation */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> endpoint Technical endpoints providing access to services operated for this role */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
