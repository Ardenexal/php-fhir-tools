...
class ConditionDefinitionResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive url Canonical identifier for this condition definition, represented as a URI (globally unique) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'uri', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive $url = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Additional identifier for the condition definition */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string version Business version of the condition definition */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name Name for this condition definition (computer friendly) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $name = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string title Name for this condition definition (human friendly) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Natural language description of the condition definition */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> jurisdiction Intended jurisdiction for condition definition (if applicable) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept bodySite Anatomical location, if relevant */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $bodySite = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept stage Stage/grade, usually assessed formally */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $stage = null,
		/** @var null|bool hasSeverity Whether Severity is appropriate */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'boolean', propertyKind: 'scalar')]
		public ?bool $hasSeverity = null,
		/** @var null|bool hasBodySite Whether bodySite is appropriate */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'boolean', propertyKind: 'scalar')]
		public ?bool $hasBodySite = null,
		/** @var null|bool hasStage Whether stage is appropriate */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'boolean', propertyKind: 'scalar')]
		public ?bool $hasStage = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive> definition Formal Definition for the condition */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ConditionDefinition\ConditionDefinitionObservation> observation Observations particularly relevant to this condition */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ConditionDefinition\ConditionDefinitionMedication> medication Medications particularly relevant for this condition */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $medication = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ConditionDefinition\ConditionDefinitionPrecondition> precondition Observation that suggets this condition */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $precondition = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> team Appropriate team for this condition */
		...
		public array $team = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ConditionDefinition\ConditionDefinitionQuestionnaire> questionnaire Questionnaire for this condition */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $questionnaire = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ConditionDefinition\ConditionDefinitionPlan> plan Plan that is appropriate */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $plan = [],
	) {
