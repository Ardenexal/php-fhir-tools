...
class GenomicStudyResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Identifiers for this genomic study */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\GenomicStudyStatusType status registered | available | cancelled | entered-in-error | unknown */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\GenomicStudyStatusType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> type The type of the study (e.g., Familial variant segregation, Functional variation detection, or Gene expression profiling) */
		...
		public array $type = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject The primary subject of the genomic study */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference encounter The healthcare event with which this genomics study is associated */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive startDate When the genomic study was started */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive $startDate = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> basedOn Event resources that the genomic study is based on */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference referrer Healthcare professional who requested or referred the genomic study */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $referrer = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> interpreter Healthcare professionals who interpreted the genomic study */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $interpreter = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> reason Why the genomic study was performed */
		...
		public array $reason = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive instantiatesCanonical The defined protocol that describes the study */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive instantiatesUri The URL pointing to an externally maintained protocol that describes the study */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'uri', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive $instantiatesUri = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note Comments related to the genomic study */
		...
		public array $note = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Description of the genomic study */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\GenomicStudy\GenomicStudyAnalysis> analysis Genomic Analysis Event */
