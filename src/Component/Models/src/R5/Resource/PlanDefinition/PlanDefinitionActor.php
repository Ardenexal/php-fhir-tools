 ...
 */
#[FHIRBackboneElement(parentResource: 'PlanDefinition', elementPath: 'PlanDefinition.actor', fhirVersion: 'R5')]
class PlanDefinitionActor extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var MarkdownPrimitive|null description Describes the actor */
        #[FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
        public ?MarkdownPrimitive $description = null,
        /** @var array<PlanDefinitionActorOption> option Who or what can be this actor */
