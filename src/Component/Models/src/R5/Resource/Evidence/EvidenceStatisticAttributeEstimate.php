...
class EvidenceStatisticAttributeEstimate extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Textual description of the attribute estimate */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note Footnote or explanatory note about the estimate */
		...
		public array $note = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept type The type of attribute estimate, e.g., confidence interval or p value */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Quantity quantity The singular quantity of the attribute estimate, for attribute estimates represented as single values; also used to report unit of measure */
		...
		/** @var null|float level Level of confidence interval, e.g., 0.95 for 95% confidence interval */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Range range Lower and upper bound values of the attribute estimate */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Evidence\EvidenceStatisticAttributeEstimate> attributeEstimate A nested attribute estimate; which is the attribute estimate of an attribute estimate */
