...
class EvidenceStatisticAttributeEstimate extends BackboneElement
{
    public function __construct(
        ...
        /** @var MarkdownPrimitive|null description Textual description of the attribute estimate */
        ...
        /** @var numeric-string|null level Level of confidence interval, e.g., 0.95 for 95% confidence interval */
