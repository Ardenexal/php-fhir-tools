 ...
 */
#[FHIRBackboneElement(parentResource: 'Evidence', elementPath: 'Evidence.certainty', fhirVersion: 'R5')]
class EvidenceCertainty extends BackboneElement
{
    public function __construct(
        ...
        /** @var MarkdownPrimitive|null description Textual description of certainty */
