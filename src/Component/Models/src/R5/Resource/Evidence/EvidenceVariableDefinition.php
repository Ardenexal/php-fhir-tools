...
class EvidenceVariableDefinition extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex'), Valid, FHIRValueSetBinding(valueSetUrl: 'http://terminology.hl7.org/ValueSet/directness', strength: 'extensible')]
