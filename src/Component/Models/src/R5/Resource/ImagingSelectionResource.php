...
class ImagingSelectionResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business Identifier for Imaging Selection */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\ImagingSelectionStatusType status available | entered-in-error | unknown */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\ImagingSelectionStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject Subject of the selected instances */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive issued Date / Time when this imaging selection was created */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ImagingSelection\ImagingSelectionPerformer> performer Selector of the instances (human or machine) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> basedOn Associated request */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> category Classifies the imaging selection */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept code Imaging Selection purpose text or code */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\IdPrimitive studyUid DICOM Study Instance UID */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'id', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\IdPrimitive $studyUid = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> derivedFrom The imaging study from which the imaging selection is derived */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $derivedFrom = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> endpoint The network service providing retrieval for the images referenced in the imaging selection */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $endpoint = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\IdPrimitive seriesUid DICOM Series Instance UID */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'id', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\IdPrimitive $seriesUid = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UnsignedIntPrimitive seriesNumber DICOM Series Number */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'unsignedInt', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UnsignedIntPrimitive $seriesNumber = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\IdPrimitive frameOfReferenceUid The Frame of Reference UID for the selected images */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'id', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\IdPrimitive $frameOfReferenceUid = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference bodySite Body part examined */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> focus Related resource that is the focus for the imaging selection */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $focus = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ImagingSelection\ImagingSelectionInstance> instance The selected instances */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
