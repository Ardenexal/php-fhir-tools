...
class MeasureReportResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Additional identifier for the MeasureReport */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\MeasureReportStatusType status complete | pending | error */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\MeasureReportStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\MeasureReportTypeType type individual | subject-list | summary | data-exchange */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\MeasureReportTypeType $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\SubmitDataUpdateTypeType dataUpdateType incremental | snapshot */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\SubmitDataUpdateTypeType $dataUpdateType = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive measure What measure was calculated */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'canonical', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive $measure = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject What individual(s) the report is for */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive date When the measure was calculated */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference reporter Who is reporting the data */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $reporter = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference reportingVendor What vendor prepared the data */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $reportingVendor = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference location Where the reported data is from */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $location = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period period What period the report covers */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference inputParameters What parameters were provided to the report */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $inputParameters = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept scoring What scoring method (e.g. proportion, ratio, continuous-variable) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\MeasureReport\MeasureReportGroup> group Measure results for each group */
		...
		public array $group = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> supplementalData Additional information collected for the report */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> evaluatedResource What data was used to calculate the measure score */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
