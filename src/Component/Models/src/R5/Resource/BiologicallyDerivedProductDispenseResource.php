...
class BiologicallyDerivedProductDispenseResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business identifier for this dispense */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> partOf Short description */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $partOf = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\BiologicallyDerivedProductDispenseCodesType status preparation | in-progress | allocated | issued | unfulfilled | returned | entered-in-error | unknown */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\BiologicallyDerivedProductDispenseCodesType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept originRelationshipType Relationship between the donor and intended recipient */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $originRelationshipType = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference product The BiologicallyDerivedProduct that is dispensed */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $product = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference patient The intended recipient of the dispensed product */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $patient = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept matchStatus Indicates the type of matching associated with the dispense */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $matchStatus = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\BiologicallyDerivedProductDispense\BiologicallyDerivedProductDispensePerformer> performer Indicates who or what performed an action */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive preparedDate When product was selected/matched */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive whenHandedOver When the product was dispatched */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive $whenHandedOver = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference destination Where the product was dispatched to */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $destination = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note Additional notes */
		...
		public array $note = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string usageInstruction Specific instructions for use */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $usageInstruction = null,
	) {
