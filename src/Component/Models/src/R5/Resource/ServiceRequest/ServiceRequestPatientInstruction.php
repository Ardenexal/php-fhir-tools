...
class ServiceRequestPatientInstruction extends BackboneElement
{
    public function __construct(
        ...
        /** @var MarkdownPrimitive|Reference|null instruction Patient or consumer-oriented instructions */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isChoice: true,
            variants: [
                [
                    ...
                    'jsonKey'      => 'instructionMarkdown',
                ],
                [
                    'fhirType'     => 'Reference',
                    'propertyKind' => 'complex',
                    'phpType'      => 'Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference',
                    'jsonKey'      => 'instructionReference',
                ],
            ],
        )]
        public MarkdownPrimitive|Reference|null $instruction = null,
    ) {
