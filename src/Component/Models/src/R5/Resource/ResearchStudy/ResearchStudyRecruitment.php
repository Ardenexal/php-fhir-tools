...
class ResearchStudyRecruitment extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var UnsignedIntPrimitive|null targetNumber Estimated total number of participants to be enrolled */
        #[FhirProperty(fhirType: 'unsignedInt', propertyKind: 'primitive')]
        public ?UnsignedIntPrimitive $targetNumber = null,
        /** @var UnsignedIntPrimitive|null actualNumber Actual total number of participants enrolled in study */
        #[FhirProperty(fhirType: 'unsignedInt', propertyKind: 'primitive')]
