 ...
 */
#[FhirResource(type: 'Library', version: '5.0.0', url: 'http://hl7.org/fhir/StructureDefinition/Library', fhirVersion: 'R5')]
#[FHIRPathInvariant(
    key: 'cnl-0',
    severity: 'warning',
...
class LibraryResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/library-type',
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\LibraryType',
        )]
        ...
        /** @var MarkdownPrimitive|null usage Describes the clinical usage of the library */
        #[FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
        ...
        /** @var DatePrimitive|null lastReviewDate When the library was last reviewed by the publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
