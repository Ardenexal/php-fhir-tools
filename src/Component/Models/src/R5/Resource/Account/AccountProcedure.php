...
class AccountProcedure extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\PositiveIntPrimitive sequence Ranking of the procedure (for each type) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference code The procedure relevant to the account */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive dateOfService Date of the procedure (when coded procedure) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive $dateOfService = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> type How this procedure value should be used in charging the account */
		...
		public array $type = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> packageCode Package Code specific for billing */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $packageCode = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> device Any devices that were associated with the procedure */
