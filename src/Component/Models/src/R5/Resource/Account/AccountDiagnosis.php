...
class AccountDiagnosis extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'CodeableReference', propertyKind: 'complex', isRequired: true), Valid, NotBlank, FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/Condition'])]
        ...
        public ?DateTimePrimitive $dateOfDiagnosis = null,
        /** @var array<CodeableConcept> type Type that this diagnosis has relevant to the account (e.g. admission, billing, discharge …) */
        #[FhirProperty(
