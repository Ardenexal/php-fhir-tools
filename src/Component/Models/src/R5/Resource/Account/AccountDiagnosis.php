...
class AccountDiagnosis extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\PositiveIntPrimitive sequence Ranking of the diagnosis (for each type) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference condition The diagnosis relevant to the account */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference $condition = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive dateOfDiagnosis Date of the diagnosis (when coded diagnosis) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive $dateOfDiagnosis = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> type Type that this diagnosis has relevant to the account (e.g. admission, billing, discharge …) */
		...
		public array $type = [],
		/** @var null|bool onAdmission Diagnosis present on Admission */
