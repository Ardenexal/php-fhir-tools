...
class AllergyIntoleranceResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept clinicalStatus active | inactive | resolved */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $clinicalStatus = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept verificationStatus unconfirmed | presumed | confirmed | refuted | entered-in-error */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $verificationStatus = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept type allergy | intolerance - Underlying mechanism (if known) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $type = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\AllergyIntoleranceCategoryType> category food | medication | environment | biologic */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\AllergyIntoleranceCriticalityType criticality low | high | unable-to-assess */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\AllergyIntoleranceCriticalityType $criticality = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept code Code that identifies the allergy or intolerance */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $code = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference patient Who the allergy or intolerance is for */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference encounter Encounter when the allergy or intolerance was asserted */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Age|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Range|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string onset When allergy or intolerance was identified */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive recordedDate Date allergy or intolerance was first recorded */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\AllergyIntolerance\AllergyIntoleranceParticipant> participant Who or what participated in the activities related to the allergy or intolerance and how they were involved */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive lastOccurrence Date(/time) of last known occurrence of a reaction */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive $lastOccurrence = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note Additional text not captured in other fields */
		...
		public array $note = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\AllergyIntolerance\AllergyIntoleranceReaction> reaction Adverse Reaction Events linked to exposure to substance */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
