...
class DiagnosticReportResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business identifier for report */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> basedOn What was requested */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\DiagnosticReportStatusType status registered | partial | preliminary | modified | final | amended | corrected | appended | cancelled | entered-in-error | unknown */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\DiagnosticReportStatusType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> category Service category */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept code Name/Code for this diagnostic report */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject The subject of the report - usually, but not always, the patient */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference encounter Health care event when test ordered */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $encounter = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period effective Clinically relevant time/time-period for report */
		...
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period|null $effective = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\InstantPrimitive issued DateTime this version was made */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> performer Responsible Diagnostic Service */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $performer = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> resultsInterpreter Primary result interpreter */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $resultsInterpreter = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> specimen Specimens this report is based on */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $specimen = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> result Observations */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $result = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note Comments about the diagnostic report */
		...
		public array $note = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> study Reference to full details of an analysis associated with the diagnostic report */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $study = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\DiagnosticReport\DiagnosticReportSupportingInfo> supportingInfo Additional information supporting the diagnostic report */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\DiagnosticReport\DiagnosticReportMedia> media Key images or data associated with this report */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $media = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference composition Reference to a Composition resource for the DiagnosticReport structure */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $composition = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive conclusion Clinical conclusion (interpretation) of test results */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive $conclusion = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> conclusionCode Codes for the clinical conclusion of test results */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $conclusionCode = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Attachment> presentedForm Entire report as issued */
