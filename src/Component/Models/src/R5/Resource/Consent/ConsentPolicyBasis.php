 ...
 */
#[FHIRBackboneElement(parentResource: 'Consent', elementPath: 'Consent.policyBasis', fhirVersion: 'R5')]
class ConsentPolicyBasis extends BackboneElement
{
    public function __construct(
        ...
        /** @var Reference|null reference Reference backing policy resource */
        #[FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
        public ?Reference $reference = null,
        /** @var UrlPrimitive|null url URL to a computable backing policy */
