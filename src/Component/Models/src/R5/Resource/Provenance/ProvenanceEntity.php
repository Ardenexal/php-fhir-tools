...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\ProvenanceEntityRoleType;
...
class ProvenanceEntity extends BackboneElement
{
    public function __construct(
        ...
        /** @var ProvenanceEntityRoleType|null role revision | quotation | source | instantiates | removal */
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/provenance-entity-role|5.0.0', strength: 'required')]
