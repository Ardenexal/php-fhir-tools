...
class FHIRRegulatedAuthorization extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var array<FHIRCodeableReference> indication Condition for which the use of the regulated product applies */
        ...
        /** @var array<FHIRReference> attachedDocument Additional information or supporting documentation about the authorization */
