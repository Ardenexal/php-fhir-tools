...
class GoalResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier External Ids for this goal */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\GoalLifecycleStatusType lifecycleStatus proposed | planned | accepted | active | on-hold | completed | cancelled | entered-in-error | rejected */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\GoalLifecycleStatusType $lifecycleStatus = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept achievementStatus in-progress | improving | worsening | no-change | achieved | sustaining | not-achieved | no-progress | not-attainable */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $achievementStatus = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> category E.g. Treatment, dietary, behavioral, etc */
		...
		/** @var null|bool continuous After meeting the goal, ongoing activity is needed to sustain the goal objective */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept description Code or text describing goal */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject Who this goal is intended for */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept start When goal pursuit begins */
		...
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept|null $start = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\Goal\GoalTarget> target Target outcome for the goal */
		...
		public array $target = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive statusDate When goal status took effect */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DatePrimitive $statusDate = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string statusReason Reason for current status */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $statusReason = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference source Who's responsible for creating Goal? */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> addresses Issues addressed by this goal */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note Comments about the goal */
		...
		public array $note = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> outcome What result was achieved regarding the goal? */
