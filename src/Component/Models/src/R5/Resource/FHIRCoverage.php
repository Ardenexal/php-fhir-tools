...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRKindType;
...
class FHIRCoverage extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var array<FHIRIdentifier> identifier Business identifier(s) for this coverage */
        ...
        /** @var FHIRKindType|null kind insurance | self-pay | other */
        #[NotBlank]
        public ?FHIRKindType $kind = null,
        /** @var array<FHIRCoveragePaymentBy> paymentBy Self-pay parties and responsibility */
        ...
        /** @var array<FHIRIdentifier> subscriberId ID assigned to the subscriber */
        ...
        /** @var FHIRReference|null insurer Issuer of the policy */
        ...
        /** @var FHIRReference|null insurancePlan Insurance plan details */
