...
class DeviceDispenseResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business identifier for this dispensation */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> basedOn The order or request that this dispense is fulfilling */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> partOf The bigger event that this dispense is a part of */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $partOf = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\DeviceDispenseStatusCodesType status preparation | in-progress | cancelled | on-hold | completed | entered-in-error | stopped | declined | unknown */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\DeviceDispenseStatusCodesType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference statusReason Why a dispense was or was not performed */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> category Type of device dispense */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference device What device was supplied */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference $device = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference receiver Who collected the device or where the medication was delivered */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $receiver = null,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> supportingInformation Information that supports the dispensing of the device */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $supportingInformation = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\DeviceDispense\DeviceDispensePerformer> performer Who performed event */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive preparedDate When product was packaged and reviewed */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive $preparedDate = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference destination Where the device was sent or should be sent */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		...
		public array $note = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive usageInstruction Full representation of the usage instructions */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive $usageInstruction = null,
