...
class TaskResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/task-status|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\TaskStatus',
        )]
        ...
        #[FhirProperty(fhirType: 'CodeableReference', propertyKind: 'complex'), Valid]
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/task-intent|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\TaskIntent',
        )]
        ...
        #[FhirProperty(fhirType: 'boolean', propertyKind: 'scalar'), FHIRIsModifier(reason: 'If true, this element negates the Task. For example, instead of a request to perform a task, it is a request _not_ to perform a task.')]
