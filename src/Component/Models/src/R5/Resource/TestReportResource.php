...
class TestReportResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier identifier External identifier */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name Informal name of the executed TestReport */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $name = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\TestReportStatusType status completed | in-progress | waiting | stopped | entered-in-error */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\TestReportStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive testScript Canonical URL to the  version-specific TestScript that was executed to produce this TestReport */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\Primitive\CanonicalPrimitive $testScript = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\TestReportResultType result pass | fail | pending */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\TestReportResultType $result = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string tester Name of the tester producing this report (Organization or individual) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $tester = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive issued When the TestScript was executed and this TestReport was generated */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestReport\TestReportParticipant> participant A participant in the test execution, either the execution engine, a client, or a server */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestReport\TestReportSetup setup The results of the series of required setup operations before the tests were executed */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestReport\TestReportTest> test A test executed from the test script */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $test = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\TestReport\TestReportTeardown teardown The results of running the series of required clean up steps */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
