...
abstract class FHIRMetadataResource extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var FHIRUri|null url Canonical identifier for this {{title}}, represented as an absolute URI (globally unique) */
        public ?FHIRUri $url = null,
        /** @var array<FHIRIdentifier> identifier Additional identifier for the {{title}} */
        public array $identifier = [],
        /** @var FHIRString|string|null version Business version of the {{title}} */
        ...
        /** @var FHIRString|string|null title Name for this {{title}} (human friendly) */
        ...
        /** @var FHIRMarkdown|null description Natural language description of the {{title}} */
        public ?FHIRMarkdown $description = null,
        /** @var array<FHIRUsageContext> useContext The context that the content is intended to support */
        public array $useContext = [],
        /** @var array<FHIRCodeableConcept> jurisdiction Intended jurisdiction for {{title}} (if applicable) */
        public array $jurisdiction = [],
        /** @var FHIRMarkdown|null purpose Why this {{title}} is defined */
        ...
        /** @var FHIRDate|null approvalDate When the {{title}} was approved by publisher */
        public ?FHIRDate $approvalDate = null,
        /** @var FHIRDate|null lastReviewDate When the {{title}} was last reviewed by the publisher */
        public ?FHIRDate $lastReviewDate = null,
        /** @var FHIRPeriod|null effectivePeriod When the {{title}} is expected to be used */
        public ?FHIRPeriod $effectivePeriod = null,
        /** @var array<FHIRCodeableConcept> topic E.g. Education, Treatment, Assessment, etc */
        public array $topic = [],
        /** @var array<FHIRContactDetail> author Who authored the {{title}} */
        public array $author = [],
        /** @var array<FHIRContactDetail> editor Who edited the {{title}} */
        public array $editor = [],
        /** @var array<FHIRContactDetail> reviewer Who reviewed the {{title}} */
        public array $reviewer = [],
        /** @var array<FHIRContactDetail> endorser Who endorsed the {{title}} */
