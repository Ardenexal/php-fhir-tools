...
class MeasureSupplementalData extends BackboneElement
{
    public function __construct(
        ...
        /** @var StringPrimitive|string|null linkId Unique id for supplementalData in measure */
        ...
        #[FHIRValueSetBinding(
            ...
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\MeasureDataUsage',
        )]
        public array $usage = [],
        /** @var MarkdownPrimitive|null description The human readable description of this supplemental data */
