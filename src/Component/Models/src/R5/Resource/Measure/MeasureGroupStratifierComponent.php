...
class MeasureGroupStratifierComponent extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var StringPrimitive|string|null linkId Unique id for stratifier component in measure */
        ...
        /** @var MarkdownPrimitive|null description The human readable description of this stratifier component */
