...
class ManufacturedItemDefinitionResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name A descriptive name applied to this item */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $name = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept manufacturedDoseForm Dose form as manufactured (before any necessary transformation) */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $manufacturedDoseForm = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept unitOfPresentation The “real-world” units in which the quantity of the item is described */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $unitOfPresentation = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> manufacturer Manufacturer of the item, one of several possible */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\MarketingStatus> marketingStatus Allows specifying that an item is on the market for sale, or that it is not available, and the dates and locations associated */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> ingredient The ingredients of this manufactured item. Only needed if these are not specified by incoming references from the Ingredient resource */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ManufacturedItemDefinition\ManufacturedItemDefinitionProperty> property General characteristics of this item */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ManufacturedItemDefinition\ManufacturedItemDefinitionComponent> component Physical parts of the manufactured item, that it is intrisically made from. This is distinct from the ingredients that are part of its chemical makeup */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
