...
class EvidenceVariableCharacteristic extends BackboneElement
{
    public function __construct(
        ...
        /** @var MarkdownPrimitive|null description Natural language description of the characteristic */
        ...
        public Quantity|Range|null $instances = null,
        /** @var Quantity|Range|null duration Length of time in which the characteristic is met */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isChoice: true,
        ...
        public Quantity|Range|null $duration = null,
        /** @var array<EvidenceVariableCharacteristicTimeFromEvent> timeFromEvent Timing in which the characteristic is determined */
        #[FhirProperty(
