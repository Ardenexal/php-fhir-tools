 ...
 */
#[FHIRBackboneElement(parentResource: 'EvidenceVariable', elementPath: 'EvidenceVariable.characteristic.timeFromEvent', fhirVersion: 'R5')]
class EvidenceVariableCharacteristicTimeFromEvent extends BackboneElement
{
