...
class PackagedProductDefinitionResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier A unique identifier for this package as whole - not for the content of the package */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string name A name for this package. Typically as listed in a drug formulary, catalogue, inventory etc */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $name = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept type A high level category e.g. medicinal product, raw material, shipping container etc */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $type = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> packageFor The product that this is a pack for */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept status The status within the lifecycle of this item. High level - not intended to duplicate details elsewhere e.g. legal status, or authorization/marketing status */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive description Textual description. Note that this is not the name of the package or product */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\PackagedProductDefinition\PackagedProductDefinitionLegalStatusOfSupply> legalStatusOfSupply The legal status of supply of the packaged item as classified by the regulator */
		...
		/** @var null|bool copackagedIndicator Identifies if the drug product is supplied with another item such as a diluent or adjuvant */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> manufacturer Manufacturer of this package type (multiple means these are all possible manufacturers) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $manufacturer = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> attachedDocument Additional information or supporting documentation about the packaged product */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $attachedDocument = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\PackagedProductDefinition\PackagedProductDefinitionPackaging packaging A packaging item, as a container for medically related items, possibly with other packaging items within, or a packaging component, such as bottle cap */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?PackagedProductDefinition\PackagedProductDefinitionPackaging $packaging = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\PackagedProductDefinition\PackagedProductDefinitionPackagingProperty> characteristic Allows the key features to be recorded, such as "hospital pack", "nurse prescribable" */
