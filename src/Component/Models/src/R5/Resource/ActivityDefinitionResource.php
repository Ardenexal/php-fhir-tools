...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\RequestResourceTypesType;
...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\ActivityDefinition\ActivityDefinitionDynamicValue;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\ActivityDefinition\ActivityDefinitionParticipant;
...
class ActivityDefinitionResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var CodeableConcept|Reference|CanonicalPrimitive|null subject Type of individual the activity definition is intended for */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isChoice: true,
        ...
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/participant-resource-types',
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\ParticipantResourceTypes',
        )]
        ...
        /** @var MarkdownPrimitive|null usage Describes the clinical usage of the activity definition */
        #[FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
        ...
        /** @var DatePrimitive|null lastReviewDate When the activity definition was last reviewed by the publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/request-resource-types|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\RequestResourceTypes',
        )]
        public ?RequestResourceTypesType $kind = null,
        ...
        /** @var Timing|Age|Range|Duration|null timing When activity is to occur */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isChoice: true,
        ...
        public Timing|Age|Range|Duration|null $timing = null,
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\ActivityDefinition\ActivityDefinitionParticipant',
        )]
        #[Valid]
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\ActivityDefinition\ActivityDefinitionDynamicValue',
        )]
        #[Valid]
