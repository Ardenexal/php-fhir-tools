 ...
 */
#[FHIRBackboneElement(parentResource: 'Citation', elementPath: 'Citation.classification', fhirVersion: 'R5')]
class CitationClassification extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex'), Valid, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/citation-classification-type', strength: 'extensible')]
