...
class CompartmentDefinitionResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var StringPrimitive|string|null title Name for this compartment definition (human friendly) */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\CompartmentDefinition\CompartmentDefinitionResource',
        )]
        #[Valid]
