...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRSpecimenCombinedType;
use Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRSpecimenStatusType;
...
class FHIRSpecimen extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var FHIRReference|null subject Where the specimen came from. This may be from patient(s), from a location (e.g., the source of an environmental sample), or a sampling of a substance, a biologically-derived product, or a device */
        public ?FHIRReference $subject = null,
        /** @var FHIRDateTime|null receivedTime The time when specimen is received by the testing laboratory */
        ...
        /** @var FHIRSpecimenCombinedType|null combined grouped | pooled */
        public ?FHIRSpecimenCombinedType $combined = null,
        /** @var array<FHIRCodeableConcept> role The role the specimen serves */
        public array $role = [],
        /** @var array<FHIRSpecimenFeature> feature The physical feature of a specimen */
