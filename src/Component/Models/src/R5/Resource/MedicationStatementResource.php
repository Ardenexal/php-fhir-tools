...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\MedicationStatementStatusCodesType;
...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\MedicationStatement\MedicationStatementAdherence;
...
class MedicationStatementResource extends AbstractDomainResource
{
    public function __construct(
        ...
        public array $partOf = [],
        /** @var MedicationStatementStatusCodesType|null status recorded | entered-in-error | draft */
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true)]
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/medication-statement-status|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\MedicationStatementStatusCodes',
        )]
        ...
        /** @var array<CodeableConcept> category Type of medication statement */
        #[FhirProperty(
        ...
        /** @var CodeableReference|null medication What medication was taken */
        ...
        /** @var Reference|null encounter Encounter associated with MedicationStatement */
        ...
        /** @var DateTimePrimitive|Period|Timing|null effective The date/time or interval when the medication is/was/will be taken */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isChoice: true,
        ...
        public DateTimePrimitive|Period|Timing|null $effective = null,
        /** @var DateTimePrimitive|null dateAsserted When the usage was asserted? */
        #[FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
        public ?DateTimePrimitive $dateAsserted = null,
        /** @var array<Reference> informationSource Person or organization that provided the information about the taking of this medication */
        #[FhirProperty(
            fhirType: 'Reference',
            propertyKind: 'complex',
            isArray: true,
        ...
        /** @var array<Reference> derivedFrom Link to information used to derive the MedicationStatement */
        #[FhirProperty(
            fhirType: 'Reference',
            propertyKind: 'complex',
            isArray: true,
        ...
        /** @var array<CodeableReference> reason Reason for why the medication is being/was taken */
        #[FhirProperty(
        ...
        public array $reason = [],
        /** @var array<Annotation> note Further information about the usage */
        #[FhirProperty(
            fhirType: 'Annotation',
            propertyKind: 'complex',
            isArray: true,
        ...
        #[Valid]
        public array $note = [],
        /** @var array<Reference> relatedClinicalInformation Link to information relevant to the usage of a medication */
        #[FhirProperty(
            fhirType: 'Reference',
            propertyKind: 'complex',
            isArray: true,
        ...
        #[Valid]
        public array $dosage = [],
        /** @var MedicationStatementAdherence|null adherence Indicates whether the medication is or is not being consumed or administered */
        #[FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone'), Valid]
        public ?MedicationStatementAdherence $adherence = null,
    ) {
