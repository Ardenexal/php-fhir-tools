...
use Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRChargeItemStatusType;
...
class FHIRChargeItem extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var FHIRReference|null encounter Encounter associated with this ChargeItem */
        ...
        /** @var FHIRMonetaryComponent|null unitPriceComponent Unit price overriding the associated rules */
        public ?FHIRMonetaryComponent $unitPriceComponent = null,
        /** @var FHIRMonetaryComponent|null totalPriceComponent Total price overriding the associated rules */
        public ?FHIRMonetaryComponent $totalPriceComponent = null,
        /** @var FHIRCodeableConcept|null overrideReason Reason for overriding the list price/factor */
        ...
        public array $reason = [],
        /** @var array<FHIRCodeableReference> service Which rendered service is being charged? */
        public array $service = [],
        /** @var array<FHIRCodeableReference> product Product charged */
