 ...
 */
#[FHIRBackboneElement(parentResource: 'TestPlan', elementPath: 'TestPlan.testCase.assertion', fhirVersion: 'R5')]
class TestPlanTestCaseAssertion extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var array<CodeableConcept> type Assertion type - for example 'informative' or 'required' */
