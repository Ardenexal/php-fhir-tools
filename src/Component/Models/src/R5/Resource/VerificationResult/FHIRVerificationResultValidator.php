 ...
 */
#[FHIRBackboneElement(parentResource: 'VerificationResult', elementPath: 'VerificationResult.validator', fhirVersion: 'R5')]
class FHIRVerificationResultValidator extends \Ardenexal\FHIRTools\Component\Models\R5\DataType\FHIRBackboneElement
{
    public function __construct(
        ...
        /** @var FHIRSignature|null attestationSignature Validator signature (digital or image) */
