...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\Citation\CitationCitedArtifact;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\Citation\CitationClassification;
 ...
 */
#[FhirResource(type: 'Citation', version: '5.0.0', url: 'http://hl7.org/fhir/StructureDefinition/Citation', fhirVersion: 'R5')]
class CitationResource extends DomainResourceResource
{
    public function __construct(
        ...
        /** @var UriPrimitive|null url Canonical identifier for this citation record, represented as a globally unique URI */
        #[FhirProperty(fhirType: 'uri', propertyKind: 'primitive')]
        public ?UriPrimitive $url = null,
        /** @var array<Identifier> identifier Identifier for the citation record itself */
        #[FhirProperty(
            fhirType: 'Identifier',
        ...
        /** @var StringPrimitive|string|null name Name for this citation record (computer friendly) */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        public StringPrimitive|string|null $name = null,
        /** @var StringPrimitive|string|null title Name for this citation record (human friendly) */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        ...
        /** @var StringPrimitive|string|null publisher The publisher of the citation record, not the publisher of the article or artifact being cited */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        public StringPrimitive|string|null $publisher = null,
        /** @var array<ContactDetail> contact Contact details for the publisher of the citation record */
        #[FhirProperty(
        ...
        /** @var array<UsageContext> useContext The context that the citation record content is intended to support */
        #[FhirProperty(
        ...
        /** @var MarkdownPrimitive|null copyright Use and/or publishing restrictions for the citation record, not for the cited artifact */
        #[FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
        public ?MarkdownPrimitive $copyright = null,
        /** @var StringPrimitive|string|null copyrightLabel Copyright holder and year(s) for the ciation record, not for the cited artifact */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        public StringPrimitive|string|null $copyrightLabel = null,
        /** @var DatePrimitive|null approvalDate When the citation record was approved by publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
        public ?DatePrimitive $approvalDate = null,
        /** @var DatePrimitive|null lastReviewDate When the citation record was last reviewed by the publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
