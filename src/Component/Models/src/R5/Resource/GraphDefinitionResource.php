...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\GraphDefinition\GraphDefinitionLink;
use Ardenexal\FHIRTools\Component\Models\R5\Resource\GraphDefinition\GraphDefinitionNode;
...
class GraphDefinitionResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var array<Identifier> identifier Additional identifier for the GraphDefinition (business identifier) */
        #[FhirProperty(
            fhirType: 'Identifier',
        ...
        /** @var StringPrimitive|string|null version Business version of the graph definition */
        ...
        /** @var StringPrimitive|string|null name Name for this graph definition (computer friendly) */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive', isRequired: true), NotBlank]
        public StringPrimitive|string|null $name = null,
        /** @var StringPrimitive|string|null title Name for this graph definition (human friendly) */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        ...
        /** @var MarkdownPrimitive|null description Natural language description of the graph definition */
        ...
        /** @var array<CodeableConcept> jurisdiction Intended jurisdiction for graph definition (if applicable) */
        #[FhirProperty(
        ...
        /** @var IdPrimitive|null start Starting Node */
        #[FhirProperty(fhirType: 'id', propertyKind: 'primitive')]
        public ?IdPrimitive $start = null,
        /** @var array<GraphDefinitionNode> node Potential target for the link */
        #[FhirProperty(
            fhirType: 'BackboneElement',
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\GraphDefinition\GraphDefinitionNode',
        )]
        public array $node = [],
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\GraphDefinition\GraphDefinitionLink',
        )]
        public array $link = [],
    ) {
