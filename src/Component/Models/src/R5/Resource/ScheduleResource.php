...
class ScheduleResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> serviceCategory High-level category */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> serviceType Specific service */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> specialty Type of specialty needed */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> actor Resource(s) that availability information is being provided for */
		...
		public array $actor = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period planningHorizon Period of time covered by schedule */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Period', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period $planningHorizon = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\MarkdownPrimitive comment Comments on availability */
