...
class ScheduleResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var array<CodeableReference> serviceType Specific service */
        #[FhirProperty(
        ...
        /** @var MarkdownPrimitive|null comment Comments on availability */
