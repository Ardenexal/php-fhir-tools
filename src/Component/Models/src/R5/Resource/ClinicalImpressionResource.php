...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\ClinicalImpression\ClinicalImpressionFinding;
...
class ClinicalImpressionResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/event-status|5.0.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R5\Enum\EventStatus',
        )]
        ...
        /** @var Reference|null encounter The Encounter during which this ClinicalImpression was created */
        ...
        /** @var Reference|null performer The clinician performing the assessment */
        ...
        #[FhirProperty(fhirType: 'Reference', propertyKind: 'complex'), Valid, FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/ClinicalImpression'])]
        ...
        /** @var CodeableConcept|null changePattern Change in the status/pattern of a subject's condition since previously assessed, such as worsening, improving, or no change */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex'), Valid]
        public ?CodeableConcept $changePattern = null,
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\ClinicalImpression\ClinicalImpressionFinding',
        )]
        #[Valid]
        ...
        #[Valid]
        #[FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/RiskAssessment'])]
