...
class ClinicalImpressionResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string description Why/how the assessment was performed */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference subject Patient or group assessed */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference encounter The Encounter during which this ClinicalImpression was created */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period effective Time of assessment */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive date When the assessment was documented */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference performer The clinician performing the assessment */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $performer = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference previous Reference to last assessment */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $previous = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> problem Relevant impressions of patient state */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept changePattern Change in the status/pattern of a subject's condition since previously assessed, such as worsening, improving, or no change */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $changePattern = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Primitive\UriPrimitive> protocol Clinical Protocol followed */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string summary Summary of the assessment */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\StringPrimitive|string|null $summary = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\ClinicalImpression\ClinicalImpressionFinding> finding Possible or likely findings and diagnoses */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> prognosisCodeableConcept Estimate of likely outcome */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> prognosisReference RiskAssessment expressing likely outcome */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $prognosisReference = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> supportingInfo Information supporting the clinical impression */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $supportingInfo = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note Comments made about the ClinicalImpression */
