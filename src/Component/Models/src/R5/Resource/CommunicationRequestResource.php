...
use Ardenexal\FHIRTools\Component\Models\R5\Resource\CommunicationRequest\CommunicationRequestPayload;
...
class CommunicationRequestResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'boolean', propertyKind: 'scalar'), FHIRIsModifier(reason: 'If true this element negates the specified action. For Example,  instead of a request for a communication, it is a request for the communication to not occur.')]
        ...
        #[FhirProperty(fhirType: 'Reference', propertyKind: 'complex'), Valid, FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/Patient', 'http://hl7.org/fhir/StructureDefinition/Group'])]
        ...
        #[FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/Resource'])]
        public array $about = [],
        /** @var Reference|null encounter The Encounter during which this CommunicationRequest was created */
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\CommunicationRequest\CommunicationRequestPayload',
        )]
        #[Valid]
        ...
        /** @var Reference|null requester Who asks for the information to be shared */
        ...
        /** @var array<Reference> recipient Who to share the information with */
        #[FhirProperty(
            fhirType: 'Reference',
            propertyKind: 'complex',
            isArray: true,
        ...
        /** @var array<Reference> informationProvider Who should share the information */
        #[FhirProperty(
            fhirType: 'Reference',
            propertyKind: 'complex',
            isArray: true,
        ...
        /** @var array<CodeableReference> reason Why is communication needed? */
        #[FhirProperty(
