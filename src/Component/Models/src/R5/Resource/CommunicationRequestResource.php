...
class CommunicationRequestResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> basedOn Fulfills plan or proposal */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> replaces Request(s) replaced by this request */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> about Resources that pertain to this communication request */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $about = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference encounter The Encounter during which this CommunicationRequest was created */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $encounter = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\CommunicationRequest\CommunicationRequestPayload> payload Message payload */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period occurrence When scheduled */
		...
		public \Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Period|null $occurrence = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Primitive\DateTimePrimitive authoredOn When request transitioned to being actionable */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference requester Who asks for the information to be shared */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $requester = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> recipient Who to share the information with */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $recipient = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference> informationProvider Who should share the information */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $informationProvider = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableReference> reason Why is communication needed? */
		...
		public array $reason = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Annotation> note Comments made about communication request */
