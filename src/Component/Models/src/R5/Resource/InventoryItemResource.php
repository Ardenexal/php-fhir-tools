...
class InventoryItemResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\Identifier> identifier Business identifier for the inventory item */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\InventoryItemStatusCodesType status active | inactive | entered-in-error | unknown */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\InventoryItemStatusCodesType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> category Category or class of the item */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> code Code designating the specific type of item */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $code = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\InventoryItem\InventoryItemName> name The item name(s) - the brand name, or common name, functional name, generic name or others */
		...
		public array $name = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\InventoryItem\InventoryItemResponsibleOrganization> responsibleOrganization Organization(s) responsible for the product */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $responsibleOrganization = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\InventoryItem\InventoryItemDescription description Descriptive characteristics of the item */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?InventoryItem\InventoryItemDescription $description = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept> inventoryStatus The usage status like recalled, in use, discarded */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $inventoryStatus = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept baseUnit The base unit of measure - the unit in which the product is used or counted */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\CodeableConcept $baseUnit = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Quantity netContent Net content or amount present in the item */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Quantity', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Quantity $netContent = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\InventoryItem\InventoryItemAssociation> association Association with other items or products */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $association = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R5\Resource\InventoryItem\InventoryItemCharacteristic> characteristic Characteristic of the item */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $characteristic = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\Resource\InventoryItem\InventoryItemInstance instance Instances or occurrences of the product */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?InventoryItem\InventoryItemInstance $instance = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference productReference Link to a product resource used in clinical workflows */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R5\DataType\Reference $productReference = null,
	) {
