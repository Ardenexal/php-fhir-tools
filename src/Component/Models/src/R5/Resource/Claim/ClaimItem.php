...
class ClaimItem extends BackboneElement
{
    public function __construct(
        ...
        public array $udi = [],
        /** @var array<ClaimItemBodySite> bodySite Anatomical location */
        #[FhirProperty(
            fhirType: 'BackboneElement',
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\Claim\ClaimItemBodySite',
        )]
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\Claim\ClaimItemDetail',
        )]
        public array $detail = [],
    ) {
