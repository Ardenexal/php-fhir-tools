 ...
 */
#[FHIRBackboneElement(parentResource: 'Claim', elementPath: 'Claim.item.detail', fhirVersion: 'R5')]
class ClaimItemDetail extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R5\Resource\Claim\ClaimItemDetailSubDetail',
        )]
