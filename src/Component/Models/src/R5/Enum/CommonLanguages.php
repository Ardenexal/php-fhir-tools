 ...
 */
#[FHIRValueSetSource(url: 'http://hl7.org/fhir/ValueSet/languages', version: '5.0.0')]
enum CommonLanguages: string
{
    /** Arabic */
    case arabic = 'ar';
