...
class ImagingStudySeriesPerformer extends BackboneElement
{
    public function __construct(
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/series-performer-function',
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ImagingStudySeriesPerformerFunction',
        )]
