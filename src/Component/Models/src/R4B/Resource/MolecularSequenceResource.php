...
class MolecularSequenceResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier> identifier Unique ID for this particular sequence. This is a FHIR-defined id */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\SequenceTypeType type aa | dna | rna */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\SequenceTypeType $type = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference patient Who and/or what this is about */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference specimen Specimen used for sequencing */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $specimen = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference device The method for sequencing */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $device = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference performer Who should be responsible for test result */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $performer = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Quantity quantity The number of copies of the sequence of interest.  (RNASeq) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\MolecularSequence\MolecularSequenceReferenceSeq referenceSeq A sequence used as reference */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\MolecularSequence\MolecularSequenceVariant> variant Variant in sequence */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string observedSeq Sequence that was observed */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string|null $observedSeq = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\MolecularSequence\MolecularSequenceQuality> quality An set of value as quality of sequence */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\MolecularSequence\MolecularSequenceRepository> repository External repository which contains detailed report related with observedSeq in this resource */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> pointer Pointer to next atomic sequence */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Reference',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\MolecularSequence\MolecularSequenceStructureVariant> structureVariant Structural variant */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
