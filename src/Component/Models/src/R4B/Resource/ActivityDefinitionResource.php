...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ActivityDefinition\ActivityDefinitionDynamicValue;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ActivityDefinition\ActivityDefinitionParticipant;
...
class ActivityDefinitionResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/request-resource-types|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\RequestResourceType',
        )]
