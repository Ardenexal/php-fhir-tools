 ...
 */
#[FHIRBackboneElement(parentResource: 'TestReport', elementPath: 'TestReport.teardown', fhirVersion: 'R4B')]
class TestReportTeardown extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var array<TestReportTeardownAction> action One or more teardown operations performed */
