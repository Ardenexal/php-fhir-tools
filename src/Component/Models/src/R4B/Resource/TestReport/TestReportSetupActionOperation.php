...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\TestReportActionResultType;
 ...
 */
#[FHIRBackboneElement(parentResource: 'TestReport', elementPath: 'TestReport.setup.action.operation', fhirVersion: 'R4B')]
class TestReportSetupActionOperation extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/report-action-result-codes|4.3.0', strength: 'required')]
