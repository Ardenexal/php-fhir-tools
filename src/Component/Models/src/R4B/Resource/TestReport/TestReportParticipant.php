...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\TestReportParticipantTypeType;
 ...
 */
#[FHIRBackboneElement(parentResource: 'TestReport', elementPath: 'TestReport.participant', fhirVersion: 'R4B')]
class TestReportParticipant extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/report-participant-type|4.3.0', strength: 'required')]
