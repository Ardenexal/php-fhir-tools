...
class OperationOutcomeResource extends DomainResourceResource
{
	public const FHIR_PROPERTY_MAP = [
		...
		'issue' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\OperationOutcome\OperationOutcomeIssue',
			'variants' => null,
		],
	];
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\OperationOutcome\OperationOutcomeIssue> issue A single issue associated with the action */
