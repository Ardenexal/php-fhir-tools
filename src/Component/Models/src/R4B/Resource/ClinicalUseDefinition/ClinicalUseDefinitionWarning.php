...
class ClinicalUseDefinitionWarning extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var MarkdownPrimitive|null description A textual definition of this warning, with formatting */
        #[FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
        public ?MarkdownPrimitive $description = null,
        /** @var CodeableConcept|null code A coded or unformatted textual definition of this warning */
