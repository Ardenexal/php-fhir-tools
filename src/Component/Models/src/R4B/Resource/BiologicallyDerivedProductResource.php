...
class BiologicallyDerivedProductResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\BiologicallyDerivedProductCategoryType productCategory organ | tissue | fluid | cells | biologicalAgent */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\BiologicallyDerivedProductCategoryType $productCategory = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept productCode What this biologically derived product is */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $productCode = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\BiologicallyDerivedProductStatusType status available | unavailable */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\BiologicallyDerivedProductStatusType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> request Procedure request */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Reference',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> parent BiologicallyDerivedProduct parent */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Reference',
			propertyKind: 'complex',
			isArray: true,
		...
		public array $parent = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\BiologicallyDerivedProduct\BiologicallyDerivedProductCollection collection How this product was collected */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\BiologicallyDerivedProduct\BiologicallyDerivedProductProcessing> processing Any processing of the product during collection */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\BiologicallyDerivedProduct\BiologicallyDerivedProductManipulation manipulation Any manipulation of product post-collection */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?BiologicallyDerivedProduct\BiologicallyDerivedProductManipulation $manipulation = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\BiologicallyDerivedProduct\BiologicallyDerivedProductStorage> storage Product storage */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
