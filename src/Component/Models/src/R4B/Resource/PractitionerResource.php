 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirResource(type: 'Practitioner', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Practitioner', fhirVersion: 'R4B')]
class PractitionerResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier> identifier An identifier for the person as this agent */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\HumanName> name The name(s) associated with the practitioner */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'HumanName',
			propertyKind: 'complex',
			isArray: true,
		...
		public array $name = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\ContactPoint> telecom A contact detail for the practitioner (that apply to all roles) */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'ContactPoint',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Address> address Address(es) of the practitioner that are not role specific (typically home address) */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Address',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DatePrimitive birthDate The date  on which the practitioner was born */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Attachment> photo Image of the person */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Attachment',
			propertyKind: 'complex',
			isArray: true,
		...
		public array $photo = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Practitioner\PractitionerQualification> qualification Certification, licenses, or training pertaining to the provision of care */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> communication A language the practitioner can use in patient communication */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'CodeableConcept',
			propertyKind: 'complex',
			isArray: true,
