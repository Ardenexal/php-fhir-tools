...
class VisionPrescriptionResource extends DomainResourceResource
{
	public const FHIR_PROPERTY_MAP = [
		...
		'lensSpecification' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\VisionPrescription\VisionPrescriptionLensSpecification',
			'variants' => null,
		],
	];
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier> identifier Business Identifier for vision prescription */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference patient Who prescription is for */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference encounter Created during encounter / admission / stay */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive dateWritten When prescription was authorized */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive $dateWritten = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference prescriber Who authorized the vision prescription */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $prescriber = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\VisionPrescription\VisionPrescriptionLensSpecification> lensSpecification Vision lens authorization */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
