...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\UDIEntryTypeType;
 ...
 */
#[FHIRBackboneElement(parentResource: 'Device', elementPath: 'Device.udiCarrier', fhirVersion: 'R4B')]
class DeviceUdiCarrier extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive'), FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/udi-entry-type|4.3.0', strength: 'required')]
