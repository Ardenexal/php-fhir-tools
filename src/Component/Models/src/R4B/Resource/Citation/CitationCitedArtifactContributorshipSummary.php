...
class CitationCitedArtifactContributorshipSummary extends BackboneElement
{
    public function __construct(
        ...
        /** @var CodeableConcept|null type Either authorList or contributorshipStatement */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex'), Valid, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/contributor-summary-type', strength: 'extensible')]
        public ?CodeableConcept $type = null,
        /** @var CodeableConcept|null style The format for the display string */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex'), Valid, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/contributor-summary-style', strength: 'extensible')]
        ...
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex'), Valid, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/contributor-summary-source', strength: 'extensible')]
