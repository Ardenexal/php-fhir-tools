...
class CitationCitedArtifactContributorshipSummary extends BackboneElement
{
    public function __construct(
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/contributor-summary-type',
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ContributorSummaryType',
        )]
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/contributor-summary-style',
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ContributorSummaryStyle',
        )]
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/contributor-summary-source',
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ContributorSummarySource',
        )]
