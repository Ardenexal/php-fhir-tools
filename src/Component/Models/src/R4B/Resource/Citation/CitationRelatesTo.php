 ...
 */
#[FHIRBackboneElement(parentResource: 'Citation', elementPath: 'Citation.relatesTo', fhirVersion: 'R4B')]
class CitationRelatesTo extends BackboneElement
{
    public function __construct(
        ...
        /** @var CodeableConcept|null relationshipType How the Citation resource relates to the target artifact */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isRequired: true), Valid, NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/artifact-relationship-type', strength: 'extensible')]
        ...
        /** @var UriPrimitive|Identifier|Reference|Attachment|null target The article or artifact that the Citation Resource is related to */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isRequired: true,
