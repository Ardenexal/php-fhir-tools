...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\FHIRFHIRDeviceStatusType;
...
class FHIRDevice extends FHIRDomainResource
{
    public function __construct(
        ...
        public array $safety = [],
        /** @var FHIRReference|null parent The device that this device is attached to or is part of */
