...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\GuidanceResponseStatusType;
...
class GuidanceResponseResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/guidance-response-status|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\GuidanceResponseStatus',
        )]
        ...
        #[Valid]
        #[FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/OperationOutcome'])]
