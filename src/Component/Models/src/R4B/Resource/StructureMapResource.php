 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirResource(type: 'StructureMap', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/StructureMap', fhirVersion: 'R4B')]
class StructureMapResource extends DomainResourceResource
{
	public const FHIR_PROPERTY_MAP = [
		...
		'structure' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\StructureMap\StructureMapStructure',
			'variants' => null,
		],
		'import' => [
			'fhirType' => 'canonical',
		...
		'group' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\StructureMap\StructureMapGroup',
			'variants' => null,
		],
	];
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UriPrimitive url Canonical identifier for this structure map, represented as a URI (globally unique) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier> identifier Additional identifier for the structure map */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string version Business version of the structure map */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string|null $version = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string name Name for this structure map (computer friendly) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string title Name for this structure map (human friendly) */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\MarkdownPrimitive description Natural language description of the structure map */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> jurisdiction Intended jurisdiction for structure map (if applicable) */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'CodeableConcept',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\MarkdownPrimitive purpose Why this structure map is defined */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\StructureMap\StructureMapStructure> structure Structure Definition used by this map */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\CanonicalPrimitive> import Other maps used by this map (canonical URLs) */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'canonical', propertyKind: 'primitive', isArray: true)]
		public array $import = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\StructureMap\StructureMapGroup> group Named sections for reader convenience */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
