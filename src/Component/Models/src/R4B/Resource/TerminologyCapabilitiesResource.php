...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeSearchSupportType;
...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\TerminologyCapabilities\TerminologyCapabilitiesClosure;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\TerminologyCapabilities\TerminologyCapabilitiesCodeSystem;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\TerminologyCapabilities\TerminologyCapabilitiesExpansion;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\TerminologyCapabilities\TerminologyCapabilitiesImplementation;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\TerminologyCapabilities\TerminologyCapabilitiesSoftware;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\TerminologyCapabilities\TerminologyCapabilitiesTranslation;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\TerminologyCapabilities\TerminologyCapabilitiesValidateCode;
...
class TerminologyCapabilitiesResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/capability-statement-kind|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\CapabilityStatementKind',
        )]
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/code-search-support|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\CodeSearchSupport',
        )]
