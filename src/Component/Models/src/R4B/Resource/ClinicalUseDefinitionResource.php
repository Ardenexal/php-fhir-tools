...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClinicalUseDefinition\ClinicalUseDefinitionContraindication;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClinicalUseDefinition\ClinicalUseDefinitionIndication;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClinicalUseDefinition\ClinicalUseDefinitionInteraction;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClinicalUseDefinition\ClinicalUseDefinitionUndesirableEffect;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClinicalUseDefinition\ClinicalUseDefinitionWarning;
...
class ClinicalUseDefinitionResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/clinical-use-definition-type|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ClinicalUseDefinitionType',
        )]
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/clinical-use-definition-category',
            strength: 'preferred',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ClinicalUseDefinitionCategory',
        )]
        ...
        public ?ClinicalUseDefinitionContraindication $contraindication = null,
        /** @var ClinicalUseDefinitionIndication|null indication Specifics for when this is an indication */
        #[FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone'), Valid]
        public ?ClinicalUseDefinitionIndication $indication = null,
        /** @var ClinicalUseDefinitionInteraction|null interaction Specifics for when this is an interaction */
        #[FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone'), Valid]
        public ?ClinicalUseDefinitionInteraction $interaction = null,
        /** @var array<Reference> population The population group to which this applies */
        #[FhirProperty(
            fhirType: 'Reference',
            propertyKind: 'complex',
            isArray: true,
        ...
        #[FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone'), Valid]
        public ?ClinicalUseDefinitionUndesirableEffect $undesirableEffect = null,
        /** @var ClinicalUseDefinitionWarning|null warning Critical environmental, health or physical risks or hazards. For example 'Do not operate heavy machinery', 'May cause drowsiness' */
        #[FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone'), Valid]
        public ?ClinicalUseDefinitionWarning $warning = null,
    ) {
