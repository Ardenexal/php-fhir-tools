...
class OrganizationAffiliationResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier> identifier Business identifiers that are specific to this role */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Period period The period during which the participatingOrganization is affiliated with the primary organization */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference organization Organization where the role is available */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference participatingOrganization Organization that provides/performs the role (e.g. providing services or is a member of) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $participatingOrganization = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> network Health insurance provider network in which the participatingOrganization provides the role's services (if defined) at the indicated locations (if defined) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> code Definition of the role the participatingOrganization plays */
		...
		public array $code = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> specialty Specific specialty of the participatingOrganization in the context of the role */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isArray: true)]
		public array $specialty = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> location The location(s) at which the role occurs */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $location = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> healthcareService Healthcare services provided through the role */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $healthcareService = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\ContactPoint> telecom Contact details at the participatingOrganization relevant to this Affiliation */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> endpoint Technical endpoints providing access to services operated for this role */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
