...
class SubscriptionTopicResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UriPrimitive url Canonical identifier for this subscription topic definition, represented as a URI (globally unique) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier> identifier Business Identifier for this subscription topic */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string version Business version of the subscription topic */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string|null $version = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string title Name for this subscription topic (Human friendly) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string|null $title = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\CanonicalPrimitive> derivedFrom Based on FHIR protocol or definition */
		...
		/** @var null|bool experimental If for testing purposes, not real usage */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'boolean', propertyKind: 'scalar')]
		public ?bool $experimental = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive date Date status first applied */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string publisher The name of the individual or organization that published the SubscriptionTopic */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\MarkdownPrimitive description Natural language description of the SubscriptionTopic */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\UsageContext> useContext Content intends to support these contexts */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> jurisdiction Intended jurisdiction of the SubscriptionTopic (if applicable) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\MarkdownPrimitive purpose Why this SubscriptionTopic is defined */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DatePrimitive approvalDate When SubscriptionTopic is/was approved by publisher */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DatePrimitive lastReviewDate Date the Subscription Topic was last reviewed by the publisher */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DatePrimitive $lastReviewDate = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Period effectivePeriod The effective date range for the SubscriptionTopic */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\SubscriptionTopic\SubscriptionTopicResourceTrigger> resourceTrigger Definition of a resource-based trigger for the subscription topic */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\SubscriptionTopic\SubscriptionTopicEventTrigger> eventTrigger Event definitions the SubscriptionTopic */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $eventTrigger = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\SubscriptionTopic\SubscriptionTopicCanFilterBy> canFilterBy Properties by which a Subscription can filter notifications from the SubscriptionTopic */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $canFilterBy = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\SubscriptionTopic\SubscriptionTopicNotificationShape> notificationShape Properties for describing the shape of notifications generated by this topic */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
