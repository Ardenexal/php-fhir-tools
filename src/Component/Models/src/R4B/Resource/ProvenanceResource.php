 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirResource(type: 'Provenance', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Provenance', fhirVersion: 'R4B')]
class ProvenanceResource extends DomainResourceResource
{
	public const FHIR_PROPERTY_MAP = [
		...
		'entity' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\Provenance\ProvenanceEntity',
			'variants' => null,
		],
		'signature' => [
			'fhirType' => 'Signature',
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> target Target Reference(s) (usually version specific) */
		...
		public array $target = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Period|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive occurred When the activity occurred */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'choice',
			propertyKind: 'choice',
			isChoice: true,
		...
		public \Ardenexal\FHIRTools\Component\Models\R4B\DataType\Period|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive|null $occurred = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\InstantPrimitive recorded When the activity was recorded / updated */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UriPrimitive> policy Policy or plan the activity was defined by */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'uri', propertyKind: 'primitive', isArray: true)]
		public array $policy = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference location Where the activity occurred, if relevant */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> reason Reason the activity is occurring */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'CodeableConcept',
			propertyKind: 'complex',
			isArray: true,
		...
		public array $reason = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept activity Activity that occurred */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $activity = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Provenance\ProvenanceAgent> agent Actor involved */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		public array $agent = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Provenance\ProvenanceEntity> entity An entity used in this activity */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		public array $entity = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Signature> signature Signature on target */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Signature',
			propertyKind: 'complex',
			isArray: true,
