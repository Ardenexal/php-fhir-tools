...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\ImmunizationEvaluationStatusCodesType;
...
class ImmunizationEvaluationResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/immunization-evaluation-status|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ImmunizationEvaluationStatusCodes',
        )]
        ...
        #[FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isRequired: true), Valid, NotBlank, FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/Immunization'])]
