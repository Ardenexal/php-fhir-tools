...
class ResearchSubjectResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier> identifier Business Identifier for research subject in a study */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\ResearchSubjectStatusType status candidate | eligible | follow-up | ineligible | not-registered | off-study | on-study | on-study-intervention | on-study-observation | pending-on-study | potential-candidate | screening | withdrawn */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\ResearchSubjectStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Period period Start and end of participation */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference study Study subject is part of */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $study = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference individual Who is part of study */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $individual = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string assignedArm What path should be followed */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string|null $assignedArm = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string actualArm What path was followed */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string|null $actualArm = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference consent Agreement to participate in study */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $consent = null,
	) {
