...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\DiagnosticReportStatusType;
...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\DiagnosticReport\DiagnosticReportMedia;
...
class DiagnosticReportResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/diagnostic-report-status|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\DiagnosticReportStatus',
        )]
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/report-codes',
            strength: 'preferred',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\LOINCDiagnosticReportCodes',
        )]
        ...
        #[Valid]
        #[FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/ImagingStudy'])]
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\DiagnosticReport\DiagnosticReportMedia',
        )]
        #[Valid]
        public array $media = [],
