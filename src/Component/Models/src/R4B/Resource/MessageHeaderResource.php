...
class MessageHeaderResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Coding|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UriPrimitive event Code for the event this message represents or link to event definition */
		...
		public \Ardenexal\FHIRTools\Component\Models\R4B\DataType\Coding|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UriPrimitive|null $event = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\MessageHeader\MessageHeaderDestination> destination Message destination application(s) */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference sender Real world sender of the message */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference enterer The source of the data entry */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $enterer = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference author The source of the decision */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $author = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\MessageHeader\MessageHeaderSource source Message source application */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public ?MessageHeader\MessageHeaderSource $source = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference responsible Final responsibility for event */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $responsible = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept reason Cause of event */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $reason = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\MessageHeader\MessageHeaderResponse response If this is a reply to prior message */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> focus The actual content of the message */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Reference',
			propertyKind: 'complex',
			isArray: true,
		...
		public array $focus = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\CanonicalPrimitive definition Link to the definition for this message */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'canonical', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\CanonicalPrimitive $definition = null,
	) {
