 ...
 */
#[FHIRBackboneElement(
    parentResource: 'MedicinalProductInteraction',
    elementPath: 'MedicinalProductInteraction.interactant',
    fhirVersion: 'R4B',
)]
class FHIRMedicinalProductInteractionInteractant extends \Ardenexal\FHIRTools\Component\Models\R4B\DataType\FHIRBackboneElement
{
