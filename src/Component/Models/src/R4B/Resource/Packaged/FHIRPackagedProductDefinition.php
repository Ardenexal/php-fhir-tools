...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\FHIRMarketingStatus;
...
class FHIRPackagedProductDefinition extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var array<FHIRIdentifier> identifier A unique identifier for this package as whole */
        ...
        /** @var array<FHIRQuantity> containedItemQuantity A total of the complete count of contained items of a particular type/form, independent of sub-packaging or organization. This can be considered as the pack size */
        ...
        /** @var array<FHIRCodeableConcept> characteristic Allows the key features to be recorded, such as "hospital pack", "nurse prescribable" */
        public array $characteristic = [],
        /** @var FHIRBoolean|null copackagedIndicator If the drug product is supplied with another item such as a diluent or adjuvant */
        ...
        /** @var FHIRPackagedProductDefinitionPackage|null package A packaging item, as a container for medically related items, possibly with other packaging items within, or a packaging component, such as bottle cap */
