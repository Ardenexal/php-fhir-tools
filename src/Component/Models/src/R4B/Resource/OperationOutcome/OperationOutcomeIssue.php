...
class OperationOutcomeIssue extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/issue-severity|4.3.0', strength: 'required')]
        public ?IssueSeverityType $severity = null,
        /** @var IssueTypeType|null code Error or warning code */
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/issue-type|4.3.0', strength: 'required')]
