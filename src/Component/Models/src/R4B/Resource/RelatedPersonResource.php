...
class RelatedPersonResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference patient The patient this person is related to */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> relationship The nature of the relationship */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'CodeableConcept',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DatePrimitive birthDate The date on which the related person was born */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Address> address Address where the related person can be contacted or visited */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Address',
			propertyKind: 'complex',
			isArray: true,
		...
		public array $photo = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Period period Period of time that this relationship is considered valid */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\RelatedPerson\RelatedPersonCommunication> communication A language which may be used to communicate with about the patient's health */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
