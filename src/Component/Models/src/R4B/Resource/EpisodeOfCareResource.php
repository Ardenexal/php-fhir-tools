...
class EpisodeOfCareResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier> identifier Business Identifier(s) relevant for this EpisodeOfCare */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\EpisodeOfCareStatusType status planned | waitlist | active | onhold | finished | cancelled | entered-in-error */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\EpisodeOfCareStatusType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\EpisodeOfCare\EpisodeOfCareStatusHistory> statusHistory Past list of status codes (the current status may be included to cover the start date of the status) */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> type Type/class  - e.g. specialist referral, disease management */
		...
		public array $type = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\EpisodeOfCare\EpisodeOfCareDiagnosis> diagnosis The list of diagnosis relevant to this episode of care */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
		public array $diagnosis = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference patient The patient who is the focus of this episode of care */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference managingOrganization Organization that assumes care */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Period period Interval during responsibility is assumed */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> referralRequest Originating Referral Request(s) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference careManager Care manager/care coordinator for the patient */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $careManager = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> team Other practitioners facilitating this episode of care */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $team = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> account The set of accounts that may be used for billing for this EpisodeOfCare */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
