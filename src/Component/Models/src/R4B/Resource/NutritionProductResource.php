...
class NutritionProductResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\NutritionProductStatusType status active | inactive | entered-in-error */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\NutritionProductStatusType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> category A category or class of the nutrition product (halal, kosher, gluten free, vegan, etc) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept code A code designating a specific type of nutritional product */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $code = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> manufacturer Manufacturer, representative or officially responsible for the product */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Reference',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\NutritionProduct\NutritionProductNutrient> nutrient The product's nutritional information expressed by the nutrients */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\NutritionProduct\NutritionProductIngredient> ingredient Ingredients contained in this product */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableReference> knownAllergen Known or suspected allergens that are a part of this product */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'CodeableReference',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\NutritionProduct\NutritionProductProductCharacteristic> productCharacteristic Specifies descriptive properties of the nutrition product */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\NutritionProduct\NutritionProductInstance instance One or several physical instances or occurrences of the nutrition product */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?NutritionProduct\NutritionProductInstance $instance = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Annotation> note Comments made about the product */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Annotation',
			propertyKind: 'complex',
			isArray: true,
