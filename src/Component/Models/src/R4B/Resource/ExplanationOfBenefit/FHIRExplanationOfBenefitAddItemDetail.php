...
class FHIRExplanationOfBenefitAddItemDetail extends FHIRBackboneElement
{
    public function __construct(
        ...
        /** @var array<FHIRExplanationOfBenefitAddItemDetailSubDetail> subDetail Insurer added line items */
