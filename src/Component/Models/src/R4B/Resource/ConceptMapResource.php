...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ConceptMap\ConceptMapGroup;
 ...
 */
#[FhirResource(type: 'ConceptMap', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/ConceptMap', fhirVersion: 'R4B')]
#[FHIRPathInvariant(
    key: 'cmd-0',
    severity: 'warning',
