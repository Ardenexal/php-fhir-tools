 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirResource(type: 'ConceptMap', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/ConceptMap', fhirVersion: 'R4B')]
class ConceptMapResource extends DomainResourceResource
{
	public const FHIR_PROPERTY_MAP = [
		...
		'group' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\ConceptMap\ConceptMapGroup',
			'variants' => null,
		],
	];
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UriPrimitive|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\CanonicalPrimitive source The source value set that contains the concepts that are being mapped */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'choice',
			propertyKind: 'choice',
			isChoice: true,
		...
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UriPrimitive|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\CanonicalPrimitive|null $source = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UriPrimitive|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\CanonicalPrimitive target The target value set which provides context for the mappings */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'choice',
			propertyKind: 'choice',
			isChoice: true,
		...
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UriPrimitive|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\CanonicalPrimitive|null $target = null,
