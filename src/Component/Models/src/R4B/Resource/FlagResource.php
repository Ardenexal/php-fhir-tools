...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\FlagStatusType;
 ...
 */
#[FhirResource(type: 'Flag', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Flag', fhirVersion: 'R4B')]
class FlagResource extends DomainResourceResource
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/flag-status|4.3.0', strength: 'required')]
