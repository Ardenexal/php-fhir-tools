...
class VerificationResultResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> target A resource that was validated */
		...
		public array $target = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string> targetLocation The fhirpath location(s) within the resource that was validated */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept need none | initial | periodic */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $need = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\StatusType status attested | validated | in-process | req-revalid | val-fail | reval-fail */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\StatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive statusDate When the validation status was updated */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept validationType nothing | primary | multiple */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $validationType = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> validationProcess The primary process by which the target is validated (edit check; value set; primary source; multiple sources; standalone; in context) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Timing frequency Frequency of revalidation */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Timing', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Timing $frequency = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive lastPerformed The date/time validation was last completed (including failed validations) */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive $lastPerformed = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DatePrimitive nextScheduled The date when target is next validated, if appropriate */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DatePrimitive $nextScheduled = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept failureAction fatal | warn | rec-only | none */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $failureAction = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\VerificationResult\VerificationResultPrimarySource> primarySource Information about the primary source(s) involved in validation */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\VerificationResult\VerificationResultAttestation attestation Information about the entity attesting to information */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\VerificationResult\VerificationResultValidator> validator Information about the entity validating information */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone', isArray: true)]
