 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirResource(type: 'Subscription', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Subscription', fhirVersion: 'R4B')]
class SubscriptionResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\SubscriptionStatusCodesType status requested | active | error | off */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\SubscriptionStatusCodesType $status = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\InstantPrimitive end When to automatically delete the subscription */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string reason Description of why this subscription was created */
		...
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string|null $reason = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string criteria Rule for server push */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'string', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string|null $criteria = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string error Latest error note */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string|null $error = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Subscription\SubscriptionChannel channel The channel on which to report matches to the criteria */
