...
class QuestionnaireResponseResource extends DomainResourceResource
{
	public const FHIR_PROPERTY_MAP = [
		...
		'item' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\QuestionnaireResponse\QuestionnaireResponseItem',
			'variants' => null,
		],
	];
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier identifier Unique id for this set of answers */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> basedOn Request fulfilled by this QuestionnaireResponse */
		...
		public array $partOf = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\CanonicalPrimitive questionnaire Form being answered */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'canonical', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\CanonicalPrimitive $questionnaire = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\QuestionnaireResponseStatusType status in-progress | completed | amended | entered-in-error | stopped */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\QuestionnaireResponseStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference subject The subject of the questions */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive authored Date the answers were gathered */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'dateTime', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive $authored = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference author Person who received and recorded the answers */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $author = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference source The person who answered the questions */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $source = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\QuestionnaireResponse\QuestionnaireResponseItem> item Groups and questions */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
