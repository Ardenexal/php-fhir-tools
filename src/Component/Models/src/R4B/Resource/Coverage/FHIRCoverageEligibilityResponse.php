...
class FHIRCoverageEligibilityResponse extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIREligibilityResponsePurposeType> purpose auth-requirements | benefits | discovery | validation */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRReference requestor Party responsible for the request */
		public ?FHIRReference $requestor = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRReference request Eligibility request reference */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRCoverageEligibilityResponseInsurance> insurance Patient insurance information */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRCodeableConcept form Printed form identifier */
		public ?FHIRCodeableConcept $form = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRCoverageEligibilityResponseError> error Processing errors */
		public array $error = [],
	) {
