...
class MedicinalProductDefinitionNameNamePart extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var CodeableConcept|null type Identifying type for this part of the name (e.g. strength part) */
