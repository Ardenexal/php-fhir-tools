...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\ResearchElementTypeType;
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\UsageContext;
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\VariableTypeType;
...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ResearchElementDefinition\ResearchElementDefinitionCharacteristic;
...
class ResearchElementDefinitionResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/research-element-type|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ResearchElementType',
        )]
        public ?ResearchElementTypeType $type = null,
        /** @var VariableTypeType|null variableType dichotomous | continuous | descriptive */
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/variable-type|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\VariableType',
        )]
        public ?VariableTypeType $variableType = null,
