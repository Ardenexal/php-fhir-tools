...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\OperationKindType;
...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\OperationDefinition\OperationDefinitionOverload;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\OperationDefinition\OperationDefinitionParameter;
...
class OperationDefinitionResource extends DomainResourceResource
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/operation-kind|4.3.0', strength: 'required')]
