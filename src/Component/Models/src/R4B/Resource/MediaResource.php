 ...
 */
#[FhirResource(type: 'Media', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Media', fhirVersion: 'R4B')]
class MediaResource extends DomainResourceResource
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex'), FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/media-type', strength: 'extensible')]
