 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirResource(type: 'Medication', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Medication', fhirVersion: 'R4B')]
class MedicationResource extends DomainResourceResource
{
	public const FHIR_PROPERTY_MAP = [
		...
		'ingredient' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\Medication\MedicationIngredient',
			'variants' => null,
		],
		'batch' => [
			'fhirType' => 'BackboneElement',
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier> identifier Business identifier for this medication */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept code Codes that identify this medication */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $code = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\MedicationStatusCodesType status active | inactive | entered-in-error */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\MedicationStatusCodesType $status = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept form powder | tablets | capsule + */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $form = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Ratio amount Amount of drug in package */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Ratio', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Ratio $amount = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Medication\MedicationIngredient> ingredient Active or inactive ingredient */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Medication\MedicationBatch batch Details about packaged medications */
