 ...
 */
#[FHIRBackboneElement(parentResource: 'CapabilityStatement', elementPath: 'CapabilityStatement.rest.security', fhirVersion: 'R4B')]
class CapabilityStatementRestSecurity extends BackboneElement
{
    public function __construct(
        ...
        #[FHIRValueSetBinding(
            ...
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\RestfulSecurityService',
        )]
