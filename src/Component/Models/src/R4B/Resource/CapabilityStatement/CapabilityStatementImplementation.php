 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRBackboneElement(parentResource: 'CapabilityStatement', elementPath: 'CapabilityStatement.implementation', fhirVersion: 'R4B')]
class CapabilityStatementImplementation extends \Ardenexal\FHIRTools\Component\Models\R4B\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string description Describes this specific instance */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UrlPrimitive url Base URL for the installation */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference custodian Organization that manages the data */
