...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\DocumentModeType;
 ...
 */
#[FHIRBackboneElement(parentResource: 'CapabilityStatement', elementPath: 'CapabilityStatement.document', fhirVersion: 'R4B')]
class CapabilityStatementDocument extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/document-mode|4.3.0', strength: 'required')]
