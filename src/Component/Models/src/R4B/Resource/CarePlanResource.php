...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\CarePlanIntentType;
...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\CarePlan\CarePlanActivity;
 ...
 */
#[FhirResource(type: 'CarePlan', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/CarePlan', fhirVersion: 'R4B')]
class CarePlanResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/care-plan-intent|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\CarePlanIntent',
        )]
