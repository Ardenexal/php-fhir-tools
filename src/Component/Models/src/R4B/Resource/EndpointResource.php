...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\EndpointStatusType;
 ...
 */
#[FhirResource(type: 'Endpoint', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Endpoint', fhirVersion: 'R4B')]
class EndpointResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'Coding', propertyKind: 'complex', isRequired: true), Valid, NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/endpoint-connection-type', strength: 'extensible')]
