...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\CareTeamStatusType;
...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\CareTeam\CareTeamParticipant;
...
class CareTeamResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/care-team-status|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\CareTeamStatus',
        )]
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\CareTeam\CareTeamParticipant',
        )]
        #[Valid]
