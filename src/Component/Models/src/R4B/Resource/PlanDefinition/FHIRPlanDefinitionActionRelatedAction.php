...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\FHIRActionRelationshipTypeType;
 ...
 */
#[FHIRBackboneElement(parentResource: 'PlanDefinition', elementPath: 'PlanDefinition.action.relatedAction', fhirVersion: 'R4B')]
