...
class IngredientSubstanceStrengthReferenceStrength extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'CodeableReference', propertyKind: 'complex'), Valid, FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/SubstanceDefinition'])]
