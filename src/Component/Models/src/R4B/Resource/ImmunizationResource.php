...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\ImmunizationStatusCodesType;
...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\Immunization\ImmunizationEducation;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\Immunization\ImmunizationPerformer;
...
class ImmunizationResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/immunization-status|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ImmunizationStatusCodes',
        )]
