...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\ClinicalImpressionStatusType;
...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClinicalImpression\ClinicalImpressionFinding;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClinicalImpression\ClinicalImpressionInvestigation;
...
class ClinicalImpressionResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/clinicalimpression-status|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ClinicalImpressionStatus',
        )]
