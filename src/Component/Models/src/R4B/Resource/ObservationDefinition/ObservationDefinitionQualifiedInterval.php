...
class ObservationDefinitionQualifiedInterval extends BackboneElement
{
    public function __construct(
        ...
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/observation-range-category|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ObservationRangeCategory',
        )]
        ...
        #[FHIRValueSetBinding(
            ...
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ObservationReferenceRangeMeaningCodes',
        )]
