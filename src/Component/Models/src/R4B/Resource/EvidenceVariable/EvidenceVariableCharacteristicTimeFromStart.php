 ...
 */
#[FHIRBackboneElement(parentResource: 'EvidenceVariable', elementPath: 'EvidenceVariable.characteristic.timeFromStart', fhirVersion: 'R4B')]
class EvidenceVariableCharacteristicTimeFromStart extends BackboneElement
{
