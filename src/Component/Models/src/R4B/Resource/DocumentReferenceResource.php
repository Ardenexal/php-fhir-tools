...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\DocumentReferenceStatusType;
...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\DocumentReference\DocumentReferenceContent;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\DocumentReference\DocumentReferenceContext;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\DocumentReference\DocumentReferenceRelatesTo;
...
class DocumentReferenceResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/document-reference-status|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\DocumentReferenceStatus',
        )]
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/composition-status|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\CompositionStatus',
        )]
        ...
        #[FHIRValueSetBinding(
            ...
            strength: 'preferred',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\FHIRDocumentTypeCodes',
        )]
