...
class SupplyRequestResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier> identifier Business Identifier for SupplyRequest */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\SupplyRequestStatusType status draft | active | suspended + */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\SupplyRequestStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept category The kind of supply (central, non-stock, etc.) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference itemX Medication, Substance, or Device requested to be supplied */
		...
		public \Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference|null $itemX = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Quantity quantity The requested amount of the item indicated */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\SupplyRequest\SupplyRequestParameter> parameter Ordered item details */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Period|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Timing occurrenceX When the request should be fulfilled */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(
			fhirType: 'choice',
			propertyKind: 'choice',
			isChoice: true,
		...
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Period|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Timing|null $occurrenceX = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive authoredOn When the request was made */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference requester Individual making the request */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> supplier Who is intended to fulfill the request */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> reasonCode The reason why the supply item was requested */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> reasonReference The reason why the supply item was requested */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex', isArray: true)]
		public array $reasonReference = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference deliverFrom The origin of the supply */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $deliverFrom = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference deliverTo The destination of the supply */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $deliverTo = null,
	) {
