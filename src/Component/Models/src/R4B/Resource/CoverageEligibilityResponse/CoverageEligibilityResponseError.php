 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRBackboneElement(parentResource: 'CoverageEligibilityResponse', elementPath: 'CoverageEligibilityResponse.error', fhirVersion: 'R4B')]
class CoverageEligibilityResponseError extends \Ardenexal\FHIRTools\Component\Models\R4B\DataType\BackboneElement
{
