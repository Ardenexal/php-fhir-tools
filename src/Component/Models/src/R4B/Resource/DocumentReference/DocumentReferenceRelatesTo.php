...
class DocumentReferenceRelatesTo extends BackboneElement
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/document-relationship-type|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\DocumentRelationshipType',
        )]
