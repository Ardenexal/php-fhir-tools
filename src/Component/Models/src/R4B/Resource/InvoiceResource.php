...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\InvoiceStatusType;
...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\Invoice\InvoiceLineItem;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\Invoice\InvoiceLineItemPriceComponent;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\Invoice\InvoiceParticipant;
...
class InvoiceResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/invoice-status|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\InvoiceStatus',
        )]
        ...
        #[FhirProperty(fhirType: 'Reference', propertyKind: 'complex'), Valid, FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/Account'])]
