...
class SubscriptionStatusResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\SubscriptionStatusCodesType status requested | active | error | off | entered-in-error */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\SubscriptionStatusCodesType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\SubscriptionNotificationTypeType type handshake | heartbeat | event-notification | query-status | query-event */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\SubscriptionNotificationTypeType $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string eventsSinceSubscriptionStart Events since the Subscription was created */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string|null $eventsSinceSubscriptionStart = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\SubscriptionStatus\SubscriptionStatusNotificationEvent> notificationEvent Detailed information about any events relevant to this notification */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference subscription Reference to the Subscription responsible for this notification */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $subscription = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\CanonicalPrimitive topic Reference to the SubscriptionTopic this notification relates to */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'canonical', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\CanonicalPrimitive $topic = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> error List of errors on the subscription */
