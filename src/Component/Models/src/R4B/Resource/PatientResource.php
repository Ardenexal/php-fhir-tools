 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirResource(type: 'Patient', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Patient', fhirVersion: 'R4B')]
class PatientResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier> identifier An identifier for this patient */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\HumanName> name A name associated with the patient */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'HumanName',
			propertyKind: 'complex',
			isArray: true,
		...
		public array $name = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\ContactPoint> telecom A contact detail for the individual */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'ContactPoint',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DatePrimitive birthDate The date of birth for the individual */
		...
		/** @var null|bool|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive deceased Indicates if the individual is deceased or not */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'choice',
			propertyKind: 'choice',
			isChoice: true,
		...
		public bool|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive|null $deceased = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Address> address An address for the individual */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Address',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept maritalStatus Marital (civil) status of a patient */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $maritalStatus = null,
		/** @var null|bool|int multipleBirth Whether patient is part of a multiple birth */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'choice',
			propertyKind: 'choice',
			isChoice: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Attachment> photo Image of the patient */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Attachment',
			propertyKind: 'complex',
			isArray: true,
		...
		public array $photo = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Patient\PatientContact> contact A contact party (e.g. guardian, partner, friend) for the patient */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Patient\PatientCommunication> communication A language which may be used to communicate with the patient about his or her health */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> generalPractitioner Patient's nominated primary care provider */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Reference',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference managingOrganization Organization that is the custodian of the patient record */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Patient\PatientLink> link Link to another patient resource that concerns the same actual person */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
