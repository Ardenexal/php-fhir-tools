 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirResource(type: 'Binary', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Binary', fhirVersion: 'R4B')]
class BinaryResource extends ResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\MimeTypesType contentType MimeType of the binary content */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference securityContext Identifies another resource to use as proxy when enforcing access control */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $securityContext = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\Base64BinaryPrimitive data The actual content */
