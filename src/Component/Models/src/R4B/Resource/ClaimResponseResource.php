...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseAddItem;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseError;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseInsurance;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseItem;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseItemAdjudication;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponsePayment;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseProcessNote;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseTotal;
...
class ClaimResponseResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/fm-status|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\FinancialResourceStatusCodes',
        )]
        #[FHIRIsModifier(reason: 'This element is labeled as a modifier because it is a status element that contains status entered-in-error which means that the resource should not be treated as valid')]
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/claim-type',
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ClaimTypeCodes',
        )]
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/claim-use|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\ClaimUse',
        )]
        ...
        #[FhirProperty(fhirType: 'Reference', propertyKind: 'complex'), Valid, FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/Claim'])]
        public ?Reference $request = null,
        /** @var RemittanceOutcomeType|null outcome queued | complete | error | partial */
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true)]
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/remittance-outcome|4.3.0',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\RemittanceOutcome',
        )]
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseItem',
        )]
        #[Valid]
        public array $item = [],
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseAddItem',
        )]
        #[Valid]
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseTotal',
        )]
        #[Valid]
        public array $total = [],
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseProcessNote',
        )]
        #[Valid]
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseInsurance',
        )]
        #[Valid]
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\ClaimResponse\ClaimResponseError',
        )]
        #[Valid]
        public array $error = [],
    ) {
