...
class NutritionOrderResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference patient The person who requires the diet, formula or nutritional supplement */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference encounter The encounter associated with this nutrition order */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\DateTimePrimitive dateTime Date and time the nutrition order was requested */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference orderer Who ordered the diet, formula or nutritional supplement */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Reference', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $orderer = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> allergyIntolerance List of the patient's food and nutrition-related allergies and intolerances */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Reference',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> foodPreferenceModifier Order-specific modifier about the type of food that should be given */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'CodeableConcept',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> excludeFoodModifier Order-specific modifier about the type of food that should not be given */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'CodeableConcept',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\NutritionOrder\NutritionOrderOralDiet oralDiet Oral diet components */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\NutritionOrder\NutritionOrderSupplement> supplement Supplement components */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\NutritionOrder\NutritionOrderEnteralFormula enteralFormula Enteral formula components */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
