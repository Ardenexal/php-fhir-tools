...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\Coverage\CoverageClass;
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\Coverage\CoverageCostToBeneficiary;
...
class CoverageResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/coverage-type',
            strength: 'preferred',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\CoverageTypeAndSelfPayCodes',
        )]
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/subscriber-relationship',
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\SubscriberRelationshipCodes',
        )]
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\Coverage\CoverageClass',
        )]
        #[Valid]
        public array $class = [],
        ...
        #[FhirProperty(
            ...
            propertyKind: 'backbone',
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\Coverage\CoverageCostToBeneficiary',
        )]
        #[Valid]
        ...
        #[Valid]
        #[FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/Contract'])]
