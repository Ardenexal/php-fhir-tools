...
namespace Ardenexal\FHIRTools\Component\Models\R4B\Resource\NamingSystem;

/**
 * @description Indicates how the system may be identified when referenced in electronic exchange.
 */
#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FHIRBackboneElement(parentResource: 'NamingSystem', elementPath: 'NamingSystem.uniqueId', fhirVersion: 'R4B')]
class NamingSystemUniqueId extends \Ardenexal\FHIRTools\Component\Models\R4B\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\NamingSystemIdentifierTypeType type oid | uuid | uri | other */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\NamingSystemIdentifierTypeType $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string value The unique identifier */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string comment Notes about identifier usage */
		#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string|null $comment = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Period period When is identifier valid? */
