 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRBackboneElement(parentResource: 'ClaimResponse', elementPath: 'ClaimResponse.item.adjudication', fhirVersion: 'R4B')]
class ClaimResponseItemAdjudication extends \Ardenexal\FHIRTools\Component\Models\R4B\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|numeric-string value Non-monetary value */
