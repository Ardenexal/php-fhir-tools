...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\CompartmentTypeType;
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\Extension;
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\GraphCompartmentRuleType;
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\GraphCompartmentUseType;
...
class GraphDefinitionLinkTargetCompartment extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/graph-compartment-use|4.3.0', strength: 'required')]
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/compartment-type|4.3.0', strength: 'required')]
        public ?CompartmentTypeType $code = null,
        /** @var GraphCompartmentRuleType|null rule identical | matching | different | custom */
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/graph-compartment-rule|4.3.0', strength: 'required')]
