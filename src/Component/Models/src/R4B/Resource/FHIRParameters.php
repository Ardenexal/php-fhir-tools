 ...
 */
#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FhirResource(type: 'Parameters', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Parameters', fhirVersion: 'R4B')]
class FHIRParameters extends FHIRResource
{
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRParametersParameter> parameter Operation Parameter */
