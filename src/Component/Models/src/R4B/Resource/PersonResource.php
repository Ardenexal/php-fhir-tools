...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\Person\PersonLink;
 ...
 */
#[FhirResource(type: 'Person', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Person', fhirVersion: 'R4B')]
class PersonResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\Person\PersonLink',
        )]
        public array $link = [],
    ) {
