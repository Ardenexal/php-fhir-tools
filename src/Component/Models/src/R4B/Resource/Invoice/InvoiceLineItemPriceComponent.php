 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRBackboneElement(parentResource: 'Invoice', elementPath: 'Invoice.lineItem.priceComponent', fhirVersion: 'R4B')]
class InvoiceLineItemPriceComponent extends \Ardenexal\FHIRTools\Component\Models\R4B\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|numeric-string factor Factor used for calculating this component */
