 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirResource(type: 'Bundle', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Bundle', fhirVersion: 'R4B')]
class BundleResource extends ResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier identifier Persistent identifier for the bundle */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\BundleTypeType type document | message | transaction | transaction-response | batch | batch-response | history | searchset | collection */
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\BundleTypeType $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\InstantPrimitive timestamp When the bundle was assembled */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'instant', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\InstantPrimitive $timestamp = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UnsignedIntPrimitive total If search, the total number of matches */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'unsignedInt', propertyKind: 'primitive')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UnsignedIntPrimitive $total = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Bundle\BundleLink> link Links related to this Bundle */
		...
		public array $link = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Bundle\BundleEntry> entry Entry in the bundle - will have a resource or information */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		public array $entry = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Signature signature Digital Signature */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'Signature', propertyKind: 'complex')]
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Signature $signature = null,
	) {
