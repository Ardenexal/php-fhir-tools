 ...
 */
#[FHIRBackboneElement(parentResource: 'Measure', elementPath: 'Measure.group', fhirVersion: 'R4B')]
class MeasureGroup extends BackboneElement
{
    public const FHIR_PROPERTY_MAP = [
        ...
        'population' => [
            ...
            'isChoice'     => false,
            'jsonKey'      => null,
            'phpType'      => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\Measure\MeasureGroupPopulation',
            'variants'     => null,
        ],
        'stratifier' => [
            'fhirType'     => 'BackboneElement',
            ...
            'isChoice'     => false,
            'jsonKey'      => null,
            'phpType'      => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\Measure\MeasureGroupStratifier',
            'variants'     => null,
        ],
    ];
