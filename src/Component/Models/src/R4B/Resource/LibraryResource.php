 ...
 */
#[FhirResource(type: 'Library', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Library', fhirVersion: 'R4B')]
#[FHIRPathInvariant(
    key: 'cnl-0',
    severity: 'warning',
...
class LibraryResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FHIRValueSetBinding(
            ...
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4B\Enum\LibraryType',
        )]
