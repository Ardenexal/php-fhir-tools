 ...
 */
#[FHIRBackboneElement(parentResource: 'MedicationKnowledge', elementPath: 'MedicationKnowledge.ingredient', fhirVersion: 'R4B')]
class MedicationKnowledgeIngredient extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var CodeableConcept|Reference|null item Medication(s) or substance(s) contained in the medication */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isRequired: true,
