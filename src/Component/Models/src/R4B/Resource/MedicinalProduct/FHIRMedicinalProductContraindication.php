...
class FHIRMedicinalProductContraindication extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRCodeableConcept disease The disease, symptom or procedure for the contraindication */
		public ?FHIRCodeableConcept $disease = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRCodeableConcept diseaseStatus The status of the disease or symptom for the contraindication */
		public ?FHIRCodeableConcept $diseaseStatus = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRCodeableConcept> comorbidity A comorbidity (concurrent condition) or coinfection */
		public array $comorbidity = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRReference> therapeuticIndication Information about the use of the medicinal product in relation to other therapies as part of the indication */
