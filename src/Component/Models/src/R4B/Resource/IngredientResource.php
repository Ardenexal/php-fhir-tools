 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirResource(type: 'Ingredient', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/Ingredient', fhirVersion: 'R4B')]
class IngredientResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier identifier An identifier or code by which the ingredient can be referenced */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> for The product which this ingredient is a constituent part of */
		...
		public array $for = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept role Purpose of the ingredient within the product, e.g. active, inactive */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> function Precise action within the drug product, e.g. antioxidant, alkalizing agent */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'CodeableConcept',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Ingredient\IngredientManufacturer> manufacturer An organization that manufactures this ingredient */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\Ingredient\IngredientSubstance substance The substance that comprises this ingredient */
		...
		public ?Ingredient\IngredientSubstance $substance = null,
	) {
