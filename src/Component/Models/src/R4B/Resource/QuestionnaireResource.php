...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\Questionnaire\QuestionnaireItem;
...
class QuestionnaireResource extends DomainResourceResource
{
    public function __construct(
        ...
        /** @var UriPrimitive|null url Canonical identifier for this questionnaire, represented as a URI (globally unique) */
        #[FhirProperty(fhirType: 'uri', propertyKind: 'primitive')]
        public ?UriPrimitive $url = null,
        /** @var array<Identifier> identifier Additional identifier for the questionnaire */
        #[FhirProperty(
            fhirType: 'Identifier',
        ...
        /** @var array<CanonicalPrimitive> derivedFrom Instantiates protocol or definition */
        #[FhirProperty(fhirType: 'canonical', propertyKind: 'primitive', isArray: true), FHIRTargetProfile(targetProfiles: ['http://hl7.org/fhir/StructureDefinition/Questionnaire'])]
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive', isArray: true), FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/resource-types|4.3.0', strength: 'required')]
        ...
        /** @var DatePrimitive|null lastReviewDate When the questionnaire was last reviewed */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
