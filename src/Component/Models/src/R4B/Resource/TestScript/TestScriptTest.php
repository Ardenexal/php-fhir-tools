 ...
 */
#[FHIRBackboneElement(parentResource: 'TestScript', elementPath: 'TestScript.test', fhirVersion: 'R4B')]
class TestScriptTest extends BackboneElement
{
    ...
    public function __construct(
        ...
        /** @var array<TestScriptTestAction> action A test operation or assert to perform */
