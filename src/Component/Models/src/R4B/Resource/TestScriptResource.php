 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirResource(type: 'TestScript', version: '4.3.0', url: 'http://hl7.org/fhir/StructureDefinition/TestScript', fhirVersion: 'R4B')]
class TestScriptResource extends DomainResourceResource
{
	public const FHIR_PROPERTY_MAP = [
		...
		'origin' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptOrigin',
			'variants' => null,
		],
		'destination' => [
			'fhirType' => 'BackboneElement',
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptDestination',
			'variants' => null,
		],
		'metadata' => [
			'fhirType' => 'BackboneElement',
		...
		'fixture' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptFixture',
			'variants' => null,
		],
		'profile' => [
			'fhirType' => 'Reference',
		...
		'variable' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptVariable',
			'variants' => null,
		],
		'setup' => [
			'fhirType' => 'BackboneElement',
		...
		'test' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptTest',
			'variants' => null,
		],
		'teardown' => [
			'fhirType' => 'BackboneElement',
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\UriPrimitive url Canonical identifier for this test script, represented as a URI (globally unique) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Identifier identifier Additional identifier for the test script */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string version Business version of the test script */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string|null $version = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string name Name for this test script (computer friendly) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string title Name for this test script (human friendly) */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\MarkdownPrimitive description Natural language description of the test script */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept> jurisdiction Intended jurisdiction for test script (if applicable) */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'CodeableConcept',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\MarkdownPrimitive purpose Why this test script is defined */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'markdown', propertyKind: 'primitive')]
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptOrigin> origin An abstract server representing a client or sender in a message exchange */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		public array $origin = [],
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptDestination> destination An abstract server representing a destination or receiver in a message exchange */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptMetadata metadata Required capability that is assumed to function correctly on the FHIR server being tested */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptFixture> fixture Fixture in the test script - by reference (uri) */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference> profile Reference of the validation profile */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'Reference',
			propertyKind: 'complex',
			isArray: true,
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptVariable> variable Placeholder for evaluated elements */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptSetup setup A series of required setup operations before tests are executed */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
		public ?TestScript\TestScriptSetup $setup = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptTest> test A test in this script */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'BackboneElement',
			propertyKind: 'backbone',
			isArray: true,
		...
		public array $test = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\TestScript\TestScriptTeardown teardown A series of required clean up steps */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'BackboneElement', propertyKind: 'backbone')]
