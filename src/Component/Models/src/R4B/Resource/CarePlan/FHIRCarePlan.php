...
use Ardenexal\FHIRTools\Component\Models\R4B\DataType\FHIRCarePlanIntentType;
...
class FHIRCarePlan extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var array<FHIRReference> basedOn Fulfills CarePlan */
        ...
        /** @var FHIRCarePlanIntentType|null intent proposal | plan | order | option */
        #[NotBlank]
        ...
        /** @var FHIRReference|null author Who is the designated responsible party */
        ...
        /** @var array<FHIRReference> addresses Health issues this plan addresses */
        ...
        public array $goal = [],
        /** @var array<FHIRCarePlanActivity> activity Action to occur as part of plan */
