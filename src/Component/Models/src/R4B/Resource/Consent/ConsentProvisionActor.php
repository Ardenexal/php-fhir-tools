 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRBackboneElement(parentResource: 'Consent', elementPath: 'Consent.provision.actor', fhirVersion: 'R4B')]
class ConsentProvisionActor extends \Ardenexal\FHIRTools\Component\Models\R4B\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept role How the actor is involved */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference reference Resource for the actor (or group, by role) */
