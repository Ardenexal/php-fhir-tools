...
#[FhirOperationPayload(
    operationUrl: 'http://hl7.org/fhir/OperationDefinition/ActivityDefinition-apply',
    use: 'in',
    version: 'R4B',
    operation: 'ActivityDefinitionApply',
    path: '',
)]
final class ActivityDefinitionApplyInput
{
    /**
    ...
    public function __construct(
        ...
        public readonly ?ActivityDefinitionResource $activityDefinition = null,
        #[FhirOperationParameter(
            name: 'subject',
            phpName: 'subject',
            use: 'in',
