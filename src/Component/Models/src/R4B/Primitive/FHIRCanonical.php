 ...
 */
#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FHIRPrimitive(primitiveType: 'canonical', fhirVersion: 'R4B')]
class FHIRCanonical extends \Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRUri
{
