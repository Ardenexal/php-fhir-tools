 ...
 */
#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FHIRPrimitive(primitiveType: 'positiveInt', fhirVersion: 'R4B')]
class FHIRPositiveInt extends \Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRInteger
{
