...
use Ardenexal\FHIRTools\Component\Models\R4B\Resource\RequestGroupResource;
 ...
 */
#[FHIRProfile(profileUrl: 'http://hl7.org/fhir/StructureDefinition/cdshooksrequestgroup', baseType: 'RequestGroup', fhirVersion: 'R4B')]
