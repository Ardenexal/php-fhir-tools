 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/structuredefinition-ancestor', fhirVersion: 'R4B')]
class AncestorExtension extends Extension
{
