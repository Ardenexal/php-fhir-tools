 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/goal-relationship', fhirVersion: 'R4B')]
class RelationshipExtension extends \Ardenexal\FHIRTools\Component\Models\R4B\DataType\Extension implements FHIRComplexExtensionInterface
{
    public function __construct(
        ...
        public \Ardenexal\FHIRTools\Component\Models\R4B\DataType\Reference $target,
        ?string $id = null,
    ) {
        $subExtensions   = [];
