 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRComplexType(typeName: 'DataRequirement.sort', fhirVersion: 'R4B')]
class DataRequirementSort extends Element
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string path The name of the attribute to perform the sort */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\SortDirectionType direction ascending | descending */
