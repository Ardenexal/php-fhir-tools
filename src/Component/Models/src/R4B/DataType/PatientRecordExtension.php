 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/familymemberhistory-patient-record', fhirVersion: 'R4B')]
class PatientRecordExtension extends Extension
{
