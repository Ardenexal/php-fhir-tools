 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/valueset-expirationDate', fhirVersion: 'R4B')]
class ExpirationDateExtension extends Extension
{
