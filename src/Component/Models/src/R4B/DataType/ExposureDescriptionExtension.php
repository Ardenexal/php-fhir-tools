 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/openEHR-exposureDescription', fhirVersion: 'R4B')]
class ExposureDescriptionExtension extends Extension
{
