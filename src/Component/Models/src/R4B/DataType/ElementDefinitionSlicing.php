...
class ElementDefinitionSlicing extends Element
{
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\ElementDefinitionSlicingDiscriminator> discriminator Element values that are used to distinguish the slices */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string description Text description of how slicing works (or not) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\SlicingRulesType rules closed | open | openAtEnd */
