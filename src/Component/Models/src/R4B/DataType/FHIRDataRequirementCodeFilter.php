...
class FHIRDataRequirementCodeFilter extends FHIRElement
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\FHIRString|string path A code-valued attribute to filter on */
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\FHIRString|string|null $path = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\FHIRString|string searchParam A coded (token) parameter to search on */
		public \Ardenexal\FHIRTools\Component\Models\R4B\Primitive\FHIRString|string|null $searchParam = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\FHIRCanonical valueSet Valueset for the filter */
		public ?\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\FHIRCanonical $valueSet = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4B\DataType\FHIRCoding> code What code is expected */
		public array $code = [],
	) {
