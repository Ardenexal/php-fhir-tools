 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/observation-bodyPosition', fhirVersion: 'R4B')]
class BodyPositionExtension extends Extension
{
