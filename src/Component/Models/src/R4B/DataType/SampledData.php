 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRComplexType(typeName: 'SampledData', fhirVersion: 'R4B')]
class SampledData extends Element
{
	...
	public function __construct(
		...
		/** @var null|numeric-string period Number of milliseconds between samples */
		...
		/** @var null|numeric-string factor Multiply data by this before adding to origin */
		...
		/** @var null|numeric-string lowerLimit Lower limit of detection */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'decimal', propertyKind: 'scalar')]
		public ?string $lowerLimit = null,
		/** @var null|numeric-string upperLimit Upper limit of detection */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'decimal', propertyKind: 'scalar')]
