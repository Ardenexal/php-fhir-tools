...
class AnimalExtension extends \Ardenexal\FHIRTools\Component\Models\R4B\DataType\Extension implements FHIRComplexExtensionInterface
{
    public function __construct(
        /** @var CodeableConcept species The animal species.  E.g. Dog, Cow. */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
        public \Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $species,
        /** @var CodeableConcept|null breed The animal breed.  E.g. Poodle, Angus. */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
        public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $breed = null,
        /** @var CodeableConcept|null genderStatus The status of the animal's reproductive parts.  E.g. Neutered, Intact. */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
        public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $genderStatus = null,
        ?string $id = null,
    ) {
        $subExtensions   = [];
