 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-houseNumberNumeric', fhirVersion: 'R4B')]
class ADXPHouseNumberNumericExtension extends Extension
{
