 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/iso21090-PQ-translation', fhirVersion: 'R4B')]
class PQTranslationExtension extends Extension
{
    public function __construct(
        /** @var Quantity|null valueQuantity Value of extension */
        #[FhirProperty(fhirType: 'Quantity', propertyKind: 'complex')]
        public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Quantity $valueQuantity = null,
        ?string $id = null,
        array $extension = [],
    ) {
        parent::__construct(
