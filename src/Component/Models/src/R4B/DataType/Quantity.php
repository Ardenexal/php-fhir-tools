 ...
 */
#[FHIRComplexType(typeName: 'Quantity', fhirVersion: 'R4B')]
#[FHIRPathInvariant(
    key: 'qty-3',
    severity: 'error',
...
class Quantity extends Element
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive'), FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/quantity-comparator|4.3.0', strength: 'required')]
