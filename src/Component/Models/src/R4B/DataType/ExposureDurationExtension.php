 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/openEHR-exposureDuration', fhirVersion: 'R4B')]
class ExposureDurationExtension extends Extension
{
