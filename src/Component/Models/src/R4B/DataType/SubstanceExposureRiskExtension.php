...
class SubstanceExposureRiskExtension extends \Ardenexal\FHIRTools\Component\Models\R4B\DataType\Extension implements FHIRComplexExtensionInterface
{
    public function __construct(
        /** @var CodeableConcept substance Substance (or pharmaceutical product) */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
        public \Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $substance,
        /** @var CodeableConcept exposureRisk known-reaction-risk | no-known-reaction-risk */
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex')]
        public \Ardenexal\FHIRTools\Component\Models\R4B\DataType\CodeableConcept $exposureRisk,
        ?string $id = null,
    ) {
        $subExtensions   = [];
