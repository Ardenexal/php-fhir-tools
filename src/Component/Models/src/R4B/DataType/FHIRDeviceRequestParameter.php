...
/**
 * @fhir-backbone-element DeviceRequest.parameter
 * @description Specific parameters for the ordered item.  For example, the prism value for lenses.
 */
class FHIRDeviceRequestParameter extends \Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRBackboneElement
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Resource\FHIRCodeableConcept code Device detail */
