 ...
 */
#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FHIRComplexType(typeName: 'ElementDefinition.slicing.discriminator', fhirVersion: 'R4B')]
class ElementDefinitionSlicingDiscriminator extends Element
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\DataType\DiscriminatorTypeType type value | exists | pattern | type | profile */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4B\Primitive\StringPrimitive|string path Path to element value */
