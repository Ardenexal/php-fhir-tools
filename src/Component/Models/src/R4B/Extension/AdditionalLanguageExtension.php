 ...
 *
 * @see http://hl7.org/fhir/StructureDefinition/additional-language
 *
 * @description The Resource contains content in a language additional to the one in the language element.
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/additional-language', fhirVersion: 'R4B')]
class AdditionalLanguageExtension extends Extension
{
