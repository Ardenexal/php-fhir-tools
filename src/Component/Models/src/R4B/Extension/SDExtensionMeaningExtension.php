 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/structuredefinition-extension-meaning', fhirVersion: 'R4B')]
#[FHIRExtensionContext(type: 'element', expression: 'Extension')]
#[FHIRExtensionContext(type: 'element', expression: 'Extension.value')]
class SDExtensionMeaningExtension extends Extension
{
    /**
