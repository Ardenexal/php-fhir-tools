 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-direction', fhirVersion: 'R4B')]
class ADXPDirectionExtension extends Extension
{
