 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/questionnaireresponse-reviewer', fhirVersion: 'R4B')]
class QRReviewerExtension extends Extension
{
