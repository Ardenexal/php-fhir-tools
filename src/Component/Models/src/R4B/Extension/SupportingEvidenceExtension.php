 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/cqf-supportingEvidence', fhirVersion: 'R4B')]
...
class SupportingEvidenceExtension extends Extension implements FHIRComplexExtensionInterface
{
    ...
    public static function fromSubExtensions(array $subExtensions, ?string $id = null): static
    {
        ...
        return new static($name, $description, $code, $valueSlice, $id);
    }
}
