 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/resource-lastReviewDate', fhirVersion: 'R4B')]
class LastReviewDateExtension extends Extension
{
