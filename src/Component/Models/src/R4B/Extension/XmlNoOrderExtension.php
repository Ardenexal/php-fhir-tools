 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/structuredefinition-xml-no-order', fhirVersion: 'R4B')]
class XmlNoOrderExtension extends Extension
{
