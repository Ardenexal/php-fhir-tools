 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/elementdefinition-type-must-support', fhirVersion: 'R4B')]
...
class TypeMustSupportExtension extends Extension
{
    /**
