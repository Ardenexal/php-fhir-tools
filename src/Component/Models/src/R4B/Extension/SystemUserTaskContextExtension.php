 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/cqf-systemUserTaskContext', fhirVersion: 'R4B')]
class SystemUserTaskContextExtension extends Extension
{
