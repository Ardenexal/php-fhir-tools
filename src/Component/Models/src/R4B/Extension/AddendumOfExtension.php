 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/diagnosticReport-addendumOf', fhirVersion: 'R4B')]
class AddendumOfExtension extends Extension
{
