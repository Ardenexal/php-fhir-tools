 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/patient-relatedPerson', fhirVersion: 'R4B')]
class PatRelatedPersonExtension extends Extension
{
