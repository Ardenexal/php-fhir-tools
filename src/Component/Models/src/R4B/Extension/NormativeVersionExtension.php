 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/structuredefinition-normative-version', fhirVersion: 'R4B')]
class NormativeVersionExtension extends Extension
{
