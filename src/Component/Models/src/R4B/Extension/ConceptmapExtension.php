 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/elementdefinition-conceptmap', fhirVersion: 'R4B')]
...
class ConceptmapExtension extends Extension
{
