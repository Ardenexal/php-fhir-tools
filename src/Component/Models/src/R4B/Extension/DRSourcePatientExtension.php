 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/documentreference-sourcepatient', fhirVersion: 'R4B')]
class DRSourcePatientExtension extends Extension
{
