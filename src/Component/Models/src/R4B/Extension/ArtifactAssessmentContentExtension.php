 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/artifactassessment-content', fhirVersion: 'R4B')]
...
class ArtifactAssessmentContentExtension extends Extension implements FHIRComplexExtensionInterface
{
    ...
    public static function fromSubExtensions(array $subExtensions, ?string $id = null): self
    {
        ...
        return new self($informationType, $summary, $type, $classifier, $quantity, $author, $path, $relatedArtifact, $freeToShare, $component, $id);
    }
}
