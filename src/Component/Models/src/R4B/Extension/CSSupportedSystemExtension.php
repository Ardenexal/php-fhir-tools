 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/capabilitystatement-supported-system', fhirVersion: 'R4B')]
class CSSupportedSystemExtension extends Extension
{
