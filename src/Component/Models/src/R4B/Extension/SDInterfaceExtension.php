 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/structuredefinition-interface', fhirVersion: 'R4B')]
class SDInterfaceExtension extends Extension
{
