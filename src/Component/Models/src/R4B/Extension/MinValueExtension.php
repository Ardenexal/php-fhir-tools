...
class MinValueExtension extends Extension
{
    public function __construct(
        /** @var DatePrimitive|DateTimePrimitive|TimePrimitive|string|int|null value Value of extension */
        #[FhirProperty(fhirType: 'choice', propertyKind: 'choice', isChoice: true)]
        DatePrimitive|DateTimePrimitive|TimePrimitive|string|int|null $value = null,
        ?string $id = null,
        array $extension = [],
    ) {
        parent::__construct(
