 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/synchronicity-control', fhirVersion: 'R4B')]
class OperationSynchronicityControlExtension extends Extension
{
    public function __construct(
        ...
        parent::__construct(
            id: $id,
            extension: $extension,
            url: 'http://hl7.org/fhir/StructureDefinition/synchronicity-control',
            value: $this->valueUri,
        );
    }
}
