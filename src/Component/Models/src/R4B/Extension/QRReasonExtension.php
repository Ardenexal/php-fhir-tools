 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/questionnaireresponse-reason', fhirVersion: 'R4B')]
class QRReasonExtension extends Extension
{
