 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/observation-specimenCode', fhirVersion: 'R4B')]
class ObsSpecimenCodeExtension extends Extension
{
