 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/canonicalresource-short-description', fhirVersion: 'R4B')]
class CRShortDescriptionExtension extends Extension
{
