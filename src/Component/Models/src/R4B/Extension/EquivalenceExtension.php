 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/elementdefinition-equivalence', fhirVersion: 'R4B')]
class EquivalenceExtension extends Extension
{
