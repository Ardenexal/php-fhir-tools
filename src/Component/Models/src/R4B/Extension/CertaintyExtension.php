 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/allergyintolerance-certainty', fhirVersion: 'R4B')]
class CertaintyExtension extends Extension
{
