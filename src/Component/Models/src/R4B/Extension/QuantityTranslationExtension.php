 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/extension-quantity-translation', fhirVersion: 'R4B')]
class QuantityTranslationExtension extends Extension
{
