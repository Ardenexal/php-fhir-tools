 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/implementationguide-sourceFile', fhirVersion: 'R4B')]
#[FHIRExtensionContext(type: 'element', expression: 'ImplementationGuide.definition')]
class IGSourceFileExtension extends Extension implements FHIRComplexExtensionInterface
{
    ...
    public static function fromSubExtensions(array $subExtensions, ?string $id = null): self
    {
        ...
        return new self($file, $location, $keepAsResource, $id);
    }
}
