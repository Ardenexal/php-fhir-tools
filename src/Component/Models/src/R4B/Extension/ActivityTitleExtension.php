...
/**
 * @author Health Level Seven, Inc. - Patient Care WG
 *
 * @see http://hl7.org/fhir/StructureDefinition/careplan-activity-title
 *
 * @description Human-friendly name for the activity.
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/careplan-activity-title', fhirVersion: 'R4B')]
class ActivityTitleExtension extends Extension
{
