 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/iso21090-uncertaintyType', fhirVersion: 'R4B')]
class UncertaintyTypeExtension extends Extension
{
