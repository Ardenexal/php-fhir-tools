 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/structuredefinition-applicable-version', fhirVersion: 'R4B')]
class SDApplicableVersionExtension extends Extension
{
