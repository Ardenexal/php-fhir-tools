 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/DiagnosticReport-geneticsFamilyMemberHistory', fhirVersion: 'R4B')]
class FamilyMemberHistoryExtension extends Extension
{
