 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/observation-secondaryFinding', fhirVersion: 'R4B')]
class SecondaryFindingExtension extends Extension
{
