 ...
 *
 * @see http://hl7.org/fhir/StructureDefinition/annotationType
 *
 * @description The type of annotation.  This extension can be used to map the v2 NTE-4 comment type field.
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/annotationType', fhirVersion: 'R4B')]
