 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/cqf-supportedCqlVersion', fhirVersion: 'R4B')]
class SupportedCqlVersionExtension extends Extension
{
