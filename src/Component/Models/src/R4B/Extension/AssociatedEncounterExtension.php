 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/encounter-associatedEncounter', fhirVersion: 'R4B')]
class AssociatedEncounterExtension extends Extension
{
