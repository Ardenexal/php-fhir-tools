 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/questionnaire-signatureRequired', fhirVersion: 'R4B')]
class QSignatureRequiredExtension extends Extension
{
