 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/procedure-approachBodyStructure', fhirVersion: 'R4B')]
class PRApproachBodyStructureExtension extends Extension
{
