 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/individual-recordedSexOrGender', fhirVersion: 'R4B')]
...
class RecordedSexOrGenderExtension extends Extension implements FHIRComplexExtensionInterface
{
    ...
    public static function fromSubExtensions(array $subExtensions, ?string $id = null): self
    {
        ...
        return new self($valueSlice, $type, $effectivePeriod, $acquisitionDate, $source, $sourceDocument, $sourceField, $jurisdiction, $comment, $genderElementQualifier, $id);
    }
}
