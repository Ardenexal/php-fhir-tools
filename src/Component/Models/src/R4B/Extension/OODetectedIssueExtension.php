 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/operationoutcome-detectedIssue', fhirVersion: 'R4B')]
class OODetectedIssueExtension extends Extension
{
