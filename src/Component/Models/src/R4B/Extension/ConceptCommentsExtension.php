 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/valueset-concept-comments', fhirVersion: 'R4B')]
class ConceptCommentsExtension extends Extension
{
