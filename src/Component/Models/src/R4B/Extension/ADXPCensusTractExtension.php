 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-censusTract', fhirVersion: 'R4B')]
class ADXPCensusTractExtension extends Extension
{
