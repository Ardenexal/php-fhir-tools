 ...
 *
 * @see http://hl7.org/fhir/StructureDefinition/target-feature-assertion
 *
 * @description This extension asserts that the data in a resource a provenance statement identifies was authored (collected/handled/created/transformed) by an application that claims conformance to the definition of a feature. Note that 'authoring' is often a client function, but that is not always the case.
 *
 ...
 *
 *   This extension is a statement about the content of resources referred to from Provenance.target and is placed on the Provenance resource. See the related extension for [declaring feature conformance in the resource itself](StructureDefinition-feature-assertion.html).
 *
 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/target-feature-assertion', fhirVersion: 'R4B')]
#[FHIRExtensionContext(type: 'element', expression: 'Provenance')]
class TargetFeatureAsssertionExtension extends Extension implements FHIRComplexExtensionInterface
{
    public function __construct(
        ...
        parent::__construct(
            ...
            url: 'http://hl7.org/fhir/StructureDefinition/target-feature-assertion',
        );
    }
    ...
    public static function fromSubExtensions(array $subExtensions, ?string $id = null): self
    {
        ...
        return new self($definition, $valueSlice, $property, $id);
    }
}
