 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/patient-multipleBirthTotal', fhirVersion: 'R4B')]
#[FHIRExtensionContext(type: 'element', expression: 'Patient.multipleBirth[x]')]
