 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/structuredefinition-display-hint', fhirVersion: 'R4B')]
class SDDisplayHintExtension extends Extension
{
