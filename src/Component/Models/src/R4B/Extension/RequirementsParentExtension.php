 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/requirements-parent', fhirVersion: 'R4B')]
#[FHIRExtensionContext(type: 'element', expression: 'Requirements.statement')]
