 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/questionnaireresponse-signature', fhirVersion: 'R4B')]
class SignatureExtension extends Extension
{
    public function __construct(
        /** @var Signature|null valueSignature Value of extension */
        #[FhirProperty(fhirType: 'Signature', propertyKind: 'complex')]
        public ?\Ardenexal\FHIRTools\Component\Models\R4B\DataType\Signature $valueSignature = null,
        ?string $id = null,
        array $extension = [],
    ) {
        parent::__construct(
