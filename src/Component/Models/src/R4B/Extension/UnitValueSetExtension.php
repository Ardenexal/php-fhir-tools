 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/questionnaire-unitValueSet', fhirVersion: 'R4B')]
...
#[FHIRContextInvariant(expression: 'type=\'quantity\'')]
class UnitValueSetExtension extends Extension
{
