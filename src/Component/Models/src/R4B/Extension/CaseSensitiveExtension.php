 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/valueset-caseSensitive', fhirVersion: 'R4B')]
class CaseSensitiveExtension extends Extension
{
