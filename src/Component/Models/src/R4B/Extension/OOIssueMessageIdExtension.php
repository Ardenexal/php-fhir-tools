 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/operationoutcome-message-id', fhirVersion: 'R4B')]
class OOIssueMessageIdExtension extends Extension
{
