 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/encounter-reasonCancelled', fhirVersion: 'R4B')]
class EncReasonCancelledExtension extends Extension
{
