 ...
 *
 * @see http://hl7.org/fhir/StructureDefinition/cqf-publicationStatus
 *
 * @description Specifies the publication status of the referenced artifacts.
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/cqf-publicationStatus', fhirVersion: 'R4B')]
class PublicationStatusExtension extends Extension
{
