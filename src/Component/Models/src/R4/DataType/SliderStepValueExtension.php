 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/questionnaire-sliderStepValue', fhirVersion: 'R4')]
class SliderStepValueExtension extends Extension
{
