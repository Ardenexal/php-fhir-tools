...
class FHIRCodeableConcept extends FHIRElement
{
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRCoding> coding Code defined by a terminology system */
		public array $coding = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Primitive\FHIRString|string text Plain text representation of the concept */
