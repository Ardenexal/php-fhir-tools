...
/**
 * @fhir-backbone-element Claim.item.detail.subDetail
 * @description A claim detail line. Either a simple (a product or service) or a 'group' of sub-details which are simple items.
 */
class FHIRClaimItemDetailSubDetail extends \Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRBackboneElement
{
