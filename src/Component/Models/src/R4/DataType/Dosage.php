 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRBackboneElement(parentResource: 'Dosage', elementPath: 'Dosage', fhirVersion: 'R4')]
class Dosage extends BackboneElement
{
	public const FHIR_PROPERTY_MAP = [
		...
		'doseAndRate' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4\DataType\DosageDoseAndRate',
			'variants' => null,
		],
		'maxDosePerPeriod' => [
			'fhirType' => 'Ratio',
	...
	public function __construct(
		...
		/** @var null|bool|\Ardenexal\FHIRTools\Component\Models\R4\DataType\CodeableConcept asNeeded Take "as needed" (for x) */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'choice',
			propertyKind: 'choice',
			isChoice: true,
