...
class FHIRElementDefinitionSlicingDiscriminator extends FHIRElement
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRDiscriminatorTypeType type value | exists | pattern | type | profile */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRDiscriminatorTypeType $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Primitive\FHIRString|string path Path to element value */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
