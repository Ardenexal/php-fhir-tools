 ...
 */
#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FHIRComplexType(typeName: 'ElementDefinition.slicing', fhirVersion: 'R4')]
class FHIRElementDefinitionSlicing extends FHIRElement
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Primitive\FHIRBoolean ordered If elements must be in same order as slices */
		public ?\Ardenexal\FHIRTools\Component\Models\R4\Primitive\FHIRBoolean $ordered = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRSlicingRulesType rules closed | open | openAtEnd */
