 ...
 */
#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FHIRPrimitive(primitiveType: 'uuid', fhirVersion: 'R4')]
class FHIRUuid extends \Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRUri
{
