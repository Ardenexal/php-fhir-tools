 ...
 */
#[FHIRPrimitive(primitiveType: 'string', fhirVersion: 'R4')]
class StringPrimitive extends Element implements \Stringable
{
    ...
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'http://hl7.org/fhirpath/System.String', propertyKind: 'scalar', xmlSerializedName: '@value'), Length(max: 1048576), Regex(pattern: '~\A(?:[ \r\n\t\S]+)\z~')]
