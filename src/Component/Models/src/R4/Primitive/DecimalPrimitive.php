...
class DecimalPrimitive extends Element implements \Stringable
{
    ...
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'http://hl7.org/fhirpath/System.Decimal', propertyKind: 'scalar', xmlSerializedName: '@value'), Regex(pattern: '~\A(?:-?(0|[1-9][0-9]*)(\.[0-9]+)?([eE][+-]?[0-9]+)?)\z~')]
