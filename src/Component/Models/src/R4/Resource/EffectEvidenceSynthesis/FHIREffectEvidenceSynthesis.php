...
class FHIREffectEvidenceSynthesis extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRUri url Canonical identifier for this effect evidence synthesis, represented as a URI (globally unique) */
		public ?FHIRUri $url = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRIdentifier> identifier Additional identifier for the effect evidence synthesis */
		public array $identifier = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRString|string version Business version of the effect evidence synthesis */
		public FHIRString|string|null $version = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRString|string name Name for this effect evidence synthesis (computer friendly) */
		public FHIRString|string|null $name = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRString|string title Name for this effect evidence synthesis (human friendly) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRMarkdown description Natural language description of the effect evidence synthesis */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRCodeableConcept> jurisdiction Intended jurisdiction for effect evidence synthesis (if applicable) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRDate approvalDate When the effect evidence synthesis was approved by publisher */
		public ?FHIRDate $approvalDate = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRDate lastReviewDate When the effect evidence synthesis was last reviewed */
		public ?FHIRDate $lastReviewDate = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRPeriod effectivePeriod When the effect evidence synthesis is expected to be used */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRReference exposureAlternative What comparison exposure? */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
