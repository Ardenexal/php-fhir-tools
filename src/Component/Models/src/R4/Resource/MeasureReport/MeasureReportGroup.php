 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRBackboneElement(parentResource: 'MeasureReport', elementPath: 'MeasureReport.group', fhirVersion: 'R4')]
class MeasureReportGroup extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\BackboneElement
{
	public const FHIR_PROPERTY_MAP = [
		...
		'population' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4\Resource\MeasureReport\MeasureReportGroupPopulation',
			'variants' => null,
		],
		'measureScore' => [
			'fhirType' => 'Quantity',
		...
		'stratifier' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4\Resource\MeasureReport\MeasureReportGroupStratifier',
			'variants' => null,
		],
	];
