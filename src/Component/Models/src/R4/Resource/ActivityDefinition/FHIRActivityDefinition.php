...
use Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRRequestResourceTypeType;
...
class FHIRActivityDefinition extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var FHIRCodeableConcept|FHIRReference|null subjectX Type of individual the activity definition is intended for */
