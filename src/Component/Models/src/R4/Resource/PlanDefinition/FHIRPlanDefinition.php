...
class FHIRPlanDefinition extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var FHIRCodeableConcept|FHIRReference|null subjectX Type of individual the plan definition is focused on */
        ...
        /** @var FHIRString|string|null usage Describes the clinical usage of the plan */
        ...
        /** @var FHIRDate|null lastReviewDate When the plan definition was last reviewed */
