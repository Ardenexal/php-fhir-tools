 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRBackboneElement(parentResource: 'TestScript', elementPath: 'TestScript.test', fhirVersion: 'R4')]
class TestScriptTest extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\BackboneElement
{
	public const FHIR_PROPERTY_MAP = [
		...
		'action' => [
			...
			'isChoice' => false,
			'jsonKey' => null,
			'phpType' => 'Ardenexal\FHIRTools\Component\Models\R4\Resource\TestScript\TestScriptTestAction',
			'variants' => null,
		],
	];
	...
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\TestScript\TestScriptTestAction> action A test operation or assert to perform */
