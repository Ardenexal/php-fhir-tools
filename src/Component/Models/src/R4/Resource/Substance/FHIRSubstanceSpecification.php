...
class FHIRSubstanceSpecification extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRIdentifier identifier Identifier by which this substance is known */
		public ?\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRIdentifier $identifier = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRCodeableConcept type High level categorization, e.g. polymer or nucleic acid */
		public ?\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRCodeableConcept $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRCodeableConcept status Status of substance within the catalogue e.g. approved */
		public ?\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRCodeableConcept $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRCodeableConcept domain If the substance applies to only human or veterinary use */
		public ?\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRCodeableConcept $domain = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Primitive\FHIRString|string description Textual description of the substance */
		...
		public array $source = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Primitive\FHIRString|string comment Textual comment about this record of a substance */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRReference referenceInformation General information detailing this substance */
		public ?\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRReference $referenceInformation = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRReference nucleicAcid Data items specific to nucleic acids */
		public ?\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRReference $nucleicAcid = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRReference polymer Data items specific to polymers */
		public ?\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRReference $polymer = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRReference protein Data items specific to proteins */
		public ?\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRReference $protein = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRReference sourceMaterial Material or taxonomic/anatomical source for the substance */
		public ?\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRReference $sourceMaterial = null,
	) {
