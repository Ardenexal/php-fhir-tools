 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRBackboneElement(parentResource: 'DeviceDefinition', elementPath: 'DeviceDefinition.udiDeviceIdentifier', fhirVersion: 'R4')]
class DeviceDefinitionUdiDeviceIdentifier extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Primitive\StringPrimitive|string deviceIdentifier The identifier that is to be associated with every Device that references this DeviceDefintiion for the issuer and jurisdication porvided in the DeviceDefinition.udiDeviceIdentifier */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Primitive\UriPrimitive issuer The organization that assigns the identifier algorithm */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Primitive\UriPrimitive jurisdiction The jurisdiction to which the deviceIdentifier applies */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'uri', propertyKind: 'primitive', isRequired: true), \Symfony\Component\Validator\Constraints\NotBlank]
