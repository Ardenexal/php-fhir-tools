 ...
 */
#[FHIRBackboneElement(parentResource: 'DeviceDefinition', elementPath: 'DeviceDefinition.specialization', fhirVersion: 'R4')]
class DeviceDefinitionSpecialization extends BackboneElement
{
    public function __construct(
        ...
        /** @var StringPrimitive|string|null systemType The standard that is used to operate and communicate */
        #[NotBlank]
        public StringPrimitive|string|null $systemType = null,
