...
class FHIRSubscription extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRSubscriptionStatusType status requested | active | error | off */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRSubscriptionStatusType $status = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRInstant end When to automatically delete the subscription */
		public ?FHIRInstant $end = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRString|string reason Description of why this subscription was created */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public FHIRString|string|null $reason = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRString|string criteria Rule for server push */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public FHIRString|string|null $criteria = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRString|string error Latest error note */
