...
class FHIRBiologicallyDerivedProduct extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRBiologicallyDerivedProductCategoryType productCategory organ | tissue | fluid | cells | biologicalAgent */
		public ?FHIRBiologicallyDerivedProductCategoryType $productCategory = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRCodeableConcept productCode What this biologically derived product is */
		public ?FHIRCodeableConcept $productCode = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRBiologicallyDerivedProductStatusType status available | unavailable */
		public ?FHIRBiologicallyDerivedProductStatusType $status = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRReference> request Procedure request */
		public array $request = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRInteger quantity The amount of this biologically derived product */
		public ?FHIRInteger $quantity = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRReference> parent BiologicallyDerivedProduct parent */
		public array $parent = [],
