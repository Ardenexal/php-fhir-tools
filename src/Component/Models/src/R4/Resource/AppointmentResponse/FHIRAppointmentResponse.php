...
class FHIRAppointmentResponse extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRReference appointment Appointment this response relates to */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRReference $appointment = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRInstant start Time from appointment, or requested new start time */
		public ?FHIRInstant $start = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRInstant end Time from appointment, or requested new end time */
		public ?FHIRInstant $end = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRCodeableConcept> participantType Role of participant in the appointment */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRParticipationStatusType participantStatus accepted | declined | tentative | needs-action */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
