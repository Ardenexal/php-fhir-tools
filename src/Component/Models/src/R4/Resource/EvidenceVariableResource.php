...
use Ardenexal\FHIRTools\Component\Models\R4\Resource\EvidenceVariable\EvidenceVariableCharacteristic;
...
class EvidenceVariableResource extends AbstractDomainResource
{
    public function __construct(
        ...
        /** @var array<Identifier> identifier Additional identifier for the evidence variable */
        #[FhirProperty(
            fhirType: 'Identifier',
        ...
        /** @var StringPrimitive|string|null version Business version of the evidence variable */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        public StringPrimitive|string|null $version = null,
        /** @var StringPrimitive|string|null name Name for this evidence variable (computer friendly) */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        public StringPrimitive|string|null $name = null,
        /** @var StringPrimitive|string|null title Name for this evidence variable (human friendly) */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        ...
        /** @var StringPrimitive|string|null subtitle Subordinate title of the EvidenceVariable */
        #[FhirProperty(fhirType: 'string', propertyKind: 'primitive')]
        ...
        /** @var MarkdownPrimitive|null description Natural language description of the evidence variable */
        ...
        /** @var array<CodeableConcept> jurisdiction Intended jurisdiction for evidence variable (if applicable) */
        #[FhirProperty(
        ...
        /** @var DatePrimitive|null approvalDate When the evidence variable was approved by publisher */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
        public ?DatePrimitive $approvalDate = null,
        /** @var DatePrimitive|null lastReviewDate When the evidence variable was last reviewed */
        #[FhirProperty(fhirType: 'date', propertyKind: 'primitive')]
        public ?DatePrimitive $lastReviewDate = null,
        /** @var Period|null effectivePeriod When the evidence variable is expected to be used */
        #[FhirProperty(fhirType: 'Period', propertyKind: 'complex')]
        public ?Period $effectivePeriod = null,
        /** @var array<CodeableConcept> topic The category of the EvidenceVariable, such as Education, Treatment, Assessment, etc. */
        #[FhirProperty(
            fhirType: 'CodeableConcept',
            propertyKind: 'complex',
            isArray: true,
        ...
        /** @var EvidenceVariableTypeType|null type dichotomous | continuous | descriptive */
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive'), FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/variable-type|4.0.1', strength: 'required')]
        public ?EvidenceVariableTypeType $type = null,
