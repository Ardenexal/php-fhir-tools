...
use Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIREvidenceVariableTypeType;
...
class FHIREvidenceVariable extends FHIRDomainResource
{
    public function __construct(
        ...
        /** @var FHIRString|string|null subtitle Subordinate title of the EvidenceVariable */
        ...
        /** @var array<FHIRCodeableConcept> jurisdiction Intended jurisdiction for evidence variable (if applicable) */
        public array $jurisdiction = [],
        /** @var FHIRMarkdown|null copyright Use and/or publishing restrictions */
        public ?FHIRMarkdown $copyright = null,
        /** @var FHIRDate|null approvalDate When the evidence variable was approved by publisher */
        public ?FHIRDate $approvalDate = null,
        /** @var FHIRDate|null lastReviewDate When the evidence variable was last reviewed */
        public ?FHIRDate $lastReviewDate = null,
        /** @var FHIRPeriod|null effectivePeriod When the evidence variable is expected to be used */
        public ?FHIRPeriod $effectivePeriod = null,
        /** @var array<FHIRCodeableConcept> topic The category of the EvidenceVariable, such as Education, Treatment, Assessment, etc. */
        public array $topic = [],
        ...
        /** @var FHIREvidenceVariableTypeType|null type dichotomous | continuous | descriptive */
        public ?FHIREvidenceVariableTypeType $type = null,
        /** @var array<FHIREvidenceVariableCharacteristic> characteristic What defines the members of the evidence element */
