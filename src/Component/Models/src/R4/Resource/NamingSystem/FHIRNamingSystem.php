...
class FHIRNamingSystem extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Primitive\FHIRString|string name Name for this naming system (computer friendly) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRNamingSystemTypeType kind codesystem | identifier | root */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRNamingSystemTypeType $kind = null,
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Primitive\FHIRString|string responsible Who maintains system namespace? */
		public \Ardenexal\FHIRTools\Component\Models\R4\Primitive\FHIRString|string|null $responsible = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRCodeableConcept type e.g. driver,  provider,  patient, bank etc. */
		public ?\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRCodeableConcept $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Primitive\FHIRMarkdown description Natural language description of the naming system */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRCodeableConcept> jurisdiction Intended jurisdiction for naming system (if applicable) */
		public array $jurisdiction = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Primitive\FHIRString|string usage How/where is it used */
