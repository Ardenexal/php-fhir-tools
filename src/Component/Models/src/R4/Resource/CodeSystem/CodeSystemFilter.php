...
class CodeSystemFilter extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(
            ...
            isArray: true,
            isRequired: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4\DataType\FilterOperatorType',
        )]
        #[Count(min: 1)]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/filter-operator|4.0.1',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4\Enum\FilterOperator',
        )]
