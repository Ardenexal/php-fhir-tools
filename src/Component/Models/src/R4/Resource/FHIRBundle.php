...
class FHIRBundle extends FHIRResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRIdentifier identifier Persistent identifier for the bundle */
		public ?FHIRIdentifier $identifier = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRBundleTypeType type document | message | transaction | transaction-response | batch | batch-response | history | searchset | collection */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRBundleTypeType $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRInstant timestamp When the bundle was assembled */
		public ?FHIRInstant $timestamp = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRUnsignedInt total If search, the total number of matches */
		...
		public array $entry = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRSignature signature Digital Signature */
