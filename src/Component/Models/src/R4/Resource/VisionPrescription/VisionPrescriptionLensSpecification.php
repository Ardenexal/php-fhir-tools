 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRBackboneElement(parentResource: 'VisionPrescription', elementPath: 'VisionPrescription.lensSpecification', fhirVersion: 'R4')]
class VisionPrescriptionLensSpecification extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\BackboneElement
{
	...
	public function __construct(
		...
		/** @var null|numeric-string sphere Power of the lens */
		...
		/** @var null|numeric-string cylinder Lens power for astigmatism */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'decimal', propertyKind: 'scalar')]
		...
		public array $prism = [],
		/** @var null|numeric-string add Added power for multifocal levels */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'decimal', propertyKind: 'scalar')]
		public ?string $add = null,
		/** @var null|numeric-string power Contact lens power */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'decimal', propertyKind: 'scalar')]
		public ?string $power = null,
		/** @var null|numeric-string backCurve Contact lens back curvature */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'decimal', propertyKind: 'scalar')]
		public ?string $backCurve = null,
		/** @var null|numeric-string diameter Contact lens diameter */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(fhirType: 'decimal', propertyKind: 'scalar')]
