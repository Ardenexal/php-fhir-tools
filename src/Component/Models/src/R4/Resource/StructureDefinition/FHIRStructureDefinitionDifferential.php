 ...
 */
#[FHIRBackboneElement(parentResource: 'StructureDefinition', elementPath: 'StructureDefinition.differential', fhirVersion: 'R4')]
class FHIRStructureDefinitionDifferential extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRBackboneElement
{
