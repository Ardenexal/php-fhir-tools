...
class FHIRStructureDefinition extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRUri url Canonical identifier for this structure definition, represented as a URI (globally unique) */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRUri $url = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRIdentifier> identifier Additional identifier for the structure definition */
		public array $identifier = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRString|string version Business version of the structure definition */
		public FHIRString|string|null $version = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRString|string name Name for this structure definition (computer friendly) */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public FHIRString|string|null $name = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRString|string title Name for this structure definition (human friendly) */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRMarkdown description Natural language description of the structure definition */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRCodeableConcept> jurisdiction Intended jurisdiction for structure definition (if applicable) */
		public array $jurisdiction = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRMarkdown purpose Why this structure definition is defined */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRCoding> keyword Assist with indexing and finding */
		public array $keyword = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRFHIRVersionType fhirVersion FHIR Version this StructureDefinition targets */
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRStructureDefinitionKindType kind primitive-type | complex-type | resource | logical */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRStructureDefinitionKindType $kind = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRBoolean abstract Whether the structure is abstract */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRString|string> contextInvariant FHIRPath invariants - when the extension can be used */
		public array $contextInvariant = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRUri type Type defined or constrained by this structure */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRUri $type = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRCanonical baseDefinition Definition that this type is constrained/specialized from */
		public ?FHIRCanonical $baseDefinition = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRTypeDerivationRuleType derivation specialization | constraint - How relates to base definition */
