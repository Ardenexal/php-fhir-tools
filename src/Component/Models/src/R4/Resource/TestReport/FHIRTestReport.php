...
class FHIRTestReport extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRIdentifier identifier External identifier */
		public ?FHIRIdentifier $identifier = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRString|string name Informal name of the executed TestScript */
		public FHIRString|string|null $name = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRTestReportStatusType status completed | in-progress | waiting | stopped | entered-in-error */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRTestReportStatusType $status = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRReference testScript Reference to the  version-specific TestScript that was executed to produce this TestReport */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRReference $testScript = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRTestReportResultType result pass | fail | pending */
		#[\Symfony\Component\Validator\Constraints\NotBlank]
		public ?FHIRTestReportResultType $result = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRDecimal score The final score (percentage of tests passed) resulting from the execution of the TestScript */
		public ?FHIRDecimal $score = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRString|string tester Name of the tester producing this report (Organization or individual) */
		public FHIRString|string|null $tester = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRDateTime issued When the TestScript was executed and this TestReport was generated */
