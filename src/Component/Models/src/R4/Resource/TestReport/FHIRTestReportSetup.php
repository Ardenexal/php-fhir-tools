...
class FHIRTestReportSetup extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRBackboneElement
{
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRTestReportSetupAction> action A setup operation or assert that was executed */
		public array $action = [],
	) {
