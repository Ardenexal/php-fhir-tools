...
use Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRMedicationStatusCodesType;
...
class FHIRMedicationStatement extends FHIRDomainResource
{
    public function __construct(
        ...
        public array $partOf = [],
        /** @var FHIRMedicationStatusCodesType|null status active | completed | entered-in-error | intended | stopped | on-hold | unknown | not-taken */
        #[NotBlank]
