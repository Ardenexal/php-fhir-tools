...
class MedicationDispenseResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/medicationdispense-status|4.0.1',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4\Enum\MedicationDispenseStatusCodes',
        )]
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/medicationdispense-category',
            strength: 'preferred',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4\Enum\MedicationDispenseCategoryCodes',
        )]
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4\Resource\MedicationDispense\MedicationDispensePerformer',
        )]
        #[Valid]
