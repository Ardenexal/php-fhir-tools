...
class MedicationRequestResource extends DomainResourceResource
{
	...
	public function __construct(
		...
		/** @var null|bool|\Ardenexal\FHIRTools\Component\Models\R4\DataType\Reference reported Reported rather than primary record */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'choice',
			propertyKind: 'choice',
			isChoice: true,
		...
		public bool|\Ardenexal\FHIRTools\Component\Models\R4\DataType\Reference|null $reported = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\DataType\CodeableConcept|\Ardenexal\FHIRTools\Component\Models\R4\DataType\Reference medication Medication to be taken */
		#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FhirProperty(
			fhirType: 'choice',
			propertyKind: 'choice',
			isRequired: true,
