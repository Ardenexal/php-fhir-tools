...
use Ardenexal\FHIRTools\Component\Models\R4\Resource\StructureMap\StructureMapGroup;
use Ardenexal\FHIRTools\Component\Models\R4\Resource\StructureMap\StructureMapStructure;
 ...
 */
#[FhirResource(type: 'StructureMap', version: '4.0.1', url: 'http://hl7.org/fhir/StructureDefinition/StructureMap', fhirVersion: 'R4')]
#[FHIRPathInvariant(
    key: 'smp-0',
    severity: 'warning',
...
class StructureMapResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FhirProperty(
            ...
            isArray: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4\Resource\StructureMap\StructureMapStructure',
        )]
        ...
        #[FhirProperty(
            ...
            isArray: true,
            isRequired: true,
            phpType: 'Ardenexal\FHIRTools\Component\Models\R4\Resource\StructureMap\StructureMapGroup',
        )]
        #[Count(min: 1)]
        public array $group = [],
    ) {
