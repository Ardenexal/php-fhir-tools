...
namespace Ardenexal\FHIRTools\Component\Models\R4\Resource\RelatedPerson;
 ...
 */
#[FHIRBackboneElement(parentResource: 'RelatedPerson', elementPath: 'RelatedPerson.communication', fhirVersion: 'R4')]
class RelatedPersonCommunication extends BackboneElement
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'CodeableConcept', propertyKind: 'complex', isRequired: true), NotBlank, FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/languages', strength: 'preferred')]
