 ...
 */
#[FHIRBackboneElement(parentResource: 'Claim', elementPath: 'Claim.accident', fhirVersion: 'R4')]
class FHIRClaimAccident extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRBackboneElement
{
