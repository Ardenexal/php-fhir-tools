...
class FHIRTiming extends FHIRBackboneElement
{
	public function __construct(
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRDateTime> event When the event occurs */
		public array $event = [],
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRCodeableConcept code BID | TID | QID | AM | PM | QD | QOD | + */
