...
class DocumentReferenceResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/document-reference-status|4.0.1',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4\Enum\DocumentReferenceStatus',
        )]
        ...
        #[Valid]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/c80-doc-typecodes',
            strength: 'preferred',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4\Enum\DocumentTypeValueSet',
        )]
