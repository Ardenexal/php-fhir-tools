...
class GraphDefinitionLinkTargetCompartment extends BackboneElement
{
    public function __construct(
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/graph-compartment-use|4.0.1',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4\Enum\GraphCompartmentUse',
        )]
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/compartment-type|4.0.1',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4\Enum\CompartmentType',
        )]
        ...
        #[NotBlank]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/graph-compartment-rule|4.0.1',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4\Enum\GraphCompartmentRule',
        )]
