...
use Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRContractResourcePublicationStatusCodesType;
...
class FHIRContractContentDefinition extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRBackboneElement
{
    public function __construct(
        ...
        /** @var FHIRContractResourcePublicationStatusCodesType|null publicationStatus amended | appended | cancelled | disputed | entered-in-error | executable | executed | negotiable | offered | policy | rejected | renewed | revoked | resolved | terminated */
        #[NotBlank]
