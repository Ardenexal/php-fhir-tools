 ...
 */
#[FhirResource(type: 'Questionnaire', version: '4.0.1', url: 'http://hl7.org/fhir/StructureDefinition/Questionnaire', fhirVersion: 'R4')]
#[FHIRPathInvariant(
    key: 'que-0',
    severity: 'warning',
...
class QuestionnaireResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FHIRValueSetBinding(valueSetUrl: 'http://hl7.org/fhir/ValueSet/resource-types|4.0.1', strength: 'required')]
