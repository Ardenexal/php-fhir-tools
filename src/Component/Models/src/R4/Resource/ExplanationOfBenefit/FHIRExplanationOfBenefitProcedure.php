 ...
 */
#[\Ardenexal\FHIRTools\Component\CodeGeneration\Attributes\FHIRBackboneElement(parentResource: 'ExplanationOfBenefit', elementPath: 'ExplanationOfBenefit.procedure', fhirVersion: 'R4')]
class FHIRExplanationOfBenefitProcedure extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\FHIRBackboneElement
{
