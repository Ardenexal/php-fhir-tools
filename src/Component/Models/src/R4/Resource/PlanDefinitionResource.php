...
class PlanDefinitionResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FHIRValueSetBinding(
            ...
            strength: 'extensible',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4\Enum\PlanDefinitionType',
        )]
        ...
        /** @var CodeableConcept|Reference|null subject Type of individual the plan definition is focused on */
        #[FhirProperty(
            fhirType: 'choice',
            propertyKind: 'choice',
            isChoice: true,
