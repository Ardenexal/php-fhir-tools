...
class FHIRMedicinalProductIndication extends FHIRDomainResource
{
	public function __construct(
		...
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRCodeableConcept diseaseSymptomProcedure The disease, symptom or procedure that is the indication for treatment */
		public ?FHIRCodeableConcept $diseaseSymptomProcedure = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRCodeableConcept diseaseStatus The status of the disease or symptom for which the indication applies */
		public ?FHIRCodeableConcept $diseaseStatus = null,
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRCodeableConcept> comorbidity Comorbidity (concurrent condition) or co-infection as part of the indication */
		public array $comorbidity = [],
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRCodeableConcept intendedEffect The intended effect, aim or strategy to be achieved by the indication */
		public ?FHIRCodeableConcept $intendedEffect = null,
		/** @var null|\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRQuantity duration Timing or duration information as part of the indication */
		...
		/** @var  array<\Ardenexal\FHIRTools\Component\Models\R4\Resource\FHIRReference> undesirableEffect Describe the undesirable effects of the medicinal product */
