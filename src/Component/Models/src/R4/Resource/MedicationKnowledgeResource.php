...
class MedicationKnowledgeResource extends AbstractDomainResource
{
    public function __construct(
        ...
        #[FhirProperty(fhirType: 'code', propertyKind: 'primitive')]
        #[FHIRValueSetBinding(
            valueSetUrl: 'http://hl7.org/fhir/ValueSet/medicationknowledge-status|4.0.1',
            strength: 'required',
            enumClass: 'Ardenexal\FHIRTools\Component\Models\R4\Enum\MedicationKnowledgeStatusCodes',
        )]
        #[FHIRIsModifier(reason: 'This element changes the interpretation of all descriptive attributes.')]
