...
#[FhirOperationPayload(
    ...
    path: 'match.unmatched',
)]
final class CodeSystemFindMatchesOutMatchUnmatched
{
    /**
     * @param list<CodeSystemFindMatchesOutMatchUnmatchedProperty> $property
     */
    public function __construct(
        ...
        #[FhirOperationParameter(
            ...
            min: 0,
            max: '*',
            partClass: CodeSystemFindMatchesOutMatchUnmatchedProperty::class,
