 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/measurereport-populationDescription', fhirVersion: 'R4')]
class MeasureReportPopulationDescriptionExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension
{
