 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/capabilitystatement-prohibited', fhirVersion: 'R4')]
class ProhibitedExtension extends Extension
{
