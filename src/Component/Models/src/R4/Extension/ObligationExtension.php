 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/obligation', fhirVersion: 'R4')]
...
class ObligationExtension extends Extension implements FHIRComplexExtensionInterface
{
    ...
    public static function fromSubExtensions(array $subExtensions, ?string $id = null): self
    {
        ...
        return new self($name, $code, $elementId, $actor, $documentation, $usage, $filter, $filterDocumentation, $applicableNumber, $process, $id);
    }
}
