 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/allergyintolerance-assertedDate', fhirVersion: 'R4')]
class AIAssertedDateExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension
{
