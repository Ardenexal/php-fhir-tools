 ...
 * @see http://hl7.org/fhir/StructureDefinition/structuredefinition-conformance-derivedFrom
 * @description Indicates one of the resources that was used to infer the specified maturity or standards status.
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/structuredefinition-conformance-derivedFrom', fhirVersion: 'R4')]
class SDStatusDerivationExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension
{
