 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/http-response-header', fhirVersion: 'R4')]
class BundleHttpResponseHeaderExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension
{
