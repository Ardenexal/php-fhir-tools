 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/cqf-scope', fhirVersion: 'R4')]
class ScopeExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension
{
