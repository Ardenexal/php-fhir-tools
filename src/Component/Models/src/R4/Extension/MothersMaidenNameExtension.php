 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/patient-mothersMaidenName', fhirVersion: 'R4')]
class MothersMaidenNameExtension extends Extension
{
