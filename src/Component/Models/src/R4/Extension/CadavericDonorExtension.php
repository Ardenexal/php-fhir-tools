 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/patient-cadavericDonor', fhirVersion: 'R4')]
class CadavericDonorExtension extends Extension
{
