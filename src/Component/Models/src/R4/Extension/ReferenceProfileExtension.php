 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/questionnaire-referenceProfile', fhirVersion: 'R4')]
class ReferenceProfileExtension extends Extension
{
