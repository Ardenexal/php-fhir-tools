...
class SRSpecimenSuggestionExtension extends Extension implements FHIRComplexExtensionInterface
{
    public function __construct(
        /** @var Base64BinaryPrimitive reference Extension */
        #[FhirProperty(fhirType: 'base64Binary', propertyKind: 'primitive')]
        public Base64BinaryPrimitive $reference,
    ...
    public static function fromSubExtensions(array $subExtensions, ?string $id = null): self
    {
        ...
        foreach ($subExtensions as $ext) {
            ...
            if ($extUrl === 'reference' && $ext->value instanceof Base64BinaryPrimitive) {
                $reference = $ext->value;
            }
        ...
        return new self($reference, $fallBackAction, $id);
    }
}
