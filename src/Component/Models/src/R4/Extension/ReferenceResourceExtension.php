 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/questionnaire-referenceResource', fhirVersion: 'R4')]
class ReferenceResourceExtension extends Extension
{
