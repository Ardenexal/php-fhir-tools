 ...
 * @see http://hl7.org/fhir/StructureDefinition/questionnaire-derivationType
 * @description Provides more precision about the type of derivation relationship that exists.
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/questionnaire-derivationType', fhirVersion: 'R4')]
class QuestionnaireDerivationTypeExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension
{
