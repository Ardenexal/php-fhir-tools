 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/regex', fhirVersion: 'R4')]
class RegexExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension
{
