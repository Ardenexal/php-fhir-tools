 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/obligations-profile', fhirVersion: 'R4')]
class ObligationsProfileExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension implements \Ardenexal\FHIRTools\Component\Metadata\Contract\FHIRComplexExtensionInterface
{
	public function __construct(
		...
		public \Ardenexal\FHIRTools\Component\Models\R4\Primitive\CanonicalPrimitive $profile,
		...
		public ?\Ardenexal\FHIRTools\Component\Models\R4\Primitive\UriPrimitive $actor = null,
		?string $id = null,
	) {
		$subExtensions = [];
