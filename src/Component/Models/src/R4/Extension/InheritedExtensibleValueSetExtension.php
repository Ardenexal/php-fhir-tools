 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/elementdefinition-inheritedExtensibleValueSet', fhirVersion: 'R4')]
class InheritedExtensibleValueSetExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension
{
