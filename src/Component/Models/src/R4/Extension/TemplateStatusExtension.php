 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/structuredefinition-template-status', fhirVersion: 'R4')]
class TemplateStatusExtension extends Extension
{
