 ...
 * @see http://hl7.org/fhir/StructureDefinition/elementdefinition-conceptmap
 * @description This extension references a ConceptMap that maps to relevant terminologies used in an implementation.
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/elementdefinition-conceptmap', fhirVersion: 'R4')]
class ConceptmapExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension
{
