 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/valueset-effectiveDate', fhirVersion: 'R4')]
class ValueSetEffectiveDateExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension
{
