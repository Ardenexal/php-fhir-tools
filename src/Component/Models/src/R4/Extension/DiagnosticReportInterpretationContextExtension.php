 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/diagnosticreport-interpretationContext', fhirVersion: 'R4')]
class DiagnosticReportInterpretationContextExtension extends Extension implements FHIRComplexExtensionInterface
{
