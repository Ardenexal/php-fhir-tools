 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/codesystem-authoritativeSource', fhirVersion: 'R4')]
class CSAuthoritativeSourceExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension
{
