 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/structuredefinition-dependencies', fhirVersion: 'R4')]
class DependentProfilesExtension extends Extension
{
