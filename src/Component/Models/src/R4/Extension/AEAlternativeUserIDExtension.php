 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/auditevent-AlternativeUserID', fhirVersion: 'R4')]
#[FHIRExtensionContext(type: 'element', expression: 'AuditEvent.agent')]
