 ...
 */
#[\Ardenexal\FHIRTools\Component\Metadata\Attribute\FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/messageheader-response-request', fhirVersion: 'R4')]
class MsgResponseRequestExtension extends \Ardenexal\FHIRTools\Component\Models\R4\DataType\Extension
{
