 ...
 */
#[FHIRExtensionDefinition(url: 'http://hl7.org/fhir/StructureDefinition/composition-section-subject', fhirVersion: 'R4')]
#[FHIRExtensionContext(type: 'element', expression: 'Composition.section')]
