...
class DependencyResolver
{
    ...
    private function resolveDependenciesRecursive(
        ...
        if (isset($visiting[$packageName])) {
            throw PackageException::circularDependency($packageName, array_keys($visiting));
        }
    ...
    private function resolveDependencyPackage(
        ...
        if (!isset($availablePackages[$depName])) {
            throw PackageException::dependencyNotFound($depName, $depConstraint);
        }
        ...
        throw PackageException::dependencyVersionNotFound($depName, $bestVersion);
    }
